...
func (this *QButtonGroup) OnButtonClickedWithInt(slot func(param1 int)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QButtonGroup_connect_buttonClickedWithInt(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QButtonGroup) OnButtonPressedWithInt(slot func(param1 int)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QButtonGroup_connect_buttonPressedWithInt(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QButtonGroup) OnButtonReleasedWithInt(slot func(param1 int)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QButtonGroup_connect_buttonReleasedWithInt(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QButtonGroup) OnButtonToggled2(slot func(param1 int, param2 bool)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QButtonGroup_connect_buttonToggled2(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
// Sender can only be called from a QButtonGroup that was directly constructed.
func (this *QButtonGroup) Sender() *QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := newQObject(C.QButtonGroup_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// SenderSignalIndex can only be called from a QButtonGroup that was directly constructed.
func (this *QButtonGroup) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QButtonGroup_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QButtonGroup that was directly constructed.
func (this *QButtonGroup) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QButtonGroup_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QButtonGroup that was directly constructed.
func (this *QButtonGroup) IsSignalConnected(signal *QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QButtonGroup_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal.cPointer()))
