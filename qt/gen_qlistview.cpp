...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QListView> handle__viewOptions;
	...
	virtual QStyleOptionViewItem viewOptions() const override {
		...
		QStyleOptionViewItem* callback_return_value = miqt_exec_callback_QListView_viewOptions(this, handle__viewOptions.value());
...
bool QListView_override_virtual_owned_viewOptions(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QListView> slot_handle(slot);
	MiqtVirtualQListView* self_cast = dynamic_cast<MiqtVirtualQListView*>( (QListView*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QStyleOptionViewItem* QListView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const MiqtVirtualQListView*>(self)->QListView::viewOptions());
}
...
bool QListView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQListView*>(self)->QListView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
