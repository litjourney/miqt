...
QScriptEngine* QScriptEngine_new() {
	return new (std::nothrow) MiqtVirtualQScriptEngine();
}

QScriptEngine* QScriptEngine_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQScriptEngine(parent);
}
...
bool QScriptEngine_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::event(event);
}
...
bool QScriptEngine_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::eventFilter(watched, event);
}
...
void QScriptEngine_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::timerEvent(event);
}
...
void QScriptEngine_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::childEvent(event);
}
...
void QScriptEngine_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::customEvent(event);
}
...
void QScriptEngine_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::connectNotify(*signal);
}
...
void QScriptEngine_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQScriptEngine*>(self)->QScriptEngine::disconnectNotify(*signal);
}
