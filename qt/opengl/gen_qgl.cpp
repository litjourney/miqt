...
void miqt_exec_callback_handle_release_QGLContext(intptr_t);
...
void miqt_exec_callback_handle_release_QGLWidget(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> handle__create;
	...
	virtual bool create(const QGLContext* shareContext) override {
		...
		bool callback_return_value = miqt_exec_callback_QGLContext_create(this, handle__create.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> handle__makeCurrent;

	// Subclass to allow providing a Go implementation
	virtual void makeCurrent() override {
		if (!handle__makeCurrent) {
			QGLContext::makeCurrent();
			return;
		}

		miqt_exec_callback_QGLContext_makeCurrent(this, handle__makeCurrent.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> handle__doneCurrent;

	// Subclass to allow providing a Go implementation
	virtual void doneCurrent() override {
		if (!handle__doneCurrent) {
			QGLContext::doneCurrent();
			return;
		}

		miqt_exec_callback_QGLContext_doneCurrent(this, handle__doneCurrent.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> handle__swapBuffers;

	// Subclass to allow providing a Go implementation
	virtual void swapBuffers() const override {
		if (!handle__swapBuffers) {
			QGLContext::swapBuffers();
			return;
		}

		miqt_exec_callback_QGLContext_swapBuffers(this, handle__swapBuffers.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> handle__chooseContext;

	// Subclass to allow providing a Go implementation
	virtual bool chooseContext(const QGLContext* shareContext) override {
		if (!handle__chooseContext) {
			return QGLContext::chooseContext(shareContext);
		}

		QGLContext* sigval1 = (QGLContext*) shareContext;
		bool callback_return_value = miqt_exec_callback_QGLContext_chooseContext(this, handle__chooseContext.value(), sigval1);
		return callback_return_value;
	}
...
bool QGLContext_override_virtual_create(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLContext> slot_handle(slot);
...
bool QGLContext_override_virtual_makeCurrent(void* self, intptr_t slot) {
	...
	self_cast->handle__makeCurrent = std::move(slot_handle);
	return true;
}
...
bool QGLContext_override_virtual_doneCurrent(void* self, intptr_t slot) {
	...
	self_cast->handle__doneCurrent = std::move(slot_handle);
	return true;
}
...
bool QGLContext_override_virtual_swapBuffers(void* self, intptr_t slot) {
	...
	self_cast->handle__swapBuffers = std::move(slot_handle);
	return true;
}
...
bool QGLContext_override_virtual_chooseContext(void* self, intptr_t slot) {
	...
	self_cast->handle__chooseContext = std::move(slot_handle);
	return true;
}
...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__paintEngine;
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QGLWidget_paintEngine(this, handle__paintEngine.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__updateGL;
	...
	virtual void updateGL() override {
		...
		miqt_exec_callback_QGLWidget_updateGL(this, handle__updateGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__updateOverlayGL;
	...
	virtual void updateOverlayGL() override {
		...
		miqt_exec_callback_QGLWidget_updateOverlayGL(this, handle__updateOverlayGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__event;
	...
	virtual bool event(QEvent* param1) override {
		...
		bool callback_return_value = miqt_exec_callback_QGLWidget_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__initializeGL;
	...
	virtual void initializeGL() override {
		...
		miqt_exec_callback_QGLWidget_initializeGL(this, handle__initializeGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__resizeGL;
	...
	virtual void resizeGL(int w, int h) override {
		...
		int sigval1 = w;
		int sigval2 = h;
		miqt_exec_callback_QGLWidget_resizeGL(this, handle__resizeGL.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__paintGL;
	...
	virtual void paintGL() override {
		...
		miqt_exec_callback_QGLWidget_paintGL(this, handle__paintGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__initializeOverlayGL;
	...
	virtual void initializeOverlayGL() override {
		...
		miqt_exec_callback_QGLWidget_initializeOverlayGL(this, handle__initializeOverlayGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__resizeOverlayGL;
	...
	virtual void resizeOverlayGL(int w, int h) override {
		...
		int sigval1 = w;
		int sigval2 = h;
		miqt_exec_callback_QGLWidget_resizeOverlayGL(this, handle__resizeOverlayGL.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__paintOverlayGL;
	...
	virtual void paintOverlayGL() override {
		...
		miqt_exec_callback_QGLWidget_paintOverlayGL(this, handle__paintOverlayGL.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__paintEvent;
	...
	virtual void paintEvent(QPaintEvent* param1) override {
		...
		miqt_exec_callback_QGLWidget_paintEvent(this, handle__paintEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__resizeEvent;
	...
	virtual void resizeEvent(QResizeEvent* param1) override {
		...
		miqt_exec_callback_QGLWidget_resizeEvent(this, handle__resizeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__glInit;
	...
	virtual void glInit() override {
		...
		miqt_exec_callback_QGLWidget_glInit(this, handle__glInit.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__glDraw;
	...
	virtual void glDraw() override {
		...
		miqt_exec_callback_QGLWidget_glDraw(this, handle__glDraw.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__devType;
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QGLWidget_devType(this, handle__devType.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__setVisible;
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QGLWidget_setVisible(this, handle__setVisible.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__sizeHint;
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QGLWidget_sizeHint(this, handle__sizeHint.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__minimumSizeHint;
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QGLWidget_minimumSizeHint(this, handle__minimumSizeHint.value());
		std::unique_ptr<QSize> callback_return_value_owner;
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__heightForWidth;
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QGLWidget_heightForWidth(this, handle__heightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__hasHeightForWidth;
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QGLWidget_hasHeightForWidth(this, handle__hasHeightForWidth.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__mousePressEvent;
	...
	virtual void mousePressEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_mousePressEvent(this, handle__mousePressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__mouseReleaseEvent;
	...
	virtual void mouseReleaseEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_mouseReleaseEvent(this, handle__mouseReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__mouseDoubleClickEvent;
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__mouseMoveEvent;
	...
	virtual void mouseMoveEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_mouseMoveEvent(this, handle__mouseMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__wheelEvent;
	...
	virtual void wheelEvent(QWheelEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_wheelEvent(this, handle__wheelEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__keyPressEvent;
	...
	virtual void keyPressEvent(QKeyEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_keyPressEvent(this, handle__keyPressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__keyReleaseEvent;
	...
	virtual void keyReleaseEvent(QKeyEvent* event) override {
		...
		QKeyEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_keyReleaseEvent(this, handle__keyReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__focusInEvent;
	...
	virtual void focusInEvent(QFocusEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_focusInEvent(this, handle__focusInEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__focusOutEvent;
	...
	virtual void focusOutEvent(QFocusEvent* event) override {
		...
		QFocusEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_focusOutEvent(this, handle__focusOutEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__enterEvent;
	...
	virtual void enterEvent(QEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_enterEvent(this, handle__enterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__leaveEvent;
	...
	virtual void leaveEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_leaveEvent(this, handle__leaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__moveEvent;
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_moveEvent(this, handle__moveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__closeEvent;
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_closeEvent(this, handle__closeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__contextMenuEvent;
	...
	virtual void contextMenuEvent(QContextMenuEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_contextMenuEvent(this, handle__contextMenuEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__tabletEvent;
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_tabletEvent(this, handle__tabletEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__actionEvent;
	...
	virtual void actionEvent(QActionEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_actionEvent(this, handle__actionEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__dragEnterEvent;
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_dragEnterEvent(this, handle__dragEnterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__dragMoveEvent;
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_dragMoveEvent(this, handle__dragMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__dragLeaveEvent;
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_dragLeaveEvent(this, handle__dragLeaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__dropEvent;
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_dropEvent(this, handle__dropEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__showEvent;
	...
	virtual void showEvent(QShowEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_showEvent(this, handle__showEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__hideEvent;
	...
	virtual void hideEvent(QHideEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_hideEvent(this, handle__hideEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__nativeEvent;
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, long* result) override {
		...
		long* sigval3 = result;
		bool callback_return_value = miqt_exec_callback_QGLWidget_nativeEvent(this, handle__nativeEvent.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__changeEvent;
	...
	virtual void changeEvent(QEvent* param1) override {
		...
		QEvent* sigval1 = param1;
		miqt_exec_callback_QGLWidget_changeEvent(this, handle__changeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__metric;
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QGLWidget_metric(this, handle__metric.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__initPainter;
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QGLWidget_initPainter(this, handle__initPainter.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__redirected;
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QGLWidget_redirected(this, handle__redirected.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__sharedPainter;
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QGLWidget_sharedPainter(this, handle__sharedPainter.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__inputMethodEvent;
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QGLWidget_inputMethodEvent(this, handle__inputMethodEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__inputMethodQuery;
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		QVariant* callback_return_value = miqt_exec_callback_QGLWidget_inputMethodQuery(this, handle__inputMethodQuery.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__focusNextPrevChild;
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QGLWidget_focusNextPrevChild(this, handle__focusNextPrevChild.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QGLWidget_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QGLWidget_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QGLWidget_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QGLWidget_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QGLWidget_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
bool QGLWidget_override_virtual_paintEngine(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> slot_handle(slot);
...
bool QGLWidget_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> slot_handle(slot);
	MiqtVirtualQGLWidget* self_cast = dynamic_cast<MiqtVirtualQGLWidget*>( (QGLWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QGLWidget_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> slot_handle(slot);
	MiqtVirtualQGLWidget* self_cast = dynamic_cast<MiqtVirtualQGLWidget*>( (QGLWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QGLWidget_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGLWidget> slot_handle(slot);
	MiqtVirtualQGLWidget* self_cast = dynamic_cast<MiqtVirtualQGLWidget*>( (QGLWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
