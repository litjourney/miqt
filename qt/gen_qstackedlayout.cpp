...
bool QStackedLayout_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QStackedLayout> slot_handle(slot);
	MiqtVirtualQStackedLayout* self_cast = dynamic_cast<MiqtVirtualQStackedLayout*>( (QStackedLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QStackedLayout_override_virtual_owned_minimumSize(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QStackedLayout> slot_handle(slot);
	MiqtVirtualQStackedLayout* self_cast = dynamic_cast<MiqtVirtualQStackedLayout*>( (QStackedLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QStackedLayout_override_virtual_owned_geometry(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QStackedLayout> slot_handle(slot);
	MiqtVirtualQStackedLayout* self_cast = dynamic_cast<MiqtVirtualQStackedLayout*>( (QStackedLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QStackedLayout_override_virtual_owned_maximumSize(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QStackedLayout> slot_handle(slot);
	MiqtVirtualQStackedLayout* self_cast = dynamic_cast<MiqtVirtualQStackedLayout*>( (QStackedLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QWidget* QStackedLayout_virtualbase_widget(void* self) {
	return static_cast<MiqtVirtualQStackedLayout*>(self)->QStackedLayout::widget();
}
