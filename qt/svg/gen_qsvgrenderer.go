...
func (this *QSvgRenderer) OnRepaintNeeded(slot func()) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QSvgRenderer_connect_repaintNeeded(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
