...
bool QAbstractSlider_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractSlider> slot_handle(slot);
	MiqtVirtualQAbstractSlider* self_cast = dynamic_cast<MiqtVirtualQAbstractSlider*>( (QAbstractSlider*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QAbstractSlider_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractSlider> slot_handle(slot);
	MiqtVirtualQAbstractSlider* self_cast = dynamic_cast<MiqtVirtualQAbstractSlider*>( (QAbstractSlider*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QAbstractSlider_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQAbstractSlider*>(self)->QAbstractSlider::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
bool QAbstractSlider_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractSlider> slot_handle(slot);
	MiqtVirtualQAbstractSlider* self_cast = dynamic_cast<MiqtVirtualQAbstractSlider*>( (QAbstractSlider*)(self) );
	if (self_cast == nullptr) {
		return false;
