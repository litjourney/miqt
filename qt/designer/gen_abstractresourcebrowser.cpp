...
void miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface(intptr_t);
...
void miqt_exec_callback_QDesignerResourceBrowserInterface_enterEvent(QDesignerResourceBrowserInterface*, intptr_t, QEvent*);
...
bool miqt_exec_callback_QDesignerResourceBrowserInterface_nativeEvent(QDesignerResourceBrowserInterface*, intptr_t, struct miqt_string, void*, long*);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__setCurrentPath;

	// Subclass to allow providing a Go implementation
	virtual void setCurrentPath(const QString& filePath) override {
		if (!handle__setCurrentPath) {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_setCurrentPath(this, handle__setCurrentPath.value(), sigval1);

	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__currentPath;

	// Subclass to allow providing a Go implementation
	virtual QString currentPath() const override {
		if (!handle__currentPath) {
			return QString(); // Pure virtual, there is no base we can call
		}

		struct miqt_string callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_currentPath(this, handle__currentPath.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__devType;
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_devType(this, handle__devType.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__setVisible;
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_setVisible(this, handle__setVisible.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__sizeHint;
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_sizeHint(this, handle__sizeHint.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__minimumSizeHint;
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_minimumSizeHint(this, handle__minimumSizeHint.value());
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__heightForWidth;
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_heightForWidth(this, handle__heightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__hasHeightForWidth;
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_hasHeightForWidth(this, handle__hasHeightForWidth.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__paintEngine;
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_paintEngine(this, handle__paintEngine.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__mousePressEvent;
	...
	virtual void mousePressEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_mousePressEvent(this, handle__mousePressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__mouseReleaseEvent;
	...
	virtual void mouseReleaseEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_mouseReleaseEvent(this, handle__mouseReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__mouseDoubleClickEvent;
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__mouseMoveEvent;
	...
	virtual void mouseMoveEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_mouseMoveEvent(this, handle__mouseMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__wheelEvent;
	...
	virtual void wheelEvent(QWheelEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_wheelEvent(this, handle__wheelEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__keyPressEvent;
	...
	virtual void keyPressEvent(QKeyEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_keyPressEvent(this, handle__keyPressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__keyReleaseEvent;
	...
	virtual void keyReleaseEvent(QKeyEvent* event) override {
		...
		QKeyEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_keyReleaseEvent(this, handle__keyReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__focusInEvent;
	...
	virtual void focusInEvent(QFocusEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_focusInEvent(this, handle__focusInEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__focusOutEvent;
	...
	virtual void focusOutEvent(QFocusEvent* event) override {
		...
		QFocusEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_focusOutEvent(this, handle__focusOutEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__enterEvent;
	...
	virtual void enterEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_enterEvent(this, handle__enterEvent.value(), sigval1);

	}

	friend void QDesignerResourceBrowserInterface_virtualbase_enterEvent(void* self, QEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__leaveEvent;
	...
	virtual void leaveEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_leaveEvent(this, handle__leaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__paintEvent;
	...
	virtual void paintEvent(QPaintEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_paintEvent(this, handle__paintEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__moveEvent;
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_moveEvent(this, handle__moveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__resizeEvent;
	...
	virtual void resizeEvent(QResizeEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_resizeEvent(this, handle__resizeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__closeEvent;
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_closeEvent(this, handle__closeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__contextMenuEvent;
	...
	virtual void contextMenuEvent(QContextMenuEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_contextMenuEvent(this, handle__contextMenuEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__tabletEvent;
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_tabletEvent(this, handle__tabletEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__actionEvent;
	...
	virtual void actionEvent(QActionEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_actionEvent(this, handle__actionEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__dragEnterEvent;
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_dragEnterEvent(this, handle__dragEnterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__dragMoveEvent;
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_dragMoveEvent(this, handle__dragMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__dragLeaveEvent;
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_dragLeaveEvent(this, handle__dragLeaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__dropEvent;
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_dropEvent(this, handle__dropEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__showEvent;
	...
	virtual void showEvent(QShowEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_showEvent(this, handle__showEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__hideEvent;
	...
	virtual void hideEvent(QHideEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_hideEvent(this, handle__hideEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__nativeEvent;
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, long* result) override {
		...
		long* sigval3 = result;
		bool callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_nativeEvent(this, handle__nativeEvent.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}

	friend bool QDesignerResourceBrowserInterface_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__changeEvent;
	...
	virtual void changeEvent(QEvent* param1) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_changeEvent(this, handle__changeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__metric;
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_metric(this, handle__metric.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__initPainter;
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_initPainter(this, handle__initPainter.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__redirected;
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_redirected(this, handle__redirected.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__sharedPainter;
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_sharedPainter(this, handle__sharedPainter.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__inputMethodEvent;
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_inputMethodEvent(this, handle__inputMethodEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__inputMethodQuery;
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		QVariant* callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_inputMethodQuery(this, handle__inputMethodQuery.value(), sigval1);
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__focusNextPrevChild;
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_focusNextPrevChild(this, handle__focusNextPrevChild.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QDesignerResourceBrowserInterface_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QDesignerResourceBrowserInterface_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QDesignerResourceBrowserInterface_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QDesignerResourceBrowserInterface_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
struct miqt_string QDesignerResourceBrowserInterface_trUtf8(const char* s) {
	QString _ret = QDesignerResourceBrowserInterface::trUtf8(s);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
void* QDesignerResourceBrowserInterface_connect_currentPathChanged(QDesignerResourceBrowserInterface* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface>>(slot);
	return new QMetaObject::Connection(QDesignerResourceBrowserInterface::connect(self, static_cast<void (QDesignerResourceBrowserInterface::*)(const QString&)>(&QDesignerResourceBrowserInterface::currentPathChanged), self, [slot_handle](const QString& filePath) {
...
void* QDesignerResourceBrowserInterface_connect_pathActivated(QDesignerResourceBrowserInterface* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface>>(slot);
	return new QMetaObject::Connection(QDesignerResourceBrowserInterface::connect(self, static_cast<void (QDesignerResourceBrowserInterface::*)(const QString&)>(&QDesignerResourceBrowserInterface::pathActivated), self, [slot_handle](const QString& filePath) {
		intptr_t slot = slot_handle->value();
		const QString filePath_ret = filePath;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray filePath_b = filePath_ret.toUtf8();
...
struct miqt_string QDesignerResourceBrowserInterface_trUtf82(const char* s, const char* c) {
	QString _ret = QDesignerResourceBrowserInterface::trUtf8(s, c);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
struct miqt_string QDesignerResourceBrowserInterface_trUtf83(const char* s, const char* c, int n) {
	QString _ret = QDesignerResourceBrowserInterface::trUtf8(s, c, static_cast<int>(n));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
bool QDesignerResourceBrowserInterface_override_virtual_setCurrentPath(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDesignerResourceBrowserInterface> slot_handle(slot);
	...
	self_cast->handle__setCurrentPath = std::move(slot_handle);
	return true;
}
...
bool QDesignerResourceBrowserInterface_override_virtual_currentPath(void* self, intptr_t slot) {
	...
	self_cast->handle__currentPath = std::move(slot_handle);
	return true;
}
...
void QDesignerResourceBrowserInterface_virtualbase_enterEvent(void* self, QEvent* event) {
...
bool QDesignerResourceBrowserInterface_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	QByteArray eventType_QByteArray(eventType.data, eventType.len);
	return static_cast<MiqtVirtualQDesignerResourceBrowserInterface*>(self)->QDesignerResourceBrowserInterface::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
