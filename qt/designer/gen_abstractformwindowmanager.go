...
func (this *QDesignerFormWindowManagerInterface) OnFormWindowAdded(slot func(formWindow *QDesignerFormWindowInterface)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QDesignerFormWindowManagerInterface_connect_formWindowAdded(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QDesignerFormWindowManagerInterface) OnFormWindowRemoved(slot func(formWindow *QDesignerFormWindowInterface)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QDesignerFormWindowManagerInterface_connect_formWindowRemoved(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QDesignerFormWindowManagerInterface) OnActiveFormWindowChanged(slot func(formWindow *QDesignerFormWindowInterface)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QDesignerFormWindowManagerInterface_connect_activeFormWindowChanged(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QDesignerFormWindowManagerInterface) OnFormWindowSettingsChanged(slot func(fw *QDesignerFormWindowInterface)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QDesignerFormWindowManagerInterface_connect_formWindowSettingsChanged(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
