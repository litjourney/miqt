...
func (this *QPrintDialog) OnAccepted(slot func(printer *QPrinter)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QPrintDialog_connect_accepted(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QPrintDialog) OnSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPrintDialog) OnMinimumSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPrintDialog) OnInputMethodQueryOwned(slot func(super func(param1 qt.InputMethodQuery) *qt.QVariant, param1 qt.InputMethodQuery) *qt.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
