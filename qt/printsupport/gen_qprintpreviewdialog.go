...
func (this *QPrintPreviewDialog) OnPaintRequested(slot func(printer *QPrinter)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QPrintPreviewDialog_connect_paintRequested(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QPrintPreviewDialog) OnSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPrintPreviewDialog) OnMinimumSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPrintPreviewDialog) OnInputMethodQueryOwned(slot func(super func(param1 qt.InputMethodQuery) *qt.QVariant, param1 qt.InputMethodQuery) *qt.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
