...
func (this *QPageSetupDialog) OnSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPageSetupDialog) OnMinimumSizeHintOwned(slot func(super func() *qt.QSize) *qt.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QPageSetupDialog) OnInputMethodQueryOwned(slot func(super func(param1 qt.InputMethodQuery) *qt.QVariant, param1 qt.InputMethodQuery) *qt.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
