...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QHeaderView> handle__viewOptions;
	...
	virtual QStyleOptionViewItem viewOptions() const override {
		...
		QStyleOptionViewItem* callback_return_value = miqt_exec_callback_QHeaderView_viewOptions(this, handle__viewOptions.value());
...
bool QHeaderView_override_virtual_owned_viewOptions(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QHeaderView> slot_handle(slot);
	MiqtVirtualQHeaderView* self_cast = dynamic_cast<MiqtVirtualQHeaderView*>( (QHeaderView*)(self) );
	if (self_cast == nullptr) {
		return false;
