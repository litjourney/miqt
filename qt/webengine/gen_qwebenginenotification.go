...
func (this *QWebEngineNotification) OnClosed(slot func()) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QWebEngineNotification_connect_closed(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
