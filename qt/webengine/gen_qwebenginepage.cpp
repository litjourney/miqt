...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebEnginePage> handle__certificateError;

	// Subclass to allow providing a Go implementation
	virtual bool certificateError(const QWebEngineCertificateError& certificateError) override {
		if (!handle__certificateError) {
		...
		bool callback_return_value = miqt_exec_callback_QWebEnginePage_certificateError(this, handle__certificateError.value(), sigval1);
		return callback_return_value;
	}
...
bool QWebEnginePage_override_virtual_certificateError(void* self, intptr_t slot) {
	...
	self_cast->handle__certificateError = std::move(slot_handle);
	return true;
}

bool QWebEnginePage_virtualbase_certificateError(void* self, QWebEngineCertificateError* certificateError) {
	return static_cast<MiqtVirtualQWebEnginePage*>(self)->QWebEnginePage::certificateError(*certificateError);
}
