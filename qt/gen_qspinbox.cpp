...
void* QSpinBox_connect_valueChangedWithQString(QSpinBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSpinBox>>(slot);
	return new QMetaObject::Connection(QSpinBox::connect(self, static_cast<void (QSpinBox::*)(const QString&)>(&QSpinBox::valueChanged), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QDoubleSpinBox_connect_valueChangedWithQString(QDoubleSpinBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QDoubleSpinBox>>(slot);
	return new QMetaObject::Connection(QDoubleSpinBox::connect(self, static_cast<void (QDoubleSpinBox::*)(const QString&)>(&QDoubleSpinBox::valueChanged), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
