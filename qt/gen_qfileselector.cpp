...
void miqt_exec_callback_handle_release_QFileSelector(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QFileSelector_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QFileSelector_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QFileSelector_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QFileSelector_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QFileSelector_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QFileSelector_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QFileSelector_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QFileSelector* QFileSelector_new() {
	return new (std::nothrow) MiqtVirtualQFileSelector();
}

QFileSelector* QFileSelector_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQFileSelector(parent);
}
...
bool QFileSelector_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QFileSelector> slot_handle(slot);
...
bool QFileSelector_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::event(event);
}
...
bool QFileSelector_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::eventFilter(watched, event);
}
...
void QFileSelector_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::timerEvent(event);
}
...
void QFileSelector_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::childEvent(event);
}
...
void QFileSelector_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::customEvent(event);
}
...
void QFileSelector_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::connectNotify(*signal);
}
...
void QFileSelector_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQFileSelector*>(self)->QFileSelector::disconnectNotify(*signal);
}
