...
public:
	...
	virtual void setPageSize(QPagedPaintDevice::PageSize size) override {
		...
		miqt_exec_callback_QPdfWriter_setPageSize(this, handle__setPageSize.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QPdfWriter> handle__setPageSizeMM;
	...
	virtual void setPageSizeMM(const QSizeF& size) override {
		...
		miqt_exec_callback_QPdfWriter_setPageSizeMM(this, handle__setPageSizeMM.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QPdfWriter> handle__setMargins;
	...
	virtual void setMargins(const QPagedPaintDevice::Margins& m) override {
		...
		miqt_exec_callback_QPdfWriter_setMargins(this, handle__setMargins.value(), sigval1);
