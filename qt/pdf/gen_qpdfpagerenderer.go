...
func (this *QPdfPageRenderer) OnDocumentChanged(slot func(document *QPdfDocument)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QPdfPageRenderer_connect_documentChanged(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QPdfPageRenderer) OnRenderModeChanged(slot func(renderMode QPdfPageRenderer__RenderMode)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QPdfPageRenderer_connect_renderModeChanged(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QPdfPageRenderer) OnPageRendered(slot func(pageNumber int, imageSize qt.QSize, image *qt.QImage, options QPdfDocumentRenderOptions, requestId uint64)) *qt.SignalConnection {
	_goptr := qt.UnsafeNewQMetaObject__Connection(C.QPdfPageRenderer_connect_pageRendered(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
