...
func (this *QTcpSocket) OnSocketOptionOwned(slot func(super func(option QAbstractSocket__SocketOption) *qt.QVariant, option QAbstractSocket__SocketOption) *qt.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
