...
void miqt_exec_callback_handle_release_QWebPluginFactory(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__plugins;
	...
	virtual QList<QWebPluginFactory::Plugin> plugins() const override {
		...
		struct miqt_array /* of QWebPluginFactory__Plugin* */  callback_return_value = miqt_exec_callback_QWebPluginFactory_plugins(this, handle__plugins.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__refreshPlugins;

	// Subclass to allow providing a Go implementation
	virtual void refreshPlugins() override {
		if (!handle__refreshPlugins) {
			QWebPluginFactory::refreshPlugins();
			return;
		}

		miqt_exec_callback_QWebPluginFactory_refreshPlugins(this, handle__refreshPlugins.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__create;
	...
	virtual QObject* create(const QString& mimeType, const QUrl& param2, const QStringList& argumentNames, const QStringList& argumentValues) const override {
		...
		QObject* callback_return_value = miqt_exec_callback_QWebPluginFactory_create(this, handle__create.value(), sigval1, sigval2, sigval3, sigval4);
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__extension;
	...
	virtual bool extension(QWebPluginFactory::Extension extension, const QWebPluginFactory::ExtensionOption* option, QWebPluginFactory::ExtensionReturn* output) override {
		...
		bool callback_return_value = miqt_exec_callback_QWebPluginFactory_extension(this, handle__extension.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__supportsExtension;
	...
	virtual bool supportsExtension(QWebPluginFactory::Extension extension) const override {
		...
		QWebPluginFactory::Extension extension_ret = extension;
		int sigval1 = static_cast<int>(extension_ret);
		bool callback_return_value = miqt_exec_callback_QWebPluginFactory_supportsExtension(this, handle__supportsExtension.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QWebPluginFactory_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QWebPluginFactory_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QWebPluginFactory_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QWebPluginFactory_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QWebPluginFactory_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QWebPluginFactory_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QWebPluginFactory_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
bool QWebPluginFactory_override_virtual_plugins(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QWebPluginFactory> slot_handle(slot);
	MiqtVirtualQWebPluginFactory* self_cast = dynamic_cast<MiqtVirtualQWebPluginFactory*>( (QWebPluginFactory*)(self) );
	if (self_cast == nullptr) {
		return false;
	}

	self_cast->handle__plugins = std::move(slot_handle);
	return true;
}
...
bool QWebPluginFactory_override_virtual_refreshPlugins(void* self, intptr_t slot) {
	...
	self_cast->handle__refreshPlugins = std::move(slot_handle);
	return true;
}
