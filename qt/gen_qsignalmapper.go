...
func (this *QSignalMapper) OnMapped(slot func(param1 int)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QSignalMapper_connect_mapped(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QSignalMapper) OnMappedWithQString(slot func(param1 string)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QSignalMapper_connect_mappedWithQString(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QSignalMapper) OnMappedWithQWidget(slot func(param1 *QWidget)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QSignalMapper_connect_mappedWithQWidget(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QSignalMapper) OnMappedWithQObject(slot func(param1 *QObject)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QSignalMapper_connect_mappedWithQObject(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QSignalMapper) OnMappedWidget(slot func(param1 *QWidget)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QSignalMapper_connect_mappedWidget(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
// Sender can only be called from a QSignalMapper that was directly constructed.
func (this *QSignalMapper) Sender() *QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := newQObject(C.QSignalMapper_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// SenderSignalIndex can only be called from a QSignalMapper that was directly constructed.
func (this *QSignalMapper) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QSignalMapper_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QSignalMapper that was directly constructed.
func (this *QSignalMapper) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QSignalMapper_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QSignalMapper that was directly constructed.
func (this *QSignalMapper) IsSignalConnected(signal *QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QSignalMapper_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal.cPointer()))
