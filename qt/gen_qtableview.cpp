...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTableView> handle__viewOptions;
	...
	virtual QStyleOptionViewItem viewOptions() const override {
		...
		QStyleOptionViewItem* callback_return_value = miqt_exec_callback_QTableView_viewOptions(this, handle__viewOptions.value());
...
bool QTableView_override_virtual_owned_viewOptions(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QTableView> slot_handle(slot);
	MiqtVirtualQTableView* self_cast = dynamic_cast<MiqtVirtualQTableView*>( (QTableView*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QStyleOptionViewItem* QTableView_virtualbase_viewOptions(const void* self) {
	return new QStyleOptionViewItem(static_cast<const MiqtVirtualQTableView*>(self)->QTableView::viewOptions());
}
...
bool QTableView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQTableView*>(self)->QTableView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
