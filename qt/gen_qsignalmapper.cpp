...
void* QSignalMapper_connect_mapped(QSignalMapper* self, intptr_t slot) {
	...
	return new QMetaObject::Connection(QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(int)>(&QSignalMapper::mapped), self, [slot_handle](int param1) {
...
void* QSignalMapper_connect_mappedWithQString(QSignalMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSignalMapper>>(slot);
	return new QMetaObject::Connection(QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(const QString&)>(&QSignalMapper::mapped), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
...
void* QSignalMapper_connect_mappedWithQWidget(QSignalMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSignalMapper>>(slot);
	return new QMetaObject::Connection(QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(QWidget*)>(&QSignalMapper::mapped), self, [slot_handle](QWidget* param1) {
		intptr_t slot = slot_handle->value();
...
void* QSignalMapper_connect_mappedWithQObject(QSignalMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSignalMapper>>(slot);
	return new QMetaObject::Connection(QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(QObject*)>(&QSignalMapper::mapped), self, [slot_handle](QObject* param1) {
		intptr_t slot = slot_handle->value();
...
void* QSignalMapper_connect_mappedWidget(QSignalMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSignalMapper>>(slot);
	return new QMetaObject::Connection(QSignalMapper::connect(self, static_cast<void (QSignalMapper::*)(QWidget*)>(&QSignalMapper::mappedWidget), self, [slot_handle](QWidget* param1) {
		intptr_t slot = slot_handle->value();
		QWidget* sigval1 = param1;
