...
void QPushButton_virtualbase_mouseMoveEvent(void* self, QMouseEvent* e) {
	static_cast<MiqtVirtualQPushButton*>(self)->QPushButton::mouseMoveEvent(e);
}
...
bool QPushButton_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQPushButton*>(self)->QPushButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
