...
QWidget* QBoxLayout_virtualbase_widget(void* self) {
	return static_cast<MiqtVirtualQBoxLayout*>(self)->QBoxLayout::widget();
}
...
QWidget* QHBoxLayout_virtualbase_widget(void* self) {
	return static_cast<MiqtVirtualQHBoxLayout*>(self)->QHBoxLayout::widget();
}
...
QWidget* QVBoxLayout_virtualbase_widget(void* self) {
	return static_cast<MiqtVirtualQVBoxLayout*>(self)->QVBoxLayout::widget();
}
