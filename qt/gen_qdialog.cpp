...
bool QDialog_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDialog> slot_handle(slot);
	MiqtVirtualQDialog* self_cast = dynamic_cast<MiqtVirtualQDialog*>( (QDialog*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QDialog_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDialog> slot_handle(slot);
	MiqtVirtualQDialog* self_cast = dynamic_cast<MiqtVirtualQDialog*>( (QDialog*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQDialog*>(self)->QDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
bool QDialog_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDialog> slot_handle(slot);
	MiqtVirtualQDialog* self_cast = dynamic_cast<MiqtVirtualQDialog*>( (QDialog*)(self) );
	if (self_cast == nullptr) {
		return false;
