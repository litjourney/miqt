...
bool QFontComboBox_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QFontComboBox> slot_handle(slot);
	MiqtVirtualQFontComboBox* self_cast = dynamic_cast<MiqtVirtualQFontComboBox*>( (QFontComboBox*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QFontComboBox_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QFontComboBox> slot_handle(slot);
	MiqtVirtualQFontComboBox* self_cast = dynamic_cast<MiqtVirtualQFontComboBox*>( (QFontComboBox*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QFontComboBox_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QFontComboBox> slot_handle(slot);
	MiqtVirtualQFontComboBox* self_cast = dynamic_cast<MiqtVirtualQFontComboBox*>( (QFontComboBox*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QFontComboBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQFontComboBox*>(self)->QFontComboBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
