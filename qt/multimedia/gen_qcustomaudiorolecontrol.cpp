...
void miqt_exec_callback_handle_release_QCustomAudioRoleControl(intptr_t);
...
void* QCustomAudioRoleControl_connect_customAudioRoleChanged(QCustomAudioRoleControl* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QCustomAudioRoleControl>>(slot);
	return new QMetaObject::Connection(QCustomAudioRoleControl::connect(self, static_cast<void (QCustomAudioRoleControl::*)(const QString&)>(&QCustomAudioRoleControl::customAudioRoleChanged), self, [slot_handle](const QString& role) {
