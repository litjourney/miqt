...
void miqt_exec_callback_handle_release_QSound(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QSound_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QSound_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QSound_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QSound_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QSound_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QSound_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QSound_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QSound* QSound_new(struct miqt_string filename) {
	...
	return new (std::nothrow) MiqtVirtualQSound(filename_QString);
}

QSound* QSound_new2(struct miqt_string filename, QObject* parent) {
	QString filename_QString = QString::fromUtf8(filename.data, filename.len);
	return new (std::nothrow) MiqtVirtualQSound(filename_QString, parent);
}
...
bool QSound_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSound> slot_handle(slot);
...
bool QSound_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQSound*>(self)->QSound::event(event);
}
...
bool QSound_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQSound*>(self)->QSound::eventFilter(watched, event);
}
...
void QSound_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQSound*>(self)->QSound::timerEvent(event);
}
...
void QSound_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQSound*>(self)->QSound::childEvent(event);
}
...
void QSound_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQSound*>(self)->QSound::customEvent(event);
}
...
void QSound_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQSound*>(self)->QSound::connectNotify(*signal);
}
...
void QSound_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQSound*>(self)->QSound::disconnectNotify(*signal);
}
