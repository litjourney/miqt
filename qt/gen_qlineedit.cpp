...
void QLineEdit_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<MiqtVirtualQLineEdit*>(self)->QLineEdit::keyReleaseEvent(event);
}
...
bool QLineEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQLineEdit*>(self)->QLineEdit::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
void QLineEdit_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQLineEdit*>(self)->QLineEdit::timerEvent(event);
}
