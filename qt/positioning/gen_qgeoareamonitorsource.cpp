...
struct miqt_string QGeoAreaMonitorSource_trUtf8(const char* s) {
...
void* QGeoAreaMonitorSource_connect_errorWithError(QGeoAreaMonitorSource* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QGeoAreaMonitorSource>>(slot);
	return new QMetaObject::Connection(QGeoAreaMonitorSource::connect(self, static_cast<void (QGeoAreaMonitorSource::*)(QGeoAreaMonitorSource::Error)>(&QGeoAreaMonitorSource::error), self, [slot_handle](QGeoAreaMonitorSource::Error error) {
		intptr_t slot = slot_handle->value();
...
struct miqt_string QGeoAreaMonitorSource_trUtf83(const char* s, const char* c, int n) {
