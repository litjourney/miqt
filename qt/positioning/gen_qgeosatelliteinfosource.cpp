...
void* QGeoSatelliteInfoSource_connect_requestTimeout(QGeoSatelliteInfoSource* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QGeoSatelliteInfoSource>>(slot);
	return new QMetaObject::Connection(QGeoSatelliteInfoSource::connect(self, static_cast<void (QGeoSatelliteInfoSource::*)()>(&QGeoSatelliteInfoSource::requestTimeout), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QGeoSatelliteInfoSource_connect_errorWithQGeoSatelliteInfoSourceError(QGeoSatelliteInfoSource* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QGeoSatelliteInfoSource>>(slot);
	return new QMetaObject::Connection(QGeoSatelliteInfoSource::connect(self, static_cast<void (QGeoSatelliteInfoSource::*)(QGeoSatelliteInfoSource::Error)>(&QGeoSatelliteInfoSource::error), self, [slot_handle](QGeoSatelliteInfoSource::Error param1) {
		intptr_t slot = slot_handle->value();
