...
struct miqt_string QGeoPositionInfoSource_trUtf8(const char* s) {
...
void* QGeoPositionInfoSource_connect_updateTimeout(QGeoPositionInfoSource* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QGeoPositionInfoSource>>(slot);
	return new QMetaObject::Connection(QGeoPositionInfoSource::connect(self, static_cast<void (QGeoPositionInfoSource::*)()>(&QGeoPositionInfoSource::updateTimeout), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QGeoPositionInfoSource_connect_errorWithQGeoPositionInfoSourceError(QGeoPositionInfoSource* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QGeoPositionInfoSource>>(slot);
	return new QMetaObject::Connection(QGeoPositionInfoSource::connect(self, static_cast<void (QGeoPositionInfoSource::*)(QGeoPositionInfoSource::Error)>(&QGeoPositionInfoSource::error), self, [slot_handle](QGeoPositionInfoSource::Error param1) {
		intptr_t slot = slot_handle->value();
...
struct miqt_string QGeoPositionInfoSource_trUtf82(const char* s, const char* c) {
...
struct miqt_string QGeoPositionInfoSource_trUtf83(const char* s, const char* c, int n) {
