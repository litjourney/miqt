...
void miqt_exec_callback_handle_release_QComboBox(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__sizeHint;
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QComboBox_sizeHint(this, handle__sizeHint.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__minimumSizeHint;
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QComboBox_minimumSizeHint(this, handle__minimumSizeHint.value());
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__showPopup;
	...
	virtual void showPopup() override {
		...
		miqt_exec_callback_QComboBox_showPopup(this, handle__showPopup.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__hidePopup;
	...
	virtual void hidePopup() override {
		...
		miqt_exec_callback_QComboBox_hidePopup(this, handle__hidePopup.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QComboBox_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__inputMethodQuery;
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		QVariant* callback_return_value = miqt_exec_callback_QComboBox_inputMethodQuery(this, handle__inputMethodQuery.value(), sigval1);
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__focusInEvent;
	...
	virtual void focusInEvent(QFocusEvent* e) override {
		...
		miqt_exec_callback_QComboBox_focusInEvent(this, handle__focusInEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__focusOutEvent;
	...
	virtual void focusOutEvent(QFocusEvent* e) override {
		...
		QFocusEvent* sigval1 = e;
		miqt_exec_callback_QComboBox_focusOutEvent(this, handle__focusOutEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__changeEvent;
	...
	virtual void changeEvent(QEvent* e) override {
		...
		QEvent* sigval1 = e;
		miqt_exec_callback_QComboBox_changeEvent(this, handle__changeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__resizeEvent;
	...
	virtual void resizeEvent(QResizeEvent* e) override {
		...
		miqt_exec_callback_QComboBox_resizeEvent(this, handle__resizeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__paintEvent;
	...
	virtual void paintEvent(QPaintEvent* e) override {
		...
		miqt_exec_callback_QComboBox_paintEvent(this, handle__paintEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__showEvent;
	...
	virtual void showEvent(QShowEvent* e) override {
		...
		miqt_exec_callback_QComboBox_showEvent(this, handle__showEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__hideEvent;
	...
	virtual void hideEvent(QHideEvent* e) override {
		...
		miqt_exec_callback_QComboBox_hideEvent(this, handle__hideEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__mousePressEvent;
	...
	virtual void mousePressEvent(QMouseEvent* e) override {
		...
		miqt_exec_callback_QComboBox_mousePressEvent(this, handle__mousePressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__mouseReleaseEvent;
	...
	virtual void mouseReleaseEvent(QMouseEvent* e) override {
		...
		QMouseEvent* sigval1 = e;
		miqt_exec_callback_QComboBox_mouseReleaseEvent(this, handle__mouseReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__keyPressEvent;
	...
	virtual void keyPressEvent(QKeyEvent* e) override {
		...
		QKeyEvent* sigval1 = e;
		miqt_exec_callback_QComboBox_keyPressEvent(this, handle__keyPressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__keyReleaseEvent;
	...
	virtual void keyReleaseEvent(QKeyEvent* e) override {
		...
		QKeyEvent* sigval1 = e;
		miqt_exec_callback_QComboBox_keyReleaseEvent(this, handle__keyReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__wheelEvent;
	...
	virtual void wheelEvent(QWheelEvent* e) override {
		...
		miqt_exec_callback_QComboBox_wheelEvent(this, handle__wheelEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__contextMenuEvent;
	...
	virtual void contextMenuEvent(QContextMenuEvent* e) override {
		...
		miqt_exec_callback_QComboBox_contextMenuEvent(this, handle__contextMenuEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__inputMethodEvent;
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QComboBox_inputMethodEvent(this, handle__inputMethodEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__devType;
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QComboBox_devType(this, handle__devType.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__setVisible;
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QComboBox_setVisible(this, handle__setVisible.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__heightForWidth;
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QComboBox_heightForWidth(this, handle__heightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__hasHeightForWidth;
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QComboBox_hasHeightForWidth(this, handle__hasHeightForWidth.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__paintEngine;
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QComboBox_paintEngine(this, handle__paintEngine.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__mouseDoubleClickEvent;
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QComboBox_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__mouseMoveEvent;
	...
	virtual void mouseMoveEvent(QMouseEvent* event) override {
		...
		QMouseEvent* sigval1 = event;
		miqt_exec_callback_QComboBox_mouseMoveEvent(this, handle__mouseMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__enterEvent;
	...
	virtual void enterEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QComboBox_enterEvent(this, handle__enterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__leaveEvent;
	...
	virtual void leaveEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QComboBox_leaveEvent(this, handle__leaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__moveEvent;
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QComboBox_moveEvent(this, handle__moveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__closeEvent;
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QComboBox_closeEvent(this, handle__closeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__tabletEvent;
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QComboBox_tabletEvent(this, handle__tabletEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__actionEvent;
	...
	virtual void actionEvent(QActionEvent* event) override {
		...
		miqt_exec_callback_QComboBox_actionEvent(this, handle__actionEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__dragEnterEvent;
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QComboBox_dragEnterEvent(this, handle__dragEnterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__dragMoveEvent;
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QComboBox_dragMoveEvent(this, handle__dragMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__dragLeaveEvent;
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QComboBox_dragLeaveEvent(this, handle__dragLeaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__dropEvent;
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QComboBox_dropEvent(this, handle__dropEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__nativeEvent;
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, long* result) override {
		...
		long* sigval3 = result;
		bool callback_return_value = miqt_exec_callback_QComboBox_nativeEvent(this, handle__nativeEvent.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__metric;
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		int callback_return_value = miqt_exec_callback_QComboBox_metric(this, handle__metric.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__initPainter;
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QComboBox_initPainter(this, handle__initPainter.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__redirected;
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QComboBox_redirected(this, handle__redirected.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__sharedPainter;
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QComboBox_sharedPainter(this, handle__sharedPainter.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__focusNextPrevChild;
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QComboBox_focusNextPrevChild(this, handle__focusNextPrevChild.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QComboBox_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QComboBox_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QComboBox_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QComboBox_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QComboBox_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QComboBox_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QComboBox* QComboBox_new(QWidget* parent) {
	return new (std::nothrow) MiqtVirtualQComboBox(parent);
}

QComboBox* QComboBox_new2() {
	return new (std::nothrow) MiqtVirtualQComboBox();
}
...
void* QComboBox_connect_editTextChanged(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::editTextChanged), self, [slot_handle](const QString& param1) {
...
void* QComboBox_connect_activated(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(int)>(&QComboBox::activated), self, [slot_handle](int index) {
		intptr_t slot = slot_handle->value();
		int sigval1 = index;
...
void* QComboBox_connect_textActivated(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::textActivated), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QComboBox_connect_highlighted(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(int)>(&QComboBox::highlighted), self, [slot_handle](int index) {
		intptr_t slot = slot_handle->value();
		int sigval1 = index;
...
void* QComboBox_connect_textHighlighted(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::textHighlighted), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QComboBox_connect_currentIndexChanged(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), self, [slot_handle](int index) {
		intptr_t slot = slot_handle->value();
		int sigval1 = index;
...
void* QComboBox_connect_currentIndexChangedWithQString(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::currentIndexChanged), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QComboBox_connect_currentTextChanged(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::currentTextChanged), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QComboBox_connect_activatedWithQString(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::activated), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
void* QComboBox_connect_highlightedWithQString(QComboBox* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox>>(slot);
	return new QMetaObject::Connection(QComboBox::connect(self, static_cast<void (QComboBox::*)(const QString&)>(&QComboBox::highlighted), self, [slot_handle](const QString& param1) {
		intptr_t slot = slot_handle->value();
		const QString param1_ret = param1;
		// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
		QByteArray param1_b = param1_ret.toUtf8();
...
bool QComboBox_override_virtual_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> slot_handle(slot);
...
QSize* QComboBox_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::sizeHint());
}
...
QSize* QComboBox_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::minimumSizeHint());
}
...
void QComboBox_virtualbase_showPopup(void* self) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::showPopup();
}
...
void QComboBox_virtualbase_hidePopup(void* self) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::hidePopup();
}
...
bool QComboBox_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::event(event);
}
...
QVariant* QComboBox_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
void QComboBox_virtualbase_focusInEvent(void* self, QFocusEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::focusInEvent(e);
}
...
void QComboBox_virtualbase_focusOutEvent(void* self, QFocusEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::focusOutEvent(e);
}
...
void QComboBox_virtualbase_changeEvent(void* self, QEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::changeEvent(e);
}
...
void QComboBox_virtualbase_resizeEvent(void* self, QResizeEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::resizeEvent(e);
}
...
void QComboBox_virtualbase_paintEvent(void* self, QPaintEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::paintEvent(e);
}
...
void QComboBox_virtualbase_showEvent(void* self, QShowEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::showEvent(e);
}
...
void QComboBox_virtualbase_hideEvent(void* self, QHideEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::hideEvent(e);
}
...
void QComboBox_virtualbase_mousePressEvent(void* self, QMouseEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::mousePressEvent(e);
}
...
void QComboBox_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::mouseReleaseEvent(e);
}
...
void QComboBox_virtualbase_keyPressEvent(void* self, QKeyEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::keyPressEvent(e);
}
...
void QComboBox_virtualbase_keyReleaseEvent(void* self, QKeyEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::keyReleaseEvent(e);
}
...
void QComboBox_virtualbase_wheelEvent(void* self, QWheelEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::wheelEvent(e);
}
...
void QComboBox_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* e) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::contextMenuEvent(e);
}
...
void QComboBox_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::inputMethodEvent(param1);
}
...
int QComboBox_virtualbase_devType(const void* self) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::devType();
}
...
void QComboBox_virtualbase_setVisible(void* self, bool visible) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::setVisible(visible);
}
...
int QComboBox_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::heightForWidth(static_cast<int>(param1));
}
...
bool QComboBox_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::hasHeightForWidth();
}
...
QPaintEngine* QComboBox_virtualbase_paintEngine(const void* self) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::paintEngine();
}
...
void QComboBox_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::mouseDoubleClickEvent(event);
}
...
void QComboBox_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::mouseMoveEvent(event);
}
...
void QComboBox_virtualbase_enterEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::enterEvent(event);
}
...
void QComboBox_virtualbase_leaveEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::leaveEvent(event);
}
...
void QComboBox_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::moveEvent(event);
}
...
void QComboBox_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::closeEvent(event);
}
...
void QComboBox_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::tabletEvent(event);
}
...
void QComboBox_virtualbase_actionEvent(void* self, QActionEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::actionEvent(event);
}
...
void QComboBox_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::dragEnterEvent(event);
}
...
void QComboBox_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::dragMoveEvent(event);
}
...
void QComboBox_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::dragLeaveEvent(event);
}
...
void QComboBox_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::dropEvent(event);
}
...
bool QComboBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
}
...
void QComboBox_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::initPainter(painter);
}
...
QPaintDevice* QComboBox_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::redirected(offset);
}
...
QPainter* QComboBox_virtualbase_sharedPainter(const void* self) {
	return static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::sharedPainter();
}
...
bool QComboBox_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::focusNextPrevChild(next);
}
...
bool QComboBox_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::eventFilter(watched, event);
}
...
void QComboBox_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::timerEvent(event);
}
...
void QComboBox_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::childEvent(event);
}
...
void QComboBox_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::customEvent(event);
}
...
void QComboBox_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::connectNotify(*signal);
}
...
void QComboBox_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::disconnectNotify(*signal);
}
