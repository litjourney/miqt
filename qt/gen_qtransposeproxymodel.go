...
// ResetInternalData can only be called from a QTransposeProxyModel that was directly constructed.
func (this *QTransposeProxyModel) ResetInternalData() {

	var _dynamic_cast_ok C.bool = false
	C.QTransposeProxyModel_protectedbase_resetInternalData(&_dynamic_cast_ok, unsafe.Pointer(this.h))
