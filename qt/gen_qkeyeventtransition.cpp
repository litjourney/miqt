...
void miqt_exec_callback_handle_release_QKeyEventTransition(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__onTransition;
	...
	virtual void onTransition(QEvent* event) override {
		...
		miqt_exec_callback_QKeyEventTransition_onTransition(this, handle__onTransition.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__eventTest;
	...
	virtual bool eventTest(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		bool callback_return_value = miqt_exec_callback_QKeyEventTransition_eventTest(this, handle__eventTest.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__event;
	...
	virtual bool event(QEvent* e) override {
		...
		QEvent* sigval1 = e;
		bool callback_return_value = miqt_exec_callback_QKeyEventTransition_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QKeyEventTransition_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QKeyEventTransition_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QKeyEventTransition_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QKeyEventTransition_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QKeyEventTransition_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QKeyEventTransition_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QKeyEventTransition* QKeyEventTransition_new() {
	return new (std::nothrow) MiqtVirtualQKeyEventTransition();
}

QKeyEventTransition* QKeyEventTransition_new2(QObject* object, int type, int key) {
	return new (std::nothrow) MiqtVirtualQKeyEventTransition(object, static_cast<QEvent::Type>(type), static_cast<int>(key));
}
...
QKeyEventTransition* QKeyEventTransition_new4(QObject* object, int type, int key, QState* sourceState) {
	return new (std::nothrow) MiqtVirtualQKeyEventTransition(object, static_cast<QEvent::Type>(type), static_cast<int>(key), sourceState);
}
...
bool QKeyEventTransition_override_virtual_onTransition(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeyEventTransition> slot_handle(slot);
...
void QKeyEventTransition_virtualbase_onTransition(void* self, QEvent* event) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::onTransition(event);
}
...
bool QKeyEventTransition_virtualbase_eventTest(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::eventTest(event);
}
...
bool QKeyEventTransition_virtualbase_event(void* self, QEvent* e) {
	return static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::event(e);
}
...
bool QKeyEventTransition_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::eventFilter(watched, event);
}
...
void QKeyEventTransition_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::timerEvent(event);
}
...
void QKeyEventTransition_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::childEvent(event);
}
...
void QKeyEventTransition_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::customEvent(event);
}
...
void QKeyEventTransition_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::connectNotify(*signal);
}
...
void QKeyEventTransition_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQKeyEventTransition*>(self)->QKeyEventTransition::disconnectNotify(*signal);
}
