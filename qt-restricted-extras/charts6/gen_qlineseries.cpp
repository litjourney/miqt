...
void miqt_exec_callback_handle_release_QLineSeries(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__type;
	...
	virtual QAbstractSeries::SeriesType type() const override {
		...
		int callback_return_value = miqt_exec_callback_QLineSeries_type(this, handle__type.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__setPen;
	...
	virtual void setPen(const QPen& pen) override {
		...
		miqt_exec_callback_QLineSeries_setPen(this, handle__setPen.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__setBrush;
	...
	virtual void setBrush(const QBrush& brush) override {
		...
		miqt_exec_callback_QLineSeries_setBrush(this, handle__setBrush.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__setColor;
	...
	virtual void setColor(const QColor& color) override {
		...
		miqt_exec_callback_QLineSeries_setColor(this, handle__setColor.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__color;
	...
	virtual QColor color() const override {
		...
		QColor* callback_return_value = miqt_exec_callback_QLineSeries_color(this, handle__color.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QLineSeries_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QLineSeries_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QLineSeries_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QLineSeries_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QLineSeries_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QLineSeries_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QLineSeries_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
bool QLineSeries_override_virtual_type(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> slot_handle(slot);
...
bool QLineSeries_override_virtual_owned_color(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLineSeries> slot_handle(slot);
	MiqtVirtualQLineSeries* self_cast = dynamic_cast<MiqtVirtualQLineSeries*>( (QLineSeries*)(self) );
	if (self_cast == nullptr) {
		return false;
