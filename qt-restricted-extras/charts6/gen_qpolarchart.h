...
bool QPolarChart_override_virtual_owned_boundingRect(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_shape(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_sizeHint(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_itemChange(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_propertyChange(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_opaqueArea(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot);
...
bool QPolarChart_override_virtual_owned_extension(void* self, intptr_t slot);
