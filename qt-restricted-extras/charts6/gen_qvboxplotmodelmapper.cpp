...
void miqt_exec_callback_handle_release_QVBoxPlotModelMapper(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QVBoxPlotModelMapper_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QVBoxPlotModelMapper_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QVBoxPlotModelMapper_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QVBoxPlotModelMapper_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QVBoxPlotModelMapper_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QVBoxPlotModelMapper_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QVBoxPlotModelMapper_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QVBoxPlotModelMapper* QVBoxPlotModelMapper_new() {
	return new (std::nothrow) MiqtVirtualQVBoxPlotModelMapper();
}

QVBoxPlotModelMapper* QVBoxPlotModelMapper_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQVBoxPlotModelMapper(parent);
}
...
void* QVBoxPlotModelMapper_connect_seriesReplaced(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::seriesReplaced), self, [slot_handle]() {
...
void* QVBoxPlotModelMapper_connect_modelReplaced(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::modelReplaced), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QVBoxPlotModelMapper_connect_firstBoxSetColumnChanged(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::firstBoxSetColumnChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QVBoxPlotModelMapper_connect_lastBoxSetColumnChanged(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::lastBoxSetColumnChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QVBoxPlotModelMapper_connect_firstRowChanged(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::firstRowChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QVBoxPlotModelMapper_connect_rowCountChanged(QVBoxPlotModelMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper>>(slot);
	return new QMetaObject::Connection(QVBoxPlotModelMapper::connect(self, static_cast<void (QVBoxPlotModelMapper::*)()>(&QVBoxPlotModelMapper::rowCountChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
bool QVBoxPlotModelMapper_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QVBoxPlotModelMapper> slot_handle(slot);
...
bool QVBoxPlotModelMapper_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::event(event);
}
...
bool QVBoxPlotModelMapper_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::eventFilter(watched, event);
}
...
void QVBoxPlotModelMapper_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::timerEvent(event);
}
...
void QVBoxPlotModelMapper_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::childEvent(event);
}
...
void QVBoxPlotModelMapper_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::customEvent(event);
}
...
void QVBoxPlotModelMapper_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::connectNotify(*signal);
}
...
void QVBoxPlotModelMapper_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQVBoxPlotModelMapper*>(self)->QVBoxPlotModelMapper::disconnectNotify(*signal);
}
