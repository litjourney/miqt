...
QCandlestickModelMapper* QCandlestickModelMapper_new() {
	return new (std::nothrow) MiqtVirtualQCandlestickModelMapper();
}

QCandlestickModelMapper* QCandlestickModelMapper_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQCandlestickModelMapper(parent);
}
...
bool QCandlestickModelMapper_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::event(event);
}
...
bool QCandlestickModelMapper_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::eventFilter(watched, event);
}
...
void QCandlestickModelMapper_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::timerEvent(event);
}
...
void QCandlestickModelMapper_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::childEvent(event);
}
...
void QCandlestickModelMapper_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::customEvent(event);
}
...
void QCandlestickModelMapper_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::connectNotify(*signal);
}
...
void QCandlestickModelMapper_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQCandlestickModelMapper*>(self)->QCandlestickModelMapper::disconnectNotify(*signal);
}
