...
//export miqt_exec_callback_handle_release_QsciLexerCustom
func miqt_exec_callback_handle_release_QsciLexerCustom(cb C.intptr_t) {
...
func (this *QsciLexerCustom) OnStyleText(slot func(start int, end int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_styleText(unsafe.Pointer(this.h), slotHandle)
	if !ok {
...
func (this *QsciLexerCustom) OnSetEditor(slot func(super func(editor *QsciScintilla), editor *QsciScintilla)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setEditor(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnStyleBitsNeeded(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_styleBitsNeeded(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnLanguage(slot func() string) {
	...
	ok := C.QsciLexerCustom_override_virtual_language(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnLexer(slot func(super func() string) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_lexer(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnLexerId(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_lexerId(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnAutoCompletionFillups(slot func(super func() string) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_autoCompletionFillups(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnAutoCompletionWordSeparators(slot func(super func() []string) []string) {
	...
	ok := C.QsciLexerCustom_override_virtual_autoCompletionWordSeparators(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnBlockEnd(slot func(super func(style *int) string, style *int) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_blockEnd(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnBlockLookback(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_blockLookback(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnBlockStart(slot func(super func(style *int) string, style *int) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_blockStart(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnBlockStartKeyword(slot func(super func(style *int) string, style *int) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_blockStartKeyword(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnBraceStyle(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_braceStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnCaseSensitive(slot func(super func() bool) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_caseSensitive(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QsciLexerCustom_color struct {
...
func (this *QsciLexerCustom) OnColor(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_color{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_color(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnColorOwned(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_color{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_color(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_color(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QColor {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_color)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QsciLexerCustom) OnEolFill(slot func(super func(style int) bool, style int) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_eolFill(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QsciLexerCustom_font struct {
...
func (this *QsciLexerCustom) OnFont(slot func(super func(style int) *qt.QFont, style int) *qt.QFont) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_font{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_font(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QsciLexerCustom) OnFontOwned(slot func(super func(style int) *qt.QFont, style int) *qt.QFont) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_font{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_font(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_font(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QFont {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_font)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QsciLexerCustom) OnIndentationGuideView(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_indentationGuideView(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnKeywords(slot func(super func(set int) string, set int) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_keywords(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnDefaultStyle(slot func(super func() int) int) {
	...
	ok := C.QsciLexerCustom_override_virtual_defaultStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnDescription(slot func(style int) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_description(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QsciLexerCustom_paper struct {
	callback   func(super func(style int) *qt.QColor, style int) *qt.QColor
	ownsReturn bool
}
...
func (this *QsciLexerCustom) OnPaper(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_paper{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_paper(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QsciLexerCustom) OnPaperOwned(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_paper{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_paper(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_paper(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QColor {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_paper)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
type miqtVirtualCallback_QsciLexerCustom_defaultColorWithStyle struct {
	callback   func(super func(style int) *qt.QColor, style int) *qt.QColor
	ownsReturn bool
}
...
func (this *QsciLexerCustom) OnDefaultColorWithStyle(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultColorWithStyle{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_defaultColorWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QsciLexerCustom) OnDefaultColorWithStyleOwned(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultColorWithStyle{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_defaultColorWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_defaultColorWithStyle(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QColor {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_defaultColorWithStyle)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QsciLexerCustom) OnDefaultEolFill(slot func(super func(style int) bool, style int) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_defaultEolFill(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QsciLexerCustom_defaultFontWithStyle struct {
	callback   func(super func(style int) *qt.QFont, style int) *qt.QFont
	ownsReturn bool
}
...
func (this *QsciLexerCustom) OnDefaultFontWithStyle(slot func(super func(style int) *qt.QFont, style int) *qt.QFont) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultFontWithStyle{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_defaultFontWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QsciLexerCustom) OnDefaultFontWithStyleOwned(slot func(super func(style int) *qt.QFont, style int) *qt.QFont) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultFontWithStyle{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_defaultFontWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_defaultFontWithStyle(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QFont {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_defaultFontWithStyle)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
type miqtVirtualCallback_QsciLexerCustom_defaultPaperWithStyle struct {
	callback   func(super func(style int) *qt.QColor, style int) *qt.QColor
	ownsReturn bool
}
...
func (this *QsciLexerCustom) OnDefaultPaperWithStyle(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultPaperWithStyle{callback: slot}))
	}
	ok := C.QsciLexerCustom_override_virtual_defaultPaperWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QsciLexerCustom) OnDefaultPaperWithStyleOwned(slot func(super func(style int) *qt.QColor, style int) *qt.QColor) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QsciLexerCustom_defaultPaperWithStyle{callback: slot, ownsReturn: true}))
	}
	ok := C.QsciLexerCustom_override_virtual_owned_defaultPaperWithStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QsciLexerCustom_defaultPaperWithStyle(self *C.QsciLexerCustom, cb C.intptr_t, style C.int) *C.QColor {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QsciLexerCustom_defaultPaperWithStyle)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QsciLexerCustom) OnRefreshProperties(slot func(super func())) {
	...
	ok := C.QsciLexerCustom_override_virtual_refreshProperties(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnWordCharacters(slot func(super func() string) string) {
	...
	ok := C.QsciLexerCustom_override_virtual_wordCharacters(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnSetAutoIndentStyle(slot func(super func(autoindentstyle int), autoindentstyle int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setAutoIndentStyle(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnSetColor(slot func(super func(c *qt.QColor, style int), c *qt.QColor, style int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setColor(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnSetEolFill(slot func(super func(eoffill bool, style int), eoffill bool, style int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setEolFill(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnSetFont(slot func(super func(f *qt.QFont, style int), f *qt.QFont, style int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setFont(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnSetPaper(slot func(super func(c *qt.QColor, style int), c *qt.QColor, style int)) {
	...
	ok := C.QsciLexerCustom_override_virtual_setPaper(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnReadProperties(slot func(super func(qs *qt.QSettings, prefix string) bool, qs *qt.QSettings, prefix string) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_readProperties(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnWriteProperties(slot func(super func(qs *qt.QSettings, prefix string) bool, qs *qt.QSettings, prefix string) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_writeProperties(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnEvent(slot func(super func(event *qt.QEvent) bool, event *qt.QEvent) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_event(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnEventFilter(slot func(super func(watched *qt.QObject, event *qt.QEvent) bool, watched *qt.QObject, event *qt.QEvent) bool) {
	...
	ok := C.QsciLexerCustom_override_virtual_eventFilter(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnTimerEvent(slot func(super func(event *qt.QTimerEvent), event *qt.QTimerEvent)) {
	...
	ok := C.QsciLexerCustom_override_virtual_timerEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnChildEvent(slot func(super func(event *qt.QChildEvent), event *qt.QChildEvent)) {
	...
	ok := C.QsciLexerCustom_override_virtual_childEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnCustomEvent(slot func(super func(event *qt.QEvent), event *qt.QEvent)) {
	...
	ok := C.QsciLexerCustom_override_virtual_customEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnConnectNotify(slot func(super func(signal *qt.QMetaMethod), signal *qt.QMetaMethod)) {
	...
	ok := C.QsciLexerCustom_override_virtual_connectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QsciLexerCustom) OnDisconnectNotify(slot func(super func(signal *qt.QMetaMethod), signal *qt.QMetaMethod)) {
	...
	ok := C.QsciLexerCustom_override_virtual_disconnectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
