...
bool QsciLexerVHDL_override_virtual_owned_color(void* self, intptr_t slot);
...
bool QsciLexerVHDL_override_virtual_owned_font(void* self, intptr_t slot);
...
bool QsciLexerVHDL_override_virtual_owned_paper(void* self, intptr_t slot);
...
bool QsciLexerVHDL_override_virtual_owned_defaultColorWithStyle(void* self, intptr_t slot);
...
bool QsciLexerVHDL_override_virtual_owned_defaultFontWithStyle(void* self, intptr_t slot);
...
bool QsciLexerVHDL_override_virtual_owned_defaultPaperWithStyle(void* self, intptr_t slot);
