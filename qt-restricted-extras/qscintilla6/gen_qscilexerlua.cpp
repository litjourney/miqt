...
void miqt_exec_callback_handle_release_QsciLexerLua(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setFoldCompact;
	...
	virtual void setFoldCompact(bool fold) override {
		...
		bool sigval1 = fold;
		miqt_exec_callback_QsciLexerLua_setFoldCompact(this, handle__setFoldCompact.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_setFoldCompact(void* self, bool fold);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__language;
	...
	virtual const char* language() const override {
		...
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_language(this, handle__language.value());
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__lexer;
	...
	virtual const char* lexer() const override {
		...
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_lexer(this, handle__lexer.value());
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_lexer(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__lexerId;
	...
	virtual int lexerId() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_lexerId(this, handle__lexerId.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_lexerId(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__autoCompletionFillups;
	...
	virtual const char* autoCompletionFillups() const override {
		...
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_autoCompletionFillups(this, handle__autoCompletionFillups.value());
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_autoCompletionFillups(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__autoCompletionWordSeparators;
	...
	virtual QStringList autoCompletionWordSeparators() const override {
		...
		struct miqt_array /* of struct miqt_string */  callback_return_value = miqt_exec_callback_QsciLexerLua_autoCompletionWordSeparators(this, handle__autoCompletionWordSeparators.value());
	...
	friend struct miqt_array /* of struct miqt_string */  QsciLexerLua_virtualbase_autoCompletionWordSeparators(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__blockEnd;
	...
	virtual const char* blockEnd(int* style) const override {
		...
		int* sigval1 = style;
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_blockEnd(this, handle__blockEnd.value(), sigval1);
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_blockEnd(const void* self, int* style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__blockLookback;
	...
	virtual int blockLookback() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_blockLookback(this, handle__blockLookback.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_blockLookback(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__blockStart;
	...
	virtual const char* blockStart(int* style) const override {
		...
		int* sigval1 = style;
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_blockStart(this, handle__blockStart.value(), sigval1);
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_blockStart(const void* self, int* style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__blockStartKeyword;
	...
	virtual const char* blockStartKeyword(int* style) const override {
		...
		int* sigval1 = style;
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_blockStartKeyword(this, handle__blockStartKeyword.value(), sigval1);
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_blockStartKeyword(const void* self, int* style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__braceStyle;
	...
	virtual int braceStyle() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_braceStyle(this, handle__braceStyle.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_braceStyle(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__caseSensitive;
	...
	virtual bool caseSensitive() const override {
		...
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_caseSensitive(this, handle__caseSensitive.value());
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_caseSensitive(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__color;
	...
	virtual QColor color(int style) const override {
		...
		int sigval1 = style;
		QColor* callback_return_value = miqt_exec_callback_QsciLexerLua_color(this, handle__color.value(), sigval1);
	...
	friend QColor* QsciLexerLua_virtualbase_color(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__eolFill;
	...
	virtual bool eolFill(int style) const override {
		...
		int sigval1 = style;
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_eolFill(this, handle__eolFill.value(), sigval1);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_eolFill(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__font;
	...
	virtual QFont font(int style) const override {
		...
		int sigval1 = style;
		QFont* callback_return_value = miqt_exec_callback_QsciLexerLua_font(this, handle__font.value(), sigval1);
	...
	friend QFont* QsciLexerLua_virtualbase_font(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__indentationGuideView;
	...
	virtual int indentationGuideView() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_indentationGuideView(this, handle__indentationGuideView.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_indentationGuideView(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__keywords;
	...
	virtual const char* keywords(int set) const override {
		...
		int sigval1 = set;
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_keywords(this, handle__keywords.value(), sigval1);
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_keywords(const void* self, int set);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__defaultStyle;
	...
	virtual int defaultStyle() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_defaultStyle(this, handle__defaultStyle.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_defaultStyle(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__description;
	...
	virtual QString description(int style) const override {
		...
		int sigval1 = style;
		struct miqt_string callback_return_value = miqt_exec_callback_QsciLexerLua_description(this, handle__description.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__paper;
	...
	virtual QColor paper(int style) const override {
		...
		int sigval1 = style;
		QColor* callback_return_value = miqt_exec_callback_QsciLexerLua_paper(this, handle__paper.value(), sigval1);
		std::unique_ptr<QColor> callback_return_value_owner;
	...
	friend QColor* QsciLexerLua_virtualbase_paper(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__defaultColorWithStyle;
	...
	virtual QColor defaultColor(int style) const override {
		...
		int sigval1 = style;
		QColor* callback_return_value = miqt_exec_callback_QsciLexerLua_defaultColorWithStyle(this, handle__defaultColorWithStyle.value(), sigval1);
		std::unique_ptr<QColor> callback_return_value_owner;
	...
	friend QColor* QsciLexerLua_virtualbase_defaultColorWithStyle(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__defaultEolFill;
	...
	virtual bool defaultEolFill(int style) const override {
		...
		int sigval1 = style;
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_defaultEolFill(this, handle__defaultEolFill.value(), sigval1);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_defaultEolFill(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__defaultFontWithStyle;
	...
	virtual QFont defaultFont(int style) const override {
		...
		int sigval1 = style;
		QFont* callback_return_value = miqt_exec_callback_QsciLexerLua_defaultFontWithStyle(this, handle__defaultFontWithStyle.value(), sigval1);
		std::unique_ptr<QFont> callback_return_value_owner;
	...
	friend QFont* QsciLexerLua_virtualbase_defaultFontWithStyle(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__defaultPaperWithStyle;
	...
	virtual QColor defaultPaper(int style) const override {
		...
		int sigval1 = style;
		QColor* callback_return_value = miqt_exec_callback_QsciLexerLua_defaultPaperWithStyle(this, handle__defaultPaperWithStyle.value(), sigval1);
		std::unique_ptr<QColor> callback_return_value_owner;
	...
	friend QColor* QsciLexerLua_virtualbase_defaultPaperWithStyle(const void* self, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setEditor;
	...
	virtual void setEditor(QsciScintilla* editor) override {
		...
		miqt_exec_callback_QsciLexerLua_setEditor(this, handle__setEditor.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_setEditor(void* self, QsciScintilla* editor);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__refreshProperties;
	...
	virtual void refreshProperties() override {
		...
		miqt_exec_callback_QsciLexerLua_refreshProperties(this, handle__refreshProperties.value());

	}

	friend void QsciLexerLua_virtualbase_refreshProperties(void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__styleBitsNeeded;
	...
	virtual int styleBitsNeeded() const override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerLua_styleBitsNeeded(this, handle__styleBitsNeeded.value());
		return static_cast<int>(callback_return_value);
	}

	friend int QsciLexerLua_virtualbase_styleBitsNeeded(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__wordCharacters;
	...
	virtual const char* wordCharacters() const override {
		...
		const char* callback_return_value = miqt_exec_callback_QsciLexerLua_wordCharacters(this, handle__wordCharacters.value());
		return callback_return_value;
	}

	friend const char* QsciLexerLua_virtualbase_wordCharacters(const void* self);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setAutoIndentStyle;
	...
	virtual void setAutoIndentStyle(int autoindentstyle) override {
		...
		miqt_exec_callback_QsciLexerLua_setAutoIndentStyle(this, handle__setAutoIndentStyle.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_setAutoIndentStyle(void* self, int autoindentstyle);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setColor;
	...
	virtual void setColor(const QColor& c, int style) override {
		...
		int sigval2 = style;
		miqt_exec_callback_QsciLexerLua_setColor(this, handle__setColor.value(), sigval1, sigval2);

	}

	friend void QsciLexerLua_virtualbase_setColor(void* self, QColor* c, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setEolFill;
	...
	virtual void setEolFill(bool eoffill, int style) override {
		...
		int sigval2 = style;
		miqt_exec_callback_QsciLexerLua_setEolFill(this, handle__setEolFill.value(), sigval1, sigval2);

	}

	friend void QsciLexerLua_virtualbase_setEolFill(void* self, bool eoffill, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setFont;
	...
	virtual void setFont(const QFont& f, int style) override {
		...
		int sigval2 = style;
		miqt_exec_callback_QsciLexerLua_setFont(this, handle__setFont.value(), sigval1, sigval2);

	}

	friend void QsciLexerLua_virtualbase_setFont(void* self, QFont* f, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__setPaper;
	...
	virtual void setPaper(const QColor& c, int style) override {
		...
		QColor* sigval1 = const_cast<QColor*>(&c_ret);
		int sigval2 = style;
		miqt_exec_callback_QsciLexerLua_setPaper(this, handle__setPaper.value(), sigval1, sigval2);

	}

	friend void QsciLexerLua_virtualbase_setPaper(void* self, QColor* c, int style);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__readProperties;
	...
	virtual bool readProperties(QSettings& qs, const QString& prefix) override {
		...
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_readProperties(this, handle__readProperties.value(), sigval1, sigval2);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__writeProperties;
	...
	virtual bool writeProperties(QSettings& qs, const QString& prefix) const override {
		...
		memcpy(prefix_ms.data, prefix_b.data(), prefix_ms.len);
		struct miqt_string sigval2 = prefix_ms;
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_writeProperties(this, handle__writeProperties.value(), sigval1, sigval2);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_event(void* self, QEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QsciLexerLua_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}

	friend bool QsciLexerLua_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QsciLexerLua_timerEvent(this, handle__timerEvent.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_timerEvent(void* self, QTimerEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QsciLexerLua_childEvent(this, handle__childEvent.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_childEvent(void* self, QChildEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QsciLexerLua_customEvent(this, handle__customEvent.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_customEvent(void* self, QEvent* event);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QsciLexerLua_connectNotify(this, handle__connectNotify.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_connectNotify(void* self, QMetaMethod* signal);

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QsciLexerLua_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);

	}

	friend void QsciLexerLua_virtualbase_disconnectNotify(void* self, QMetaMethod* signal);
...
QsciLexerLua* QsciLexerLua_new() {
	return new (std::nothrow) MiqtVirtualQsciLexerLua();
}

QsciLexerLua* QsciLexerLua_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQsciLexerLua(parent);
}
...
bool QsciLexerLua_override_virtual_setFoldCompact(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
...
void QsciLexerLua_virtualbase_setFoldCompact(void* self, bool fold) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setFoldCompact(fold);
}
...
const char* QsciLexerLua_virtualbase_lexer(const void* self) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::lexer();
}
...
int QsciLexerLua_virtualbase_lexerId(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::lexerId();
}
...
const char* QsciLexerLua_virtualbase_autoCompletionFillups(const void* self) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::autoCompletionFillups();
}
...
struct miqt_array /* of struct miqt_string */  QsciLexerLua_virtualbase_autoCompletionWordSeparators(const void* self) {
	QStringList _ret = static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::autoCompletionWordSeparators();
	// Convert QList<> from C++ memory to manually-managed C memory
	struct miqt_string* _arr = static_cast<struct miqt_string*>(malloc(sizeof(struct miqt_string) * _ret.length()));
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		QString _lv_ret = _ret[i];
...
const char* QsciLexerLua_virtualbase_blockEnd(const void* self, int* style) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::blockEnd(static_cast<int*>(style));
}
...
int QsciLexerLua_virtualbase_blockLookback(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::blockLookback();
}
...
const char* QsciLexerLua_virtualbase_blockStart(const void* self, int* style) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::blockStart(static_cast<int*>(style));
}
...
const char* QsciLexerLua_virtualbase_blockStartKeyword(const void* self, int* style) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::blockStartKeyword(static_cast<int*>(style));
}
...
int QsciLexerLua_virtualbase_braceStyle(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::braceStyle();
}
...
bool QsciLexerLua_virtualbase_caseSensitive(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::caseSensitive();
}
...
bool QsciLexerLua_override_virtual_owned_color(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QColor* QsciLexerLua_virtualbase_color(const void* self, int style) {
	return new QColor(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::color(static_cast<int>(style)));
}
...
bool QsciLexerLua_virtualbase_eolFill(const void* self, int style) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::eolFill(static_cast<int>(style));
}
...
bool QsciLexerLua_override_virtual_owned_font(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QFont* QsciLexerLua_virtualbase_font(const void* self, int style) {
	return new QFont(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::font(static_cast<int>(style)));
}
...
int QsciLexerLua_virtualbase_indentationGuideView(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::indentationGuideView();
}
...
const char* QsciLexerLua_virtualbase_keywords(const void* self, int set) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::keywords(static_cast<int>(set));
}
...
int QsciLexerLua_virtualbase_defaultStyle(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::defaultStyle();
}
...
bool QsciLexerLua_override_virtual_owned_paper(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QColor* QsciLexerLua_virtualbase_paper(const void* self, int style) {
	return new QColor(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::paper(static_cast<int>(style)));
}
...
bool QsciLexerLua_override_virtual_owned_defaultColorWithStyle(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QColor* QsciLexerLua_virtualbase_defaultColorWithStyle(const void* self, int style) {
	return new QColor(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::defaultColor(static_cast<int>(style)));
}
...
bool QsciLexerLua_virtualbase_defaultEolFill(const void* self, int style) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::defaultEolFill(static_cast<int>(style));
}
...
bool QsciLexerLua_override_virtual_owned_defaultFontWithStyle(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QFont* QsciLexerLua_virtualbase_defaultFontWithStyle(const void* self, int style) {
	return new QFont(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::defaultFont(static_cast<int>(style)));
}
...
bool QsciLexerLua_override_virtual_owned_defaultPaperWithStyle(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QsciLexerLua> slot_handle(slot);
	MiqtVirtualQsciLexerLua* self_cast = dynamic_cast<MiqtVirtualQsciLexerLua*>( (QsciLexerLua*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QColor* QsciLexerLua_virtualbase_defaultPaperWithStyle(const void* self, int style) {
	return new QColor(static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::defaultPaper(static_cast<int>(style)));
}
...
void QsciLexerLua_virtualbase_setEditor(void* self, QsciScintilla* editor) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setEditor(editor);
}
...
void QsciLexerLua_virtualbase_refreshProperties(void* self) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::refreshProperties();
}
...
int QsciLexerLua_virtualbase_styleBitsNeeded(const void* self) {
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::styleBitsNeeded();
}
...
const char* QsciLexerLua_virtualbase_wordCharacters(const void* self) {
	return (const char*) static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::wordCharacters();
}
...
void QsciLexerLua_virtualbase_setAutoIndentStyle(void* self, int autoindentstyle) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setAutoIndentStyle(static_cast<int>(autoindentstyle));
}
...
void QsciLexerLua_virtualbase_setColor(void* self, QColor* c, int style) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setColor(*c, static_cast<int>(style));
}
...
void QsciLexerLua_virtualbase_setEolFill(void* self, bool eoffill, int style) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setEolFill(eoffill, static_cast<int>(style));
}
...
void QsciLexerLua_virtualbase_setFont(void* self, QFont* f, int style) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setFont(*f, static_cast<int>(style));
}
...
void QsciLexerLua_virtualbase_setPaper(void* self, QColor* c, int style) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::setPaper(*c, static_cast<int>(style));
}
...
bool QsciLexerLua_virtualbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	...
	return static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::readProperties(*qs, prefix_QString);
}
...
bool QsciLexerLua_virtualbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	QString prefix_QString = QString::fromUtf8(prefix.data, prefix.len);
	return static_cast<const MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::writeProperties(*qs, prefix_QString);
}
...
bool QsciLexerLua_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::event(event);
}
...
bool QsciLexerLua_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::eventFilter(watched, event);
}
...
void QsciLexerLua_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::timerEvent(event);
}
...
void QsciLexerLua_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::childEvent(event);
}
...
void QsciLexerLua_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::customEvent(event);
}
...
void QsciLexerLua_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::connectNotify(*signal);
}
...
void QsciLexerLua_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQsciLexerLua*>(self)->QsciLexerLua::disconnectNotify(*signal);
}
