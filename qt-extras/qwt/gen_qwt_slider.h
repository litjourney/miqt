#pragma once
#ifndef MIQT_QT_EXTRAS_QWT_GEN_QWT_SLIDER_H
#define MIQT_QT_EXTRAS_QWT_GEN_QWT_SLIDER_H
...
typedef struct QwtSlider QwtSlider;
#endif
...
double QwtSlider_scrolledTo(const QwtSlider* self, QPoint* param1);
bool QwtSlider_isScrollPosition(const QwtSlider* self, QPoint* param1);
void QwtSlider_drawSlider(const QwtSlider* self, QPainter* param1, QRect* param2);
void QwtSlider_drawHandle(const QwtSlider* self, QPainter* param1, QRect* param2, int pos);
void QwtSlider_mousePressEvent(QwtSlider* self, QMouseEvent* param1);
void QwtSlider_mouseReleaseEvent(QwtSlider* self, QMouseEvent* param1);
void QwtSlider_resizeEvent(QwtSlider* self, QResizeEvent* param1);
void QwtSlider_paintEvent(QwtSlider* self, QPaintEvent* param1);
void QwtSlider_changeEvent(QwtSlider* self, QEvent* param1);
void QwtSlider_timerEvent(QwtSlider* self, QTimerEvent* param1);
void QwtSlider_scaleChange(QwtSlider* self);
