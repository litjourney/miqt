...
void miqt_exec_callback_handle_release_QwtGraphic(intptr_t);
...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawPath;
	...
	virtual void drawPath(const QPainterPath& param1) override {
		...
		miqt_exec_callback_QwtGraphic_drawPath(this, handle__drawPath.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawPixmap;
	...
	virtual void drawPixmap(const QRectF& param1, const QPixmap& param2, const QRectF& param3) override {
		...
		miqt_exec_callback_QwtGraphic_drawPixmap(this, handle__drawPixmap.value(), sigval1, sigval2, sigval3);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawImage;
	...
	virtual void drawImage(const QRectF& param1, const QImage& param2, const QRectF& param3, Qt::ImageConversionFlags param4) override {
		...
		miqt_exec_callback_QwtGraphic_drawImage(this, handle__drawImage.value(), sigval1, sigval2, sigval3, sigval4);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__updateState;
	...
	virtual void updateState(const QPaintEngineState& state) override {
		...
		miqt_exec_callback_QwtGraphic_updateState(this, handle__updateState.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__paintEngine;
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QwtGraphic_paintEngine(this, handle__paintEngine.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__metric;
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QwtGraphic_metric(this, handle__metric.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawRects;
	...
	virtual void drawRects(const QRect* param1, int param2) override {
		...
		int sigval2 = param2;
		miqt_exec_callback_QwtGraphic_drawRects(this, handle__drawRects.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawLines;
	...
	virtual void drawLines(const QLine* param1, int param2) override {
		...
		int sigval2 = param2;
		miqt_exec_callback_QwtGraphic_drawLines(this, handle__drawLines.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawEllipse;
	...
	virtual void drawEllipse(const QRectF& param1) override {
		...
		// Cast returned reference into pointer
		QRectF* sigval1 = const_cast<QRectF*>(&param1_ret);
		miqt_exec_callback_QwtGraphic_drawEllipse(this, handle__drawEllipse.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawPoints;
	...
	virtual void drawPoints(const QPointF* param1, int param2) override {
		...
		int sigval2 = param2;
		miqt_exec_callback_QwtGraphic_drawPoints(this, handle__drawPoints.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawPolygon;
	...
	virtual void drawPolygon(const QPointF* param1, int param2, QPaintEngine::PolygonDrawMode param3) override {
		...
		miqt_exec_callback_QwtGraphic_drawPolygon(this, handle__drawPolygon.value(), sigval1, sigval2, sigval3);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawTextItem;
	...
	virtual void drawTextItem(const QPointF& param1, const QTextItem& param2) override {
		...
		miqt_exec_callback_QwtGraphic_drawTextItem(this, handle__drawTextItem.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__drawTiledPixmap;
	...
	virtual void drawTiledPixmap(const QRectF& param1, const QPixmap& param2, const QPointF& param3) override {
		...
		miqt_exec_callback_QwtGraphic_drawTiledPixmap(this, handle__drawTiledPixmap.value(), sigval1, sigval2, sigval3);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__devType;
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QwtGraphic_devType(this, handle__devType.value());
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__initPainter;
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QwtGraphic_initPainter(this, handle__initPainter.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__redirected;
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QwtGraphic_redirected(this, handle__redirected.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtGraphic> handle__sharedPainter;
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QwtGraphic_sharedPainter(this, handle__sharedPainter.value());
		return callback_return_value;
	}
