...
bool QwtAbstractScale_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtAbstractScale> slot_handle(slot);
	MiqtVirtualQwtAbstractScale* self_cast = dynamic_cast<MiqtVirtualQwtAbstractScale*>( (QwtAbstractScale*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QwtAbstractScale_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtAbstractScale> slot_handle(slot);
	MiqtVirtualQwtAbstractScale* self_cast = dynamic_cast<MiqtVirtualQwtAbstractScale*>( (QwtAbstractScale*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QwtAbstractScale_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QwtAbstractScale> slot_handle(slot);
	MiqtVirtualQwtAbstractScale* self_cast = dynamic_cast<MiqtVirtualQwtAbstractScale*>( (QwtAbstractScale*)(self) );
	if (self_cast == nullptr) {
		return false;
