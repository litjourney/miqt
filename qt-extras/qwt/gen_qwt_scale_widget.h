#pragma once
#ifndef MIQT_QT_EXTRAS_QWT_GEN_QWT_SCALE_WIDGET_H
#define MIQT_QT_EXTRAS_QWT_GEN_QWT_SCALE_WIDGET_H
...
void QwtScaleWidget_paintEvent(QwtScaleWidget* self, QPaintEvent* param1);
void QwtScaleWidget_resizeEvent(QwtScaleWidget* self, QResizeEvent* param1);
