#pragma once
#ifndef MIQT_QT_EXTRAS_QWT_GEN_QWT_KNOB_H
#define MIQT_QT_EXTRAS_QWT_GEN_QWT_KNOB_H
...
typedef struct QwtKnob QwtKnob;
...
void QwtKnob_paintEvent(QwtKnob* self, QPaintEvent* param1);
void QwtKnob_changeEvent(QwtKnob* self, QEvent* param1);
void QwtKnob_drawKnob(const QwtKnob* self, QPainter* param1, QRectF* param2);
void QwtKnob_drawFocusIndicator(const QwtKnob* self, QPainter* param1);
void QwtKnob_drawMarker(const QwtKnob* self, QPainter* param1, QRectF* param2, double angle);
double QwtKnob_scrolledTo(const QwtKnob* self, QPoint* param1);
bool QwtKnob_isScrollPosition(const QwtKnob* self, QPoint* param1);
