...
bool QwtAbstractSlider_override_virtual_owned_sizeHint(void* self, intptr_t slot);
...
bool QwtAbstractSlider_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot);
...
bool QwtAbstractSlider_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot);
