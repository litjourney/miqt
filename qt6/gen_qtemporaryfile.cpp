...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTemporaryFile> handle__skipData;
	...
	virtual qint64 skipData(qint64 maxSize) override {
		...
		long long callback_return_value = miqt_exec_callback_QTemporaryFile_skipData(this, handle__skipData.value(), sigval1);
		return static_cast<qint64>(callback_return_value);
	}
...
long long QTemporaryFile_virtualbase_skipData(void* self, long long maxSize) {
	qint64 _ret = static_cast<MiqtVirtualQTemporaryFile*>(self)->QTemporaryFile::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
}
