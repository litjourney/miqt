...
void miqt_exec_callback_handle_release_QSocketNotifier(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__event;
	...
	virtual bool event(QEvent* param1) override {
		...
		bool callback_return_value = miqt_exec_callback_QSocketNotifier_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QSocketNotifier_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QSocketNotifier_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QSocketNotifier_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		miqt_exec_callback_QSocketNotifier_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QSocketNotifier_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QSocketNotifier_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
bool QSocketNotifier_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier> slot_handle(slot);
...
void* QSocketNotifier_connect_activated(QSocketNotifier* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSocketNotifier>>(slot);
	return new QMetaObject::Connection(QSocketNotifier::connect(self, &QSocketNotifier::activated, self, [slot_handle](QSocketDescriptor socket, QSocketNotifier::Type activationEvent) {
