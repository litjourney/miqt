...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QUndoView> handle__initViewItemOption;
	...
	virtual void initViewItemOption(QStyleOptionViewItem* option) const override {
		...
		miqt_exec_callback_QUndoView_initViewItemOption(this, handle__initViewItemOption.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QUndoView> handle__itemDelegateForIndex;
	...
	virtual QAbstractItemDelegate* itemDelegateForIndex(const QModelIndex& index) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		QAbstractItemDelegate* callback_return_value = miqt_exec_callback_QUndoView_itemDelegateForIndex(this, handle__itemDelegateForIndex.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QUndoView> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionFrame* option) const override {
		...
		miqt_exec_callback_QUndoView_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
void QUndoView_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const MiqtVirtualQUndoView*>(self)->QUndoView::initViewItemOption(option);
}
...
QAbstractItemDelegate* QUndoView_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const MiqtVirtualQUndoView*>(self)->QUndoView::itemDelegateForIndex(*index);
}
...
void QUndoView_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const MiqtVirtualQUndoView*>(self)->QUndoView::initStyleOption(option);
}
...
bool QUndoView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQUndoView*>(self)->QUndoView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
