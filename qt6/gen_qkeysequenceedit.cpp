...
void QKeySequenceEdit_virtualbase_focusOutEvent(void* self, QFocusEvent* param1) {
	static_cast<MiqtVirtualQKeySequenceEdit*>(self)->QKeySequenceEdit::focusOutEvent(param1);
}
...
bool QKeySequenceEdit_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeySequenceEdit> slot_handle(slot);
	MiqtVirtualQKeySequenceEdit* self_cast = dynamic_cast<MiqtVirtualQKeySequenceEdit*>( (QKeySequenceEdit*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QKeySequenceEdit_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeySequenceEdit> slot_handle(slot);
	MiqtVirtualQKeySequenceEdit* self_cast = dynamic_cast<MiqtVirtualQKeySequenceEdit*>( (QKeySequenceEdit*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QKeySequenceEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQKeySequenceEdit*>(self)->QKeySequenceEdit::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
bool QKeySequenceEdit_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QKeySequenceEdit> slot_handle(slot);
	MiqtVirtualQKeySequenceEdit* self_cast = dynamic_cast<MiqtVirtualQKeySequenceEdit*>( (QKeySequenceEdit*)(self) );
	if (self_cast == nullptr) {
		return false;
