...
//export miqt_exec_callback_handle_release_QImage
func miqt_exec_callback_handle_release_QImage(cb C.intptr_t) {
...
func NewQImage6(data *byte, width int, height int, bytesPerLine int64, format QImage__Format) *QImage {
	...
	return newQImage(C.QImage_new6((*C.uchar)(unsafe.Pointer(data)), (C.int)(width), (C.int)(height), (C.ptrdiff_t)(bytesPerLine), (C.int)(format)))
}
...
func NewQImage7(data *byte, width int, height int, bytesPerLine int64, format QImage__Format) *QImage {
	...
	return newQImage(C.QImage_new7((*C.uchar)(unsafe.Pointer(data)), (C.int)(width), (C.int)(height), (C.ptrdiff_t)(bytesPerLine), (C.int)(format)))
}
...
func (this *QImage) MirrorWithHorizontally(horizontally bool) {
	C.QImage_mirrorWithHorizontally(this.h, (C.bool)(horizontally))
}
...
func (this *QImage) LoadFromData3(data QByteArrayView, format string) bool {
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	return (bool)(C.QImage_loadFromData3(this.h, data.cPointer(), format_Cstring))
}

func (this *QImage) LoadFromData4(buf *byte, lenVal int, format string) bool {
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	return (bool)(C.QImage_loadFromData4(this.h, (*C.uchar)(unsafe.Pointer(buf)), (C.int)(lenVal), format_Cstring))
}

func (this *QImage) LoadFromData5(data []byte, format string) bool {
	data_alias := C.struct_miqt_string{}
	if len(data) > 0 {
		data_alias.data = (*C.char)(unsafe.Pointer(&data[0]))
	} else {
	...
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	return (bool)(C.QImage_loadFromData5(this.h, data_alias, format_Cstring))
}
...
func QImage_FromData3(data QByteArrayView, format string) *QImage {
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	_goptr := newQImage(C.QImage_fromData3(data.cPointer(), format_Cstring))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func QImage_FromData4(data *byte, size int, format string) *QImage {
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	_goptr := newQImage(C.QImage_fromData4((*C.uchar)(unsafe.Pointer(data)), (C.int)(size), format_Cstring))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func QImage_FromData5(data []byte, format string) *QImage {
	data_alias := C.struct_miqt_string{}
	if len(data) > 0 {
		data_alias.data = (*C.char)(unsafe.Pointer(&data[0]))
	} else {
	...
	format_Cstring := C.CString(format)
	defer C.free(unsafe.Pointer(format_Cstring))
	_goptr := newQImage(C.QImage_fromData5(data_alias, format_Cstring))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
// DetachMetadataWithInvalidateCache can only be called from a QImage that was directly constructed.
func (this *QImage) DetachMetadataWithInvalidateCache(invalidateCache bool) {

	var _dynamic_cast_ok C.bool = false
	C.QImage_protectedbase_detachMetadataWithInvalidateCache(&_dynamic_cast_ok, unsafe.Pointer(this.h), (C.bool)(invalidateCache))
...
func (this *QImage) OnDevType(slot func(super func() int) int) {
	...
	ok := C.QImage_override_virtual_devType(unsafe.Pointer(this.h), slotHandle)
	if !ok {
...
func (this *QImage) OnPaintEngine(slot func(super func() *QPaintEngine) *QPaintEngine) {
	...
	ok := C.QImage_override_virtual_paintEngine(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QImage) OnMetric(slot func(super func(metric QPaintDevice__PaintDeviceMetric) int, metric QPaintDevice__PaintDeviceMetric) int) {
	...
	ok := C.QImage_override_virtual_metric(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QImage) OnInitPainter(slot func(super func(painter *QPainter), painter *QPainter)) {
	...
	ok := C.QImage_override_virtual_initPainter(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QImage) OnRedirected(slot func(super func(offset *QPoint) *QPaintDevice, offset *QPoint) *QPaintDevice) {
	...
	ok := C.QImage_override_virtual_redirected(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QImage) OnSharedPainter(slot func(super func() *QPainter) *QPainter) {
	...
	ok := C.QImage_override_virtual_sharedPainter(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
