...
void miqt_exec_callback_handle_release_QMenu(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__sizeHint;
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QMenu_sizeHint(this, handle__sizeHint.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__changeEvent;
	...
	virtual void changeEvent(QEvent* param1) override {
		...
		miqt_exec_callback_QMenu_changeEvent(this, handle__changeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__keyPressEvent;
	...
	virtual void keyPressEvent(QKeyEvent* param1) override {
		...
		miqt_exec_callback_QMenu_keyPressEvent(this, handle__keyPressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__mouseReleaseEvent;
	...
	virtual void mouseReleaseEvent(QMouseEvent* param1) override {
		...
		miqt_exec_callback_QMenu_mouseReleaseEvent(this, handle__mouseReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__mousePressEvent;
	...
	virtual void mousePressEvent(QMouseEvent* param1) override {
		...
		QMouseEvent* sigval1 = param1;
		miqt_exec_callback_QMenu_mousePressEvent(this, handle__mousePressEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__mouseMoveEvent;
	...
	virtual void mouseMoveEvent(QMouseEvent* param1) override {
		...
		QMouseEvent* sigval1 = param1;
		miqt_exec_callback_QMenu_mouseMoveEvent(this, handle__mouseMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__wheelEvent;
	...
	virtual void wheelEvent(QWheelEvent* param1) override {
		...
		miqt_exec_callback_QMenu_wheelEvent(this, handle__wheelEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__enterEvent;
	...
	virtual void enterEvent(QEnterEvent* param1) override {
		...
		miqt_exec_callback_QMenu_enterEvent(this, handle__enterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__leaveEvent;
	...
	virtual void leaveEvent(QEvent* param1) override {
		...
		QEvent* sigval1 = param1;
		miqt_exec_callback_QMenu_leaveEvent(this, handle__leaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__hideEvent;
	...
	virtual void hideEvent(QHideEvent* param1) override {
		...
		miqt_exec_callback_QMenu_hideEvent(this, handle__hideEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__paintEvent;
	...
	virtual void paintEvent(QPaintEvent* param1) override {
		...
		miqt_exec_callback_QMenu_paintEvent(this, handle__paintEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__actionEvent;
	...
	virtual void actionEvent(QActionEvent* param1) override {
		...
		miqt_exec_callback_QMenu_actionEvent(this, handle__actionEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* param1) override {
		...
		miqt_exec_callback_QMenu_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__event;
	...
	virtual bool event(QEvent* param1) override {
		...
		QEvent* sigval1 = param1;
		bool callback_return_value = miqt_exec_callback_QMenu_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__focusNextPrevChild;
	...
	virtual bool focusNextPrevChild(bool next) override {
		...
		bool sigval1 = next;
		bool callback_return_value = miqt_exec_callback_QMenu_focusNextPrevChild(this, handle__focusNextPrevChild.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionMenuItem* option, const QAction* action) const override {
		...
		miqt_exec_callback_QMenu_initStyleOption(this, handle__initStyleOption.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__devType;
	...
	virtual int devType() const override {
		...
		int callback_return_value = miqt_exec_callback_QMenu_devType(this, handle__devType.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__setVisible;
	...
	virtual void setVisible(bool visible) override {
		...
		miqt_exec_callback_QMenu_setVisible(this, handle__setVisible.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__minimumSizeHint;
	...
	virtual QSize minimumSizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QMenu_minimumSizeHint(this, handle__minimumSizeHint.value());
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__heightForWidth;
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QMenu_heightForWidth(this, handle__heightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__hasHeightForWidth;
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QMenu_hasHeightForWidth(this, handle__hasHeightForWidth.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__paintEngine;
	...
	virtual QPaintEngine* paintEngine() const override {
		...
		QPaintEngine* callback_return_value = miqt_exec_callback_QMenu_paintEngine(this, handle__paintEngine.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__mouseDoubleClickEvent;
	...
	virtual void mouseDoubleClickEvent(QMouseEvent* event) override {
		...
		miqt_exec_callback_QMenu_mouseDoubleClickEvent(this, handle__mouseDoubleClickEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__keyReleaseEvent;
	...
	virtual void keyReleaseEvent(QKeyEvent* event) override {
		...
		miqt_exec_callback_QMenu_keyReleaseEvent(this, handle__keyReleaseEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__focusInEvent;
	...
	virtual void focusInEvent(QFocusEvent* event) override {
		...
		miqt_exec_callback_QMenu_focusInEvent(this, handle__focusInEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__focusOutEvent;
	...
	virtual void focusOutEvent(QFocusEvent* event) override {
		...
		QFocusEvent* sigval1 = event;
		miqt_exec_callback_QMenu_focusOutEvent(this, handle__focusOutEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__moveEvent;
	...
	virtual void moveEvent(QMoveEvent* event) override {
		...
		miqt_exec_callback_QMenu_moveEvent(this, handle__moveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__resizeEvent;
	...
	virtual void resizeEvent(QResizeEvent* event) override {
		...
		miqt_exec_callback_QMenu_resizeEvent(this, handle__resizeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__closeEvent;
	...
	virtual void closeEvent(QCloseEvent* event) override {
		...
		miqt_exec_callback_QMenu_closeEvent(this, handle__closeEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__contextMenuEvent;
	...
	virtual void contextMenuEvent(QContextMenuEvent* event) override {
		...
		miqt_exec_callback_QMenu_contextMenuEvent(this, handle__contextMenuEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__tabletEvent;
	...
	virtual void tabletEvent(QTabletEvent* event) override {
		...
		miqt_exec_callback_QMenu_tabletEvent(this, handle__tabletEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__dragEnterEvent;
	...
	virtual void dragEnterEvent(QDragEnterEvent* event) override {
		...
		miqt_exec_callback_QMenu_dragEnterEvent(this, handle__dragEnterEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__dragMoveEvent;
	...
	virtual void dragMoveEvent(QDragMoveEvent* event) override {
		...
		miqt_exec_callback_QMenu_dragMoveEvent(this, handle__dragMoveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__dragLeaveEvent;
	...
	virtual void dragLeaveEvent(QDragLeaveEvent* event) override {
		...
		miqt_exec_callback_QMenu_dragLeaveEvent(this, handle__dragLeaveEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__dropEvent;
	...
	virtual void dropEvent(QDropEvent* event) override {
		...
		miqt_exec_callback_QMenu_dropEvent(this, handle__dropEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__showEvent;
	...
	virtual void showEvent(QShowEvent* event) override {
		...
		miqt_exec_callback_QMenu_showEvent(this, handle__showEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__nativeEvent;
	...
	virtual bool nativeEvent(const QByteArray& eventType, void* message, qintptr* result) override {
		...
		bool callback_return_value = miqt_exec_callback_QMenu_nativeEvent(this, handle__nativeEvent.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__metric;
	...
	virtual int metric(QPaintDevice::PaintDeviceMetric param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QMenu_metric(this, handle__metric.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__initPainter;
	...
	virtual void initPainter(QPainter* painter) const override {
		...
		miqt_exec_callback_QMenu_initPainter(this, handle__initPainter.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__redirected;
	...
	virtual QPaintDevice* redirected(QPoint* offset) const override {
		...
		QPaintDevice* callback_return_value = miqt_exec_callback_QMenu_redirected(this, handle__redirected.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__sharedPainter;
	...
	virtual QPainter* sharedPainter() const override {
		...
		QPainter* callback_return_value = miqt_exec_callback_QMenu_sharedPainter(this, handle__sharedPainter.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__inputMethodEvent;
	...
	virtual void inputMethodEvent(QInputMethodEvent* param1) override {
		...
		miqt_exec_callback_QMenu_inputMethodEvent(this, handle__inputMethodEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__inputMethodQuery;
	...
	virtual QVariant inputMethodQuery(Qt::InputMethodQuery param1) const override {
		...
		int sigval1 = static_cast<int>(param1_ret);
		QVariant* callback_return_value = miqt_exec_callback_QMenu_inputMethodQuery(this, handle__inputMethodQuery.value(), sigval1);
		return *callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QMenu_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QMenu_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		miqt_exec_callback_QMenu_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QMenu_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QMenu_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QMenu* QMenu_new(QWidget* parent) {
	return new (std::nothrow) MiqtVirtualQMenu(parent);
}

QMenu* QMenu_new2() {
	return new (std::nothrow) MiqtVirtualQMenu();
}

QMenu* QMenu_new3(struct miqt_string title) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	return new (std::nothrow) MiqtVirtualQMenu(title_QString);
}

QMenu* QMenu_new4(struct miqt_string title, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	return new (std::nothrow) MiqtVirtualQMenu(title_QString, parent);
}
...
void* QMenu_connect_aboutToShow(QMenu* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QMenu>>(slot);
	return new QMetaObject::Connection(QMenu::connect(self, static_cast<void (QMenu::*)()>(&QMenu::aboutToShow), self, [slot_handle]() {
...
void* QMenu_connect_aboutToHide(QMenu* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QMenu>>(slot);
	return new QMetaObject::Connection(QMenu::connect(self, static_cast<void (QMenu::*)()>(&QMenu::aboutToHide), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QMenu_connect_triggered(QMenu* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QMenu>>(slot);
	return new QMetaObject::Connection(QMenu::connect(self, static_cast<void (QMenu::*)(QAction*)>(&QMenu::triggered), self, [slot_handle](QAction* action) {
		intptr_t slot = slot_handle->value();
...
void* QMenu_connect_hovered(QMenu* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QMenu>>(slot);
	return new QMetaObject::Connection(QMenu::connect(self, static_cast<void (QMenu::*)(QAction*)>(&QMenu::hovered), self, [slot_handle](QAction* action) {
		intptr_t slot = slot_handle->value();
		QAction* sigval1 = action;
...
bool QMenu_override_virtual_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QMenu> slot_handle(slot);
...
QSize* QMenu_virtualbase_sizeHint(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQMenu*>(self)->QMenu::sizeHint());
}
...
void QMenu_virtualbase_changeEvent(void* self, QEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::changeEvent(param1);
}
...
void QMenu_virtualbase_keyPressEvent(void* self, QKeyEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::keyPressEvent(param1);
}
...
void QMenu_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::mouseReleaseEvent(param1);
}
...
void QMenu_virtualbase_mousePressEvent(void* self, QMouseEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::mousePressEvent(param1);
}
...
void QMenu_virtualbase_mouseMoveEvent(void* self, QMouseEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::mouseMoveEvent(param1);
}
...
void QMenu_virtualbase_wheelEvent(void* self, QWheelEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::wheelEvent(param1);
}
...
void QMenu_virtualbase_enterEvent(void* self, QEnterEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::enterEvent(param1);
}
...
void QMenu_virtualbase_leaveEvent(void* self, QEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::leaveEvent(param1);
}
...
void QMenu_virtualbase_hideEvent(void* self, QHideEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::hideEvent(param1);
}
...
void QMenu_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::paintEvent(param1);
}
...
void QMenu_virtualbase_actionEvent(void* self, QActionEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::actionEvent(param1);
}
...
void QMenu_virtualbase_timerEvent(void* self, QTimerEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::timerEvent(param1);
}
...
bool QMenu_virtualbase_event(void* self, QEvent* param1) {
	return static_cast<MiqtVirtualQMenu*>(self)->QMenu::event(param1);
}
...
bool QMenu_virtualbase_focusNextPrevChild(void* self, bool next) {
	return static_cast<MiqtVirtualQMenu*>(self)->QMenu::focusNextPrevChild(next);
}
...
void QMenu_virtualbase_initStyleOption(const void* self, QStyleOptionMenuItem* option, QAction* action) {
	static_cast<const MiqtVirtualQMenu*>(self)->QMenu::initStyleOption(option, action);
}
...
int QMenu_virtualbase_devType(const void* self) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::devType();
}
...
void QMenu_virtualbase_setVisible(void* self, bool visible) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::setVisible(visible);
}
...
QSize* QMenu_virtualbase_minimumSizeHint(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQMenu*>(self)->QMenu::minimumSizeHint());
}
...
int QMenu_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::heightForWidth(static_cast<int>(param1));
}
...
bool QMenu_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::hasHeightForWidth();
}
...
QPaintEngine* QMenu_virtualbase_paintEngine(const void* self) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::paintEngine();
}
...
void QMenu_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::mouseDoubleClickEvent(event);
}
...
void QMenu_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::keyReleaseEvent(event);
}
...
void QMenu_virtualbase_focusInEvent(void* self, QFocusEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::focusInEvent(event);
}
...
void QMenu_virtualbase_focusOutEvent(void* self, QFocusEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::focusOutEvent(event);
}
...
void QMenu_virtualbase_moveEvent(void* self, QMoveEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::moveEvent(event);
}
...
void QMenu_virtualbase_resizeEvent(void* self, QResizeEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::resizeEvent(event);
}
...
void QMenu_virtualbase_closeEvent(void* self, QCloseEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::closeEvent(event);
}
...
void QMenu_virtualbase_contextMenuEvent(void* self, QContextMenuEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::contextMenuEvent(event);
}
...
void QMenu_virtualbase_tabletEvent(void* self, QTabletEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::tabletEvent(event);
}
...
void QMenu_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::dragEnterEvent(event);
}
...
void QMenu_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::dragMoveEvent(event);
}
...
void QMenu_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::dragLeaveEvent(event);
}
...
void QMenu_virtualbase_dropEvent(void* self, QDropEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::dropEvent(event);
}
...
void QMenu_virtualbase_showEvent(void* self, QShowEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::showEvent(event);
}
...
bool QMenu_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQMenu*>(self)->QMenu::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
int QMenu_virtualbase_metric(const void* self, int param1) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::metric(static_cast<MiqtVirtualQMenu::PaintDeviceMetric>(param1));
}
...
void QMenu_virtualbase_initPainter(const void* self, QPainter* painter) {
	static_cast<const MiqtVirtualQMenu*>(self)->QMenu::initPainter(painter);
}
...
QPaintDevice* QMenu_virtualbase_redirected(const void* self, QPoint* offset) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::redirected(offset);
}
...
QPainter* QMenu_virtualbase_sharedPainter(const void* self) {
	return static_cast<const MiqtVirtualQMenu*>(self)->QMenu::sharedPainter();
}
...
void QMenu_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::inputMethodEvent(param1);
}
...
QVariant* QMenu_virtualbase_inputMethodQuery(const void* self, int param1) {
	return new QVariant(static_cast<const MiqtVirtualQMenu*>(self)->QMenu::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));
}
...
bool QMenu_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQMenu*>(self)->QMenu::eventFilter(watched, event);
}
...
void QMenu_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::childEvent(event);
}
...
void QMenu_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::customEvent(event);
}
...
void QMenu_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::connectNotify(*signal);
}
...
void QMenu_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQMenu*>(self)->QMenu::disconnectNotify(*signal);
}
