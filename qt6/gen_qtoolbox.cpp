...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QToolBox> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionFrame* option) const override {
		...
		miqt_exec_callback_QToolBox_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
bool QToolBox_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QToolBox> slot_handle(slot);
	MiqtVirtualQToolBox* self_cast = dynamic_cast<MiqtVirtualQToolBox*>( (QToolBox*)(self) );
	if (self_cast == nullptr) {
		return false;
...
void QToolBox_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const MiqtVirtualQToolBox*>(self)->QToolBox::initStyleOption(option);
}
...
bool QToolBox_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QToolBox> slot_handle(slot);
	MiqtVirtualQToolBox* self_cast = dynamic_cast<MiqtVirtualQToolBox*>( (QToolBox*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QToolBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQToolBox*>(self)->QToolBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
bool QToolBox_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QToolBox> slot_handle(slot);
	MiqtVirtualQToolBox* self_cast = dynamic_cast<MiqtVirtualQToolBox*>( (QToolBox*)(self) );
	if (self_cast == nullptr) {
		return false;
