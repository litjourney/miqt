...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QRasterWindow> handle__closeEvent;
	...
	virtual void closeEvent(QCloseEvent* param1) override {
		...
		miqt_exec_callback_QRasterWindow_closeEvent(this, handle__closeEvent.value(), sigval1);
...
void QRasterWindow_virtualbase_closeEvent(void* self, QCloseEvent* param1) {
	static_cast<MiqtVirtualQRasterWindow*>(self)->QRasterWindow::closeEvent(param1);
}
...
bool QRasterWindow_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQRasterWindow*>(self)->QRasterWindow::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
