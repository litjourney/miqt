...
func (this *QGeoSatelliteInfoSource) OnSatellitesInViewUpdated(slot func(satellites []QGeoSatelliteInfo)) *qt6.SignalConnection {
	_goptr := qt6.UnsafeNewQMetaObject__Connection(C.QGeoSatelliteInfoSource_connect_satellitesInViewUpdated(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QGeoSatelliteInfoSource) OnSatellitesInUseUpdated(slot func(satellites []QGeoSatelliteInfo)) *qt6.SignalConnection {
	_goptr := qt6.UnsafeNewQMetaObject__Connection(C.QGeoSatelliteInfoSource_connect_satellitesInUseUpdated(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QGeoSatelliteInfoSource) OnErrorOccurred(slot func(param1 QGeoSatelliteInfoSource__Error)) *qt6.SignalConnection {
	_goptr := qt6.UnsafeNewQMetaObject__Connection(C.QGeoSatelliteInfoSource_connect_errorOccurred(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
func (this *QGeoSatelliteInfoSource) OnSetBackendProperty(slot func(super func(name string, value *qt6.QVariant) bool, name string, value *qt6.QVariant) bool) {
	...
	ok := C.QGeoSatelliteInfoSource_override_virtual_setBackendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QGeoSatelliteInfoSource_backendProperty struct {
...
func (this *QGeoSatelliteInfoSource) OnBackendProperty(slot func(super func(name string) *qt6.QVariant, name string) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QGeoSatelliteInfoSource_backendProperty{callback: slot}))
	}
	ok := C.QGeoSatelliteInfoSource_override_virtual_backendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QGeoSatelliteInfoSource) OnBackendPropertyOwned(slot func(super func(name string) *qt6.QVariant, name string) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QGeoSatelliteInfoSource_backendProperty{callback: slot, ownsReturn: true}))
	}
	ok := C.QGeoSatelliteInfoSource_override_virtual_owned_backendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QGeoSatelliteInfoSource_backendProperty(self *C.QGeoSatelliteInfoSource, cb C.intptr_t, name C.struct_miqt_string) *C.QVariant {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QGeoSatelliteInfoSource_backendProperty)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
