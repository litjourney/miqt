...
//export miqt_exec_callback_handle_release_QNmeaPositionInfoSource
func miqt_exec_callback_handle_release_QNmeaPositionInfoSource(cb C.intptr_t) {
...
func NewQNmeaPositionInfoSource2(updateMode QNmeaPositionInfoSource__UpdateMode, parent *qt6.QObject) *QNmeaPositionInfoSource {

	return newQNmeaPositionInfoSource(C.QNmeaPositionInfoSource_new2((C.int)(updateMode), (*C.QObject)(parent.UnsafePointer())))
}

func (this *QNmeaPositionInfoSource) MetaObject() *qt6.QMetaObject {
	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QNmeaPositionInfoSource_metaObject(this.h)))
}
...
func (this *QNmeaPositionInfoSource) SetDevice(source *qt6.QIODevice) {
	C.QNmeaPositionInfoSource_setDevice(this.h, (*C.QIODevice)(source.UnsafePointer()))
}

func (this *QNmeaPositionInfoSource) Device() *qt6.QIODevice {
	return qt6.UnsafeNewQIODevice(unsafe.Pointer(C.QNmeaPositionInfoSource_device(this.h)))
}
...
func (this *QNmeaPositionInfoSource) LastKnownPosition(fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo {
	_goptr := newQGeoPositionInfo(C.QNmeaPositionInfoSource_lastKnownPosition(this.h, (C.bool)(fromSatellitePositioningMethodsOnly)))
...
func (this *QNmeaPositionInfoSource) RequestUpdate(timeout int) {
	C.QNmeaPositionInfoSource_requestUpdate(this.h, (C.int)(timeout))
}
...
// SetError can only be called from a QNmeaPositionInfoSource that was directly constructed.
func (this *QNmeaPositionInfoSource) SetError(positionError QGeoPositionInfoSource__Error) {

	var _dynamic_cast_ok C.bool = false
	C.QNmeaPositionInfoSource_protectedbase_setError(&_dynamic_cast_ok, unsafe.Pointer(this.h), (C.int)(positionError))
...
func (this *QNmeaPositionInfoSource) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QNmeaPositionInfoSource_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QNmeaPositionInfoSource) IsSignalConnected(signal *qt6.QMetaMethod) bool {
...
func (this *QNmeaPositionInfoSource) OnSetUpdateInterval(slot func(super func(msec int), msec int)) {
	...
	ok := C.QNmeaPositionInfoSource_override_virtual_setUpdateInterval(unsafe.Pointer(this.h), slotHandle)
	if !ok {
...
func (this *QNmeaPositionInfoSource) callVirtualBase_LastKnownPosition(fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo {

	_goptr := newQGeoPositionInfo(C.QNmeaPositionInfoSource_virtualbase_lastKnownPosition(unsafe.Pointer(this.h), (C.bool)(fromSatellitePositioningMethodsOnly)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr

}

type miqtVirtualCallback_QNmeaPositionInfoSource_lastKnownPosition struct {
	callback   func(super func(fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo, fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo
	ownsReturn bool
}

func (this *QNmeaPositionInfoSource) OnLastKnownPosition(slot func(super func(fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo, fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QNmeaPositionInfoSource_lastKnownPosition{callback: slot}))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_lastKnownPosition(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) OnLastKnownPositionOwned(slot func(super func(fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo, fromSatellitePositioningMethodsOnly bool) *QGeoPositionInfo) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QNmeaPositionInfoSource_lastKnownPosition{callback: slot, ownsReturn: true}))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_owned_lastKnownPosition(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_lastKnownPosition(self *C.QNmeaPositionInfoSource, cb C.intptr_t, fromSatellitePositioningMethodsOnly C.bool) *C.QGeoPositionInfo {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QNmeaPositionInfoSource_lastKnownPosition)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	...
	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_LastKnownPosition, slotval1)
...
func (this *QNmeaPositionInfoSource) callVirtualBase_SupportedPositioningMethods() QGeoPositionInfoSource__PositioningMethod {

	return (QGeoPositionInfoSource__PositioningMethod)(C.QNmeaPositionInfoSource_virtualbase_supportedPositioningMethods(unsafe.Pointer(this.h)))

}
func (this *QNmeaPositionInfoSource) OnSupportedPositioningMethods(slot func(super func() QGeoPositionInfoSource__PositioningMethod) QGeoPositionInfoSource__PositioningMethod) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_supportedPositioningMethods(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_supportedPositioningMethods(self *C.QNmeaPositionInfoSource, cb C.intptr_t) C.int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() QGeoPositionInfoSource__PositioningMethod) QGeoPositionInfoSource__PositioningMethod)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_SupportedPositioningMethods)

	return (C.int)(virtualReturn)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_MinimumUpdateInterval() int {

	return (int)(C.QNmeaPositionInfoSource_virtualbase_minimumUpdateInterval(unsafe.Pointer(this.h)))

}
func (this *QNmeaPositionInfoSource) OnMinimumUpdateInterval(slot func(super func() int) int) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_minimumUpdateInterval(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_minimumUpdateInterval(self *C.QNmeaPositionInfoSource, cb C.intptr_t) C.int {
	...
	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_MinimumUpdateInterval)

	return (C.int)(virtualReturn)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_Error() QGeoPositionInfoSource__Error {

	return (QGeoPositionInfoSource__Error)(C.QNmeaPositionInfoSource_virtualbase_error(unsafe.Pointer(this.h)))

}
func (this *QNmeaPositionInfoSource) OnError(slot func(super func() QGeoPositionInfoSource__Error) QGeoPositionInfoSource__Error) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_error(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_error(self *C.QNmeaPositionInfoSource, cb C.intptr_t) C.int {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() QGeoPositionInfoSource__Error) QGeoPositionInfoSource__Error)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_Error)

	return (C.int)(virtualReturn)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_StartUpdates() {

	C.QNmeaPositionInfoSource_virtualbase_startUpdates(unsafe.Pointer(this.h))

}
func (this *QNmeaPositionInfoSource) OnStartUpdates(slot func(super func())) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_startUpdates(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_startUpdates(self *C.QNmeaPositionInfoSource, cb C.intptr_t) {
	...
	gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_StartUpdates)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_StopUpdates() {

	C.QNmeaPositionInfoSource_virtualbase_stopUpdates(unsafe.Pointer(this.h))

}
func (this *QNmeaPositionInfoSource) OnStopUpdates(slot func(super func())) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_stopUpdates(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_stopUpdates(self *C.QNmeaPositionInfoSource, cb C.intptr_t) {
	...
	gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_StopUpdates)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_RequestUpdate(timeout int) {

	C.QNmeaPositionInfoSource_virtualbase_requestUpdate(unsafe.Pointer(this.h), (C.int)(timeout))

}
func (this *QNmeaPositionInfoSource) OnRequestUpdate(slot func(super func(timeout int), timeout int)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_requestUpdate(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNmeaPositionInfoSource_requestUpdate(self *C.QNmeaPositionInfoSource, cb C.intptr_t, timeout C.int) {
	...
	gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_RequestUpdate, slotval1)
...
func (this *QNmeaPositionInfoSource) OnParsePosInfoFromNmeaData(slot func(super func(data string, size int, posInfo *QGeoPositionInfo, hasFix *bool) bool, data string, size int, posInfo *QGeoPositionInfo, hasFix *bool) bool) {
	...
	ok := C.QNmeaPositionInfoSource_override_virtual_parsePosInfoFromNmeaData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) OnSetPreferredPositioningMethods(slot func(super func(methods QGeoPositionInfoSource__PositioningMethod), methods QGeoPositionInfoSource__PositioningMethod)) {
	...
	ok := C.QNmeaPositionInfoSource_override_virtual_setPreferredPositioningMethods(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_SetBackendProperty(name string, value *qt6.QVariant) bool {
	name_ms := C.struct_miqt_string{}
	name_ms.data = C.CString(name)
	name_ms.len = C.size_t(len(name))
	defer C.free(unsafe.Pointer(name_ms.data))

	return (bool)(C.QNmeaPositionInfoSource_virtualbase_setBackendProperty(unsafe.Pointer(this.h), name_ms, (*C.QVariant)(value.UnsafePointer())))

}
func (this *QNmeaPositionInfoSource) OnSetBackendProperty(slot func(super func(name string, value *qt6.QVariant) bool, name string, value *qt6.QVariant) bool) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_setBackendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QNmeaPositionInfoSource_setBackendProperty
func miqt_exec_callback_QNmeaPositionInfoSource_setBackendProperty(self *C.QNmeaPositionInfoSource, cb C.intptr_t, name C.struct_miqt_string, value *C.QVariant) C.bool {
	...
	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_SetBackendProperty, slotval1, slotval2)

	return (C.bool)(virtualReturn)

}

func (this *QNmeaPositionInfoSource) callVirtualBase_BackendProperty(name string) *qt6.QVariant {
	name_ms := C.struct_miqt_string{}
	name_ms.data = C.CString(name)
	name_ms.len = C.size_t(len(name))
	defer C.free(unsafe.Pointer(name_ms.data))

	_goptr := qt6.UnsafeNewQVariant(unsafe.Pointer(C.QNmeaPositionInfoSource_virtualbase_backendProperty(unsafe.Pointer(this.h), name_ms)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr

}

type miqtVirtualCallback_QNmeaPositionInfoSource_backendProperty struct {
	callback   func(super func(name string) *qt6.QVariant, name string) *qt6.QVariant
	ownsReturn bool
}

func (this *QNmeaPositionInfoSource) OnBackendProperty(slot func(super func(name string) *qt6.QVariant, name string) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QNmeaPositionInfoSource_backendProperty{callback: slot}))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_backendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QNmeaPositionInfoSource) OnBackendPropertyOwned(slot func(super func(name string) *qt6.QVariant, name string) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QNmeaPositionInfoSource_backendProperty{callback: slot, ownsReturn: true}))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_owned_backendProperty(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QNmeaPositionInfoSource_backendProperty
func miqt_exec_callback_QNmeaPositionInfoSource_backendProperty(self *C.QNmeaPositionInfoSource, cb C.intptr_t, name C.struct_miqt_string) *C.QVariant {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QNmeaPositionInfoSource_backendProperty)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
	...
	virtualReturn := gofunc((&QNmeaPositionInfoSource{h: self}).callVirtualBase_BackendProperty, slotval1)
	if callbackData.ownsReturn && virtualReturn != nil {
		runtime.SetFinalizer(virtualReturn, nil)
	}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_Event(event *qt6.QEvent) bool {

	return (bool)(C.QNmeaPositionInfoSource_virtualbase_event(unsafe.Pointer(this.h), (*C.QEvent)(event.UnsafePointer())))

}
func (this *QNmeaPositionInfoSource) OnEvent(slot func(super func(event *qt6.QEvent) bool, event *qt6.QEvent) bool) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_event(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_EventFilter(watched *qt6.QObject, event *qt6.QEvent) bool {
...
func (this *QNmeaPositionInfoSource) OnEventFilter(slot func(super func(watched *qt6.QObject, event *qt6.QEvent) bool, watched *qt6.QObject, event *qt6.QEvent) bool) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_eventFilter(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_TimerEvent(event *qt6.QTimerEvent) {

	C.QNmeaPositionInfoSource_virtualbase_timerEvent(unsafe.Pointer(this.h), (*C.QTimerEvent)(event.UnsafePointer()))

}
func (this *QNmeaPositionInfoSource) OnTimerEvent(slot func(super func(event *qt6.QTimerEvent), event *qt6.QTimerEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_timerEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_ChildEvent(event *qt6.QChildEvent) {

	C.QNmeaPositionInfoSource_virtualbase_childEvent(unsafe.Pointer(this.h), (*C.QChildEvent)(event.UnsafePointer()))

}
func (this *QNmeaPositionInfoSource) OnChildEvent(slot func(super func(event *qt6.QChildEvent), event *qt6.QChildEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_childEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_CustomEvent(event *qt6.QEvent) {

	C.QNmeaPositionInfoSource_virtualbase_customEvent(unsafe.Pointer(this.h), (*C.QEvent)(event.UnsafePointer()))

}
func (this *QNmeaPositionInfoSource) OnCustomEvent(slot func(super func(event *qt6.QEvent), event *qt6.QEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_customEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_ConnectNotify(signal *qt6.QMetaMethod) {

	C.QNmeaPositionInfoSource_virtualbase_connectNotify(unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer()))

}
func (this *QNmeaPositionInfoSource) OnConnectNotify(slot func(super func(signal *qt6.QMetaMethod), signal *qt6.QMetaMethod)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_connectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QNmeaPositionInfoSource) callVirtualBase_DisconnectNotify(signal *qt6.QMetaMethod) {

	C.QNmeaPositionInfoSource_virtualbase_disconnectNotify(unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer()))

}
func (this *QNmeaPositionInfoSource) OnDisconnectNotify(slot func(super func(signal *qt6.QMetaMethod), signal *qt6.QMetaMethod)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
	ok := C.QNmeaPositionInfoSource_override_virtual_disconnectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
