...
void miqt_exec_callback_handle_release_QDataWidgetMapper(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__setCurrentIndex;
	...
	virtual void setCurrentIndex(int index) override {
		...
		int sigval1 = index;
		miqt_exec_callback_QDataWidgetMapper_setCurrentIndex(this, handle__setCurrentIndex.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QDataWidgetMapper_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QDataWidgetMapper_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QDataWidgetMapper_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QDataWidgetMapper_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QDataWidgetMapper_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QDataWidgetMapper_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QDataWidgetMapper_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QDataWidgetMapper* QDataWidgetMapper_new() {
	return new (std::nothrow) MiqtVirtualQDataWidgetMapper();
}

QDataWidgetMapper* QDataWidgetMapper_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQDataWidgetMapper(parent);
}
...
void* QDataWidgetMapper_connect_currentIndexChanged(QDataWidgetMapper* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper>>(slot);
	return new QMetaObject::Connection(QDataWidgetMapper::connect(self, static_cast<void (QDataWidgetMapper::*)(int)>(&QDataWidgetMapper::currentIndexChanged), self, [slot_handle](int index) {
...
bool QDataWidgetMapper_override_virtual_setCurrentIndex(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDataWidgetMapper> slot_handle(slot);
...
void QDataWidgetMapper_virtualbase_setCurrentIndex(void* self, int index) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::setCurrentIndex(static_cast<int>(index));
}
...
bool QDataWidgetMapper_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::event(event);
}
...
bool QDataWidgetMapper_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::eventFilter(watched, event);
}
...
void QDataWidgetMapper_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::timerEvent(event);
}
...
void QDataWidgetMapper_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::childEvent(event);
}
...
void QDataWidgetMapper_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::customEvent(event);
}
...
void QDataWidgetMapper_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::connectNotify(*signal);
}
...
void QDataWidgetMapper_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQDataWidgetMapper*>(self)->QDataWidgetMapper::disconnectNotify(*signal);
}
