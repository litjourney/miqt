...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QProcess> handle__skipData;
	...
	virtual qint64 skipData(qint64 maxSize) override {
		...
		long long callback_return_value = miqt_exec_callback_QProcess_skipData(this, handle__skipData.value(), sigval1);
		return static_cast<qint64>(callback_return_value);
	}
...
void* QProcess_connect_finished(QProcess* self, intptr_t slot) {
	...
	return new QMetaObject::Connection(QProcess::connect(self, static_cast<void (QProcess::*)(int, QProcess::ExitStatus)>(&QProcess::finished), self, [slot_handle](int exitCode) {
...
long long QProcess_virtualbase_skipData(void* self, long long maxSize) {
	qint64 _ret = static_cast<MiqtVirtualQProcess*>(self)->QProcess::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
}
