...
void* QWebEngineProfile_connect_downloadRequested(QWebEngineProfile* self, intptr_t slot) {
	...
	return new QMetaObject::Connection(QWebEngineProfile::connect(self, static_cast<void (QWebEngineProfile::*)(QWebEngineDownloadRequest*)>(&QWebEngineProfile::downloadRequested), self, [slot_handle](QWebEngineDownloadRequest* download) {
