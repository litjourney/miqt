...
void miqt_exec_callback_handle_release_QStringListModel(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__rowCount;
	...
	virtual int rowCount(const QModelIndex& parent) const override {
		...
		int callback_return_value = miqt_exec_callback_QStringListModel_rowCount(this, handle__rowCount.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__setData;
	...
	virtual bool setData(const QModelIndex& index, const QVariant& value, int role) override {
		...
		int sigval3 = role;
		bool callback_return_value = miqt_exec_callback_QStringListModel_setData(this, handle__setData.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__clearItemData;
	...
	virtual bool clearItemData(const QModelIndex& index) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_clearItemData(this, handle__clearItemData.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__flags;
	...
	virtual Qt::ItemFlags flags(const QModelIndex& index) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		int callback_return_value = miqt_exec_callback_QStringListModel_flags(this, handle__flags.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__insertRows;
	...
	virtual bool insertRows(int row, int count, const QModelIndex& parent) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_insertRows(this, handle__insertRows.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__removeRows;
	...
	virtual bool removeRows(int row, int count, const QModelIndex& parent) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval3 = const_cast<QModelIndex*>(&parent_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_removeRows(this, handle__removeRows.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__moveRows;
	...
	virtual bool moveRows(const QModelIndex& sourceParent, int sourceRow, int count, const QModelIndex& destinationParent, int destinationChild) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_moveRows(this, handle__moveRows.value(), sigval1, sigval2, sigval3, sigval4, sigval5);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__itemData;
	...
	virtual QMap<int, QVariant> itemData(const QModelIndex& index) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		struct miqt_map /* of int to QVariant* */  callback_return_value = miqt_exec_callback_QStringListModel_itemData(this, handle__itemData.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__setItemData;
	...
	virtual bool setItemData(const QModelIndex& index, const QMap<int, QVariant>& roles) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_setItemData(this, handle__setItemData.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__sort;
	...
	virtual void sort(int column, Qt::SortOrder order) override {
		...
		miqt_exec_callback_QStringListModel_sort(this, handle__sort.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__supportedDropActions;
	...
	virtual Qt::DropActions supportedDropActions() const override {
		...
		int callback_return_value = miqt_exec_callback_QStringListModel_supportedDropActions(this, handle__supportedDropActions.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__dropMimeData;
	...
	virtual bool dropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_dropMimeData(this, handle__dropMimeData.value(), sigval1, sigval2, sigval3, sigval4, sigval5);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__setHeaderData;
	...
	virtual bool setHeaderData(int section, Qt::Orientation orientation, const QVariant& value, int role) override {
		...
		int sigval4 = role;
		bool callback_return_value = miqt_exec_callback_QStringListModel_setHeaderData(this, handle__setHeaderData.value(), sigval1, sigval2, sigval3, sigval4);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__mimeTypes;
	...
	virtual QStringList mimeTypes() const override {
		...
		struct miqt_array /* of struct miqt_string */  callback_return_value = miqt_exec_callback_QStringListModel_mimeTypes(this, handle__mimeTypes.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__mimeData;
	...
	virtual QMimeData* mimeData(const QModelIndexList& indexes) const override {
		...
		QMimeData* callback_return_value = miqt_exec_callback_QStringListModel_mimeData(this, handle__mimeData.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__canDropMimeData;
	...
	virtual bool canDropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval5 = const_cast<QModelIndex*>(&parent_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_canDropMimeData(this, handle__canDropMimeData.value(), sigval1, sigval2, sigval3, sigval4, sigval5);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__supportedDragActions;
	...
	virtual Qt::DropActions supportedDragActions() const override {
		...
		int callback_return_value = miqt_exec_callback_QStringListModel_supportedDragActions(this, handle__supportedDragActions.value());
		return static_cast<Qt::DropActions>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__insertColumns;
	...
	virtual bool insertColumns(int column, int count, const QModelIndex& parent) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval3 = const_cast<QModelIndex*>(&parent_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_insertColumns(this, handle__insertColumns.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__removeColumns;
	...
	virtual bool removeColumns(int column, int count, const QModelIndex& parent) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval3 = const_cast<QModelIndex*>(&parent_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_removeColumns(this, handle__removeColumns.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__moveColumns;
	...
	virtual bool moveColumns(const QModelIndex& sourceParent, int sourceColumn, int count, const QModelIndex& destinationParent, int destinationChild) override {
		...
		QModelIndex* sigval4 = const_cast<QModelIndex*>(&destinationParent_ret);
		int sigval5 = destinationChild;
		bool callback_return_value = miqt_exec_callback_QStringListModel_moveColumns(this, handle__moveColumns.value(), sigval1, sigval2, sigval3, sigval4, sigval5);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__fetchMore;
	...
	virtual void fetchMore(const QModelIndex& parent) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&parent_ret);
		miqt_exec_callback_QStringListModel_fetchMore(this, handle__fetchMore.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__canFetchMore;
	...
	virtual bool canFetchMore(const QModelIndex& parent) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&parent_ret);
		bool callback_return_value = miqt_exec_callback_QStringListModel_canFetchMore(this, handle__canFetchMore.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__match;
	...
	virtual QModelIndexList match(const QModelIndex& start, int role, const QVariant& value, int hits, Qt::MatchFlags flags) const override {
		...
		struct miqt_array /* of QModelIndex* */  callback_return_value = miqt_exec_callback_QStringListModel_match(this, handle__match.value(), sigval1, sigval2, sigval3, sigval4, sigval5);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__roleNames;
	...
	virtual QHash<int, QByteArray> roleNames() const override {
		...
		struct miqt_map /* of int to struct miqt_string */  callback_return_value = miqt_exec_callback_QStringListModel_roleNames(this, handle__roleNames.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__multiData;
	...
	virtual void multiData(const QModelIndex& index, QModelRoleDataSpan roleDataSpan) const override {
		...
		miqt_exec_callback_QStringListModel_multiData(this, handle__multiData.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__submit;
	...
	virtual bool submit() override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_submit(this, handle__submit.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__revert;
	...
	virtual void revert() override {
		...
		miqt_exec_callback_QStringListModel_revert(this, handle__revert.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__resetInternalData;
	...
	virtual void resetInternalData() override {
		...
		miqt_exec_callback_QStringListModel_resetInternalData(this, handle__resetInternalData.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QStringListModel_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QStringListModel_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QStringListModel_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QStringListModel_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QStringListModel_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStringListModel> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QStringListModel_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QStringListModel* QStringListModel_new() {
	return new (std::nothrow) MiqtVirtualQStringListModel();
}
...
QStringListModel* QStringListModel_new2(struct miqt_array /* of struct miqt_string */  strings) {
	...
	return new (std::nothrow) MiqtVirtualQStringListModel(strings_QList);
}

QStringListModel* QStringListModel_new3(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQStringListModel(parent);
}
...
QStringListModel* QStringListModel_new4(struct miqt_array /* of struct miqt_string */  strings, QObject* parent) {
	...
	return new (std::nothrow) MiqtVirtualQStringListModel(strings_QList, parent);
}
...
int QStringListModel_virtualbase_rowCount(const void* self, QModelIndex* parent) {
	return static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::rowCount(*parent);
}
...
QModelIndex* QStringListModel_virtualbase_sibling(const void* self, int row, int column, QModelIndex* idx) {
	return new QModelIndex(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::sibling(static_cast<int>(row), static_cast<int>(column), *idx));
}
...
QVariant* QStringListModel_virtualbase_data(const void* self, QModelIndex* index, int role) {
	return new QVariant(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::data(*index, static_cast<int>(role)));
}
...
bool QStringListModel_virtualbase_setData(void* self, QModelIndex* index, QVariant* value, int role) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::setData(*index, *value, static_cast<int>(role));
}
...
bool QStringListModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::clearItemData(*index);
}
...
int QStringListModel_virtualbase_flags(const void* self, QModelIndex* index) {
	Qt::ItemFlags _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::flags(*index);
	return static_cast<int>(_ret);
}
...
bool QStringListModel_virtualbase_insertRows(void* self, int row, int count, QModelIndex* parent) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::insertRows(static_cast<int>(row), static_cast<int>(count), *parent);
}
...
bool QStringListModel_virtualbase_removeRows(void* self, int row, int count, QModelIndex* parent) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::removeRows(static_cast<int>(row), static_cast<int>(count), *parent);
}
...
bool QStringListModel_virtualbase_moveRows(void* self, QModelIndex* sourceParent, int sourceRow, int count, QModelIndex* destinationParent, int destinationChild) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::moveRows(*sourceParent, static_cast<int>(sourceRow), static_cast<int>(count), *destinationParent, static_cast<int>(destinationChild));
}
...
struct miqt_map /* of int to QVariant* */  QStringListModel_virtualbase_itemData(const void* self, QModelIndex* index) {
	QMap<int, QVariant> _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::itemData(*index);
	// Convert QMap<> from C++ memory to manually-managed C memory
	int* _karr = static_cast<int*>(malloc(sizeof(int) * _ret.size()));
	QVariant** _varr = static_cast<QVariant**>(malloc(sizeof(QVariant*) * _ret.size()));
	int _ctr = 0;
...
bool QStringListModel_virtualbase_setItemData(void* self, QModelIndex* index, struct miqt_map /* of int to QVariant* */  roles) {
	...
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::setItemData(*index, roles_QMap);
}
...
void QStringListModel_virtualbase_sort(void* self, int column, int order) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::sort(static_cast<int>(column), static_cast<Qt::SortOrder>(order));
}
...
int QStringListModel_virtualbase_supportedDropActions(const void* self) {
	Qt::DropActions _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::supportedDropActions();
	return static_cast<int>(_ret);
}
...
QModelIndex* QStringListModel_virtualbase_index(const void* self, int row, int column, QModelIndex* parent) {
	return new QModelIndex(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::index(static_cast<int>(row), static_cast<int>(column), *parent));
}
...
QVariant* QStringListModel_virtualbase_headerData(const void* self, int section, int orientation, int role) {
	return new QVariant(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::headerData(static_cast<int>(section), static_cast<Qt::Orientation>(orientation), static_cast<int>(role)));
}
...
bool QStringListModel_virtualbase_setHeaderData(void* self, int section, int orientation, QVariant* value, int role) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::setHeaderData(static_cast<int>(section), static_cast<Qt::Orientation>(orientation), *value, static_cast<int>(role));
}
...
struct miqt_array /* of struct miqt_string */  QStringListModel_virtualbase_mimeTypes(const void* self) {
	QStringList _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::mimeTypes();
	// Convert QList<> from C++ memory to manually-managed C memory
	struct miqt_string* _arr = static_cast<struct miqt_string*>(malloc(sizeof(struct miqt_string) * _ret.length()));
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		QString _lv_ret = _ret[i];
...
QMimeData* QStringListModel_virtualbase_mimeData(const void* self, struct miqt_array /* of QModelIndex* */  indexes) {
	...
	return static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::mimeData(indexes_QList);
}
...
bool QStringListModel_virtualbase_canDropMimeData(const void* self, QMimeData* data, int action, int row, int column, QModelIndex* parent) {
	return static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::canDropMimeData(data, static_cast<Qt::DropAction>(action), static_cast<int>(row), static_cast<int>(column), *parent);
}
...
int QStringListModel_virtualbase_supportedDragActions(const void* self) {
	Qt::DropActions _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::supportedDragActions();
	return static_cast<int>(_ret);
}
...
bool QStringListModel_virtualbase_insertColumns(void* self, int column, int count, QModelIndex* parent) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::insertColumns(static_cast<int>(column), static_cast<int>(count), *parent);
}
...
bool QStringListModel_virtualbase_removeColumns(void* self, int column, int count, QModelIndex* parent) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::removeColumns(static_cast<int>(column), static_cast<int>(count), *parent);
}
...
bool QStringListModel_virtualbase_moveColumns(void* self, QModelIndex* sourceParent, int sourceColumn, int count, QModelIndex* destinationParent, int destinationChild) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::moveColumns(*sourceParent, static_cast<int>(sourceColumn), static_cast<int>(count), *destinationParent, static_cast<int>(destinationChild));
}
...
void QStringListModel_virtualbase_fetchMore(void* self, QModelIndex* parent) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::fetchMore(*parent);
}
...
bool QStringListModel_virtualbase_canFetchMore(const void* self, QModelIndex* parent) {
	return static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::canFetchMore(*parent);
}
...
QModelIndex* QStringListModel_virtualbase_buddy(const void* self, QModelIndex* index) {
	return new QModelIndex(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::buddy(*index));
}
...
struct miqt_array /* of QModelIndex* */  QStringListModel_virtualbase_match(const void* self, QModelIndex* start, int role, QVariant* value, int hits, int flags) {
	QModelIndexList _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::match(*start, static_cast<int>(role), *value, static_cast<int>(hits), static_cast<Qt::MatchFlags>(flags));
	// Convert QList<> from C++ memory to manually-managed C memory
...
QSize* QStringListModel_virtualbase_span(const void* self, QModelIndex* index) {
	return new QSize(static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::span(*index));
}
...
struct miqt_map /* of int to struct miqt_string */  QStringListModel_virtualbase_roleNames(const void* self) {
	QHash<int, QByteArray> _ret = static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::roleNames();
	// Convert QMap<> from C++ memory to manually-managed C memory
	int* _karr = static_cast<int*>(malloc(sizeof(int) * _ret.size()));
...
void QStringListModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	static_cast<const MiqtVirtualQStringListModel*>(self)->QStringListModel::multiData(*index, *roleDataSpan);
}
...
bool QStringListModel_virtualbase_submit(void* self) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::submit();
}
...
void QStringListModel_virtualbase_revert(void* self) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::revert();
}
...
void QStringListModel_virtualbase_resetInternalData(void* self) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::resetInternalData();
}
...
bool QStringListModel_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::event(event);
}
...
bool QStringListModel_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::eventFilter(watched, event);
}
...
void QStringListModel_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::timerEvent(event);
}
...
void QStringListModel_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::childEvent(event);
}
...
void QStringListModel_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::customEvent(event);
}
...
void QStringListModel_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::connectNotify(*signal);
}
...
void QStringListModel_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQStringListModel*>(self)->QStringListModel::disconnectNotify(*signal);
}
