...
void miqt_exec_callback_handle_release_QGenericPlugin(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__create;
	...
	virtual QObject* create(const QString& name, const QString& spec) override {
		...
		QObject* callback_return_value = miqt_exec_callback_QGenericPlugin_create(this, handle__create.value(), sigval1, sigval2);
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QGenericPlugin_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QGenericPlugin_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QGenericPlugin_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QGenericPlugin_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QGenericPlugin_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QGenericPlugin_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QGenericPlugin_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
bool QGenericPlugin_override_virtual_create(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QGenericPlugin> slot_handle(slot);
