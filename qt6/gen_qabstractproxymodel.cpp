...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractProxyModel> handle__clearItemData;
	...
	virtual bool clearItemData(const QModelIndex& index) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		bool callback_return_value = miqt_exec_callback_QAbstractProxyModel_clearItemData(this, handle__clearItemData.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractProxyModel> handle__multiData;
	...
	virtual void multiData(const QModelIndex& index, QModelRoleDataSpan roleDataSpan) const override {
		...
		miqt_exec_callback_QAbstractProxyModel_multiData(this, handle__multiData.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAbstractProxyModel> handle__resetInternalData;
	...
	virtual void resetInternalData() override {
		...
		miqt_exec_callback_QAbstractProxyModel_resetInternalData(this, handle__resetInternalData.value());
...
void QAbstractProxyModel_virtualbase_resetInternalData(void* self) {
	static_cast<MiqtVirtualQAbstractProxyModel*>(self)->QAbstractProxyModel::resetInternalData();
}
