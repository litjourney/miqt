...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QListWidget> handle__initViewItemOption;
	...
	virtual void initViewItemOption(QStyleOptionViewItem* option) const override {
		...
		miqt_exec_callback_QListWidget_initViewItemOption(this, handle__initViewItemOption.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QListWidget> handle__itemDelegateForIndex;
	...
	virtual QAbstractItemDelegate* itemDelegateForIndex(const QModelIndex& index) const override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		QAbstractItemDelegate* callback_return_value = miqt_exec_callback_QListWidget_itemDelegateForIndex(this, handle__itemDelegateForIndex.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QListWidget> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionFrame* option) const override {
		...
		miqt_exec_callback_QListWidget_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
void QListWidget_virtualbase_initViewItemOption(const void* self, QStyleOptionViewItem* option) {
	static_cast<const MiqtVirtualQListWidget*>(self)->QListWidget::initViewItemOption(option);
}
...
QAbstractItemDelegate* QListWidget_virtualbase_itemDelegateForIndex(const void* self, QModelIndex* index) {
	return static_cast<const MiqtVirtualQListWidget*>(self)->QListWidget::itemDelegateForIndex(*index);
}
...
void QListWidget_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	static_cast<const MiqtVirtualQListWidget*>(self)->QListWidget::initStyleOption(option);
}
...
bool QListWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQListWidget*>(self)->QListWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
