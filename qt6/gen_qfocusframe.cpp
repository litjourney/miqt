...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFocusFrame> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOption* option) const override {
		...
		miqt_exec_callback_QFocusFrame_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
void QFocusFrame_virtualbase_initStyleOption(const void* self, QStyleOption* option) {
	static_cast<const MiqtVirtualQFocusFrame*>(self)->QFocusFrame::initStyleOption(option);
}
...
bool QFocusFrame_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQFocusFrame*>(self)->QFocusFrame::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
