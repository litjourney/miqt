...
QAudioOutput* QAudioOutput_new2(QAudioDevice* device) {
	return new (std::nothrow) MiqtVirtualQAudioOutput(*device);
}

QAudioOutput* QAudioOutput_new3(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQAudioOutput(parent);
}

QAudioOutput* QAudioOutput_new4(QAudioDevice* device, QObject* parent) {
	return new (std::nothrow) MiqtVirtualQAudioOutput(*device, parent);
}
...
void* QAudioOutput_connect_deviceChanged(QAudioOutput* self, intptr_t slot) {
	...
	return new QMetaObject::Connection(QAudioOutput::connect(self, static_cast<void (QAudioOutput::*)()>(&QAudioOutput::deviceChanged), self, [slot_handle]() {
...
void* QAudioOutput_connect_volumeChanged(QAudioOutput* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAudioOutput>>(slot);
	return new QMetaObject::Connection(QAudioOutput::connect(self, static_cast<void (QAudioOutput::*)(float)>(&QAudioOutput::volumeChanged), self, [slot_handle](float volume) {
		intptr_t slot = slot_handle->value();
...
void* QAudioOutput_connect_mutedChanged(QAudioOutput* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAudioOutput>>(slot);
	return new QMetaObject::Connection(QAudioOutput::connect(self, static_cast<void (QAudioOutput::*)(bool)>(&QAudioOutput::mutedChanged), self, [slot_handle](bool muted) {
		intptr_t slot = slot_handle->value();
		bool sigval1 = muted;
