...
void miqt_exec_callback_handle_release_QSoundEffect(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QSoundEffect_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QSoundEffect_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QSoundEffect_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QSoundEffect_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QSoundEffect_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QSoundEffect_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QSoundEffect_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
void* QSoundEffect_connect_sourceChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::sourceChanged), self, [slot_handle]() {
...
void* QSoundEffect_connect_loopCountChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loopCountChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_loopsRemainingChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loopsRemainingChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_volumeChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::volumeChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_mutedChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::mutedChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_loadedChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loadedChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_playingChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::playingChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_statusChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::statusChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QSoundEffect_connect_audioDeviceChanged(QSoundEffect* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect>>(slot);
	return new QMetaObject::Connection(QSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::audioDeviceChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
bool QSoundEffect_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSoundEffect> slot_handle(slot);
