...
void* QVideoWidget_connect_aspectRatioModeChanged(QVideoWidget* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QVideoWidget>>(slot);
	return new QMetaObject::Connection(QVideoWidget::connect(self, static_cast<void (QVideoWidget::*)(Qt::AspectRatioMode)>(&QVideoWidget::aspectRatioModeChanged), self, [slot_handle](Qt::AspectRatioMode mode) {
		intptr_t slot = slot_handle->value();
...
bool QVideoWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQVideoWidget*>(self)->QVideoWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
