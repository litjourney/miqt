...
bool QSplashScreen_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSplashScreen> slot_handle(slot);
	MiqtVirtualQSplashScreen* self_cast = dynamic_cast<MiqtVirtualQSplashScreen*>( (QSplashScreen*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QSplashScreen_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSplashScreen> slot_handle(slot);
	MiqtVirtualQSplashScreen* self_cast = dynamic_cast<MiqtVirtualQSplashScreen*>( (QSplashScreen*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QSplashScreen_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQSplashScreen*>(self)->QSplashScreen::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
bool QSplashScreen_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QSplashScreen> slot_handle(slot);
	MiqtVirtualQSplashScreen* self_cast = dynamic_cast<MiqtVirtualQSplashScreen*>( (QSplashScreen*)(self) );
	if (self_cast == nullptr) {
		return false;
