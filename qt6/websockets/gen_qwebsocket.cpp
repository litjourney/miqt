...
void* QWebSocket_connect_peerVerifyError(QWebSocket* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QWebSocket>>(slot);
	return new QMetaObject::Connection(QWebSocket::connect(self, static_cast<void (QWebSocket::*)(const QSslError&)>(&QWebSocket::peerVerifyError), self, [slot_handle](const QSslError& error) {
		intptr_t slot = slot_handle->value();
...
void* QWebSocket_connect_alertSent(QWebSocket* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QWebSocket>>(slot);
	return new QMetaObject::Connection(QWebSocket::connect(self, static_cast<void (QWebSocket::*)(QSsl::AlertLevel, QSsl::AlertType, const QString&)>(&QWebSocket::alertSent), self, [slot_handle](QSsl::AlertLevel level, QSsl::AlertType type, const QString& description) {
		intptr_t slot = slot_handle->value();
...
void* QWebSocket_connect_alertReceived(QWebSocket* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QWebSocket>>(slot);
	return new QMetaObject::Connection(QWebSocket::connect(self, static_cast<void (QWebSocket::*)(QSsl::AlertLevel, QSsl::AlertType, const QString&)>(&QWebSocket::alertReceived), self, [slot_handle](QSsl::AlertLevel level, QSsl::AlertType type, const QString& description) {
		intptr_t slot = slot_handle->value();
		QSsl::AlertLevel level_ret = level;
		int sigval1 = static_cast<int>(level_ret);
		QSsl::AlertType type_ret = type;
...
void* QWebSocket_connect_handshakeInterruptedOnError(QWebSocket* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QWebSocket>>(slot);
	return new QMetaObject::Connection(QWebSocket::connect(self, static_cast<void (QWebSocket::*)(const QSslError&)>(&QWebSocket::handshakeInterruptedOnError), self, [slot_handle](const QSslError& error) {
		intptr_t slot = slot_handle->value();
		const QSslError& error_ret = error;
		// Cast returned reference into pointer
		QSslError* sigval1 = const_cast<QSslError*>(&error_ret);
