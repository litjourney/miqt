...
void miqt_exec_callback_handle_release_QAudioListener(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QAudioListener_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QAudioListener_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QAudioListener_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QAudioListener_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QAudioListener_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QAudioListener_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QAudioListener_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QAudioListener* QAudioListener_new(QAudioEngine* engine) {
	return new (std::nothrow) MiqtVirtualQAudioListener(engine);
}
...
bool QAudioListener_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QAudioListener> slot_handle(slot);
...
bool QAudioListener_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::event(event);
}
...
bool QAudioListener_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::eventFilter(watched, event);
}
...
void QAudioListener_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::timerEvent(event);
}
...
void QAudioListener_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::childEvent(event);
}
...
void QAudioListener_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::customEvent(event);
}
...
void QAudioListener_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::connectNotify(*signal);
}
...
void QAudioListener_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQAudioListener*>(self)->QAudioListener::disconnectNotify(*signal);
}
