...
void miqt_exec_callback_handle_release_QAmbientSound(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QAmbientSound_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QAmbientSound_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QAmbientSound_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QAmbientSound_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QAmbientSound_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QAmbientSound_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QAmbientSound_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QAmbientSound* QAmbientSound_new(QAudioEngine* engine) {
	return new (std::nothrow) MiqtVirtualQAmbientSound(engine);
}
...
void* QAmbientSound_connect_sourceChanged(QAmbientSound* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound>>(slot);
	return new QMetaObject::Connection(QAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::sourceChanged), self, [slot_handle]() {
...
void* QAmbientSound_connect_loopsChanged(QAmbientSound* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound>>(slot);
	return new QMetaObject::Connection(QAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::loopsChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QAmbientSound_connect_autoPlayChanged(QAmbientSound* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound>>(slot);
	return new QMetaObject::Connection(QAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::autoPlayChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
void* QAmbientSound_connect_volumeChanged(QAmbientSound* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound>>(slot);
	return new QMetaObject::Connection(QAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::volumeChanged), self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
...
bool QAmbientSound_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QAmbientSound> slot_handle(slot);
...
bool QAmbientSound_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::event(event);
}
...
bool QAmbientSound_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::eventFilter(watched, event);
}
...
void QAmbientSound_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::timerEvent(event);
}
...
void QAmbientSound_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::childEvent(event);
}
...
void QAmbientSound_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::customEvent(event);
}
...
void QAmbientSound_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::connectNotify(*signal);
}
...
void QAmbientSound_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQAmbientSound*>(self)->QAmbientSound::disconnectNotify(*signal);
}
