...
void miqt_exec_callback_handle_release_QTcpServer(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__hasPendingConnections;
	...
	virtual bool hasPendingConnections() const override {
		...
		bool callback_return_value = miqt_exec_callback_QTcpServer_hasPendingConnections(this, handle__hasPendingConnections.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__nextPendingConnection;
	...
	virtual QTcpSocket* nextPendingConnection() override {
		...
		QTcpSocket* callback_return_value = miqt_exec_callback_QTcpServer_nextPendingConnection(this, handle__nextPendingConnection.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__incomingConnection;
	...
	virtual void incomingConnection(qintptr handle) override {
		...
		miqt_exec_callback_QTcpServer_incomingConnection(this, handle__incomingConnection.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QTcpServer_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QTcpServer_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QTcpServer_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QTcpServer_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QTcpServer_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QTcpServer_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QTcpServer_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QTcpServer* QTcpServer_new() {
	return new (std::nothrow) MiqtVirtualQTcpServer();
}

QTcpServer* QTcpServer_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQTcpServer(parent);
}
...
void* QTcpServer_connect_newConnection(QTcpServer* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer>>(slot);
	return new QMetaObject::Connection(QTcpServer::connect(self, static_cast<void (QTcpServer::*)()>(&QTcpServer::newConnection), self, [slot_handle]() {
...
void* QTcpServer_connect_acceptError(QTcpServer* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer>>(slot);
	return new QMetaObject::Connection(QTcpServer::connect(self, static_cast<void (QTcpServer::*)(QAbstractSocket::SocketError)>(&QTcpServer::acceptError), self, [slot_handle](QAbstractSocket::SocketError socketError) {
		intptr_t slot = slot_handle->value();
...
bool QTcpServer_override_virtual_hasPendingConnections(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer> slot_handle(slot);
...
bool QTcpServer_virtualbase_hasPendingConnections(const void* self) {
	return static_cast<const MiqtVirtualQTcpServer*>(self)->QTcpServer::hasPendingConnections();
}
...
QTcpSocket* QTcpServer_virtualbase_nextPendingConnection(void* self) {
	return static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::nextPendingConnection();
}
...
void QTcpServer_virtualbase_incomingConnection(void* self, intptr_t handle) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::incomingConnection((qintptr)(handle));
}
...
bool QTcpServer_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::event(event);
}
...
bool QTcpServer_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::eventFilter(watched, event);
}
...
void QTcpServer_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::timerEvent(event);
}
...
void QTcpServer_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::childEvent(event);
}
...
void QTcpServer_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::customEvent(event);
}
...
void QTcpServer_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::connectNotify(*signal);
}
...
void QTcpServer_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQTcpServer*>(self)->QTcpServer::disconnectNotify(*signal);
}
...
void* QTcpServer_connect_pendingConnectionAvailable(QTcpServer* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QTcpServer>>(slot);
	return new QMetaObject::Connection(QTcpServer::connect(self, &QTcpServer::pendingConnectionAvailable, self, [slot_handle]() {
		intptr_t slot = slot_handle->value();
