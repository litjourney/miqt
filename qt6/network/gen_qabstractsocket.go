...
func (this *QAbstractSocket) OnSocketOptionOwned(slot func(super func(option QAbstractSocket__SocketOption) *qt6.QVariant, option QAbstractSocket__SocketOption) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
