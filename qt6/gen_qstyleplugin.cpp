...
void miqt_exec_callback_handle_release_QStylePlugin(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__create;
	...
	virtual QStyle* create(const QString& key) override {
		...
		QStyle* callback_return_value = miqt_exec_callback_QStylePlugin_create(this, handle__create.value(), sigval1);
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QStylePlugin_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QStylePlugin_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QStylePlugin_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QStylePlugin_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QStylePlugin_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QStylePlugin_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QStylePlugin_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
QStylePlugin* QStylePlugin_new() {
	return new (std::nothrow) MiqtVirtualQStylePlugin();
}

QStylePlugin* QStylePlugin_new2(QObject* parent) {
	return new (std::nothrow) MiqtVirtualQStylePlugin(parent);
}
...
bool QStylePlugin_override_virtual_create(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QStylePlugin> slot_handle(slot);
...
bool QStylePlugin_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::event(event);
}
...
bool QStylePlugin_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::eventFilter(watched, event);
}
...
void QStylePlugin_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::timerEvent(event);
}
...
void QStylePlugin_virtualbase_childEvent(void* self, QChildEvent* event) {
	static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::childEvent(event);
}
...
void QStylePlugin_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::customEvent(event);
}
...
void QStylePlugin_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::connectNotify(*signal);
}
...
void QStylePlugin_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQStylePlugin*>(self)->QStylePlugin::disconnectNotify(*signal);
}
