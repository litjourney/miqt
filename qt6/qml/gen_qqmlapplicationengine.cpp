...
void miqt_exec_callback_handle_release_QQmlApplicationEngine(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__event;
	...
	virtual bool event(QEvent* param1) override {
		...
		bool callback_return_value = miqt_exec_callback_QQmlApplicationEngine_event(this, handle__event.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QQmlApplicationEngine_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QQmlApplicationEngine_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* event) override {
		...
		miqt_exec_callback_QQmlApplicationEngine_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		miqt_exec_callback_QQmlApplicationEngine_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QQmlApplicationEngine_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QQmlApplicationEngine_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
...
void* QQmlApplicationEngine_connect_objectCreated(QQmlApplicationEngine* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine>>(slot);
	return new QMetaObject::Connection(QQmlApplicationEngine::connect(self, static_cast<void (QQmlApplicationEngine::*)(QObject*, const QUrl&)>(&QQmlApplicationEngine::objectCreated), self, [slot_handle](QObject* object, const QUrl& url) {
...
void* QQmlApplicationEngine_connect_objectCreationFailed(QQmlApplicationEngine* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine>>(slot);
	return new QMetaObject::Connection(QQmlApplicationEngine::connect(self, static_cast<void (QQmlApplicationEngine::*)(const QUrl&)>(&QQmlApplicationEngine::objectCreationFailed), self, [slot_handle](const QUrl& url) {
		intptr_t slot = slot_handle->value();
		const QUrl& url_ret = url;
		// Cast returned reference into pointer
...
bool QQmlApplicationEngine_override_virtual_event(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QQmlApplicationEngine> slot_handle(slot);
