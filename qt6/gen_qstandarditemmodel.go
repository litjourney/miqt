...
//export miqt_exec_callback_handle_release_QStandardItem
func miqt_exec_callback_handle_release_QStandardItem(cb C.intptr_t) {
...
// EmitDataChanged can only be called from a QStandardItem that was directly constructed.
func (this *QStandardItem) EmitDataChanged() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItem_protectedbase_emitDataChanged(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
type miqtVirtualCallback_QStandardItem_data struct {
...
func (this *QStandardItem) OnData(slot func(super func(role int) *QVariant, role int) *QVariant) {
	...
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItem_data{callback: slot}))
	}
	ok := C.QStandardItem_override_virtual_data(unsafe.Pointer(this.h), slotHandle)
	if !ok {
...
func (this *QStandardItem) OnDataOwned(slot func(super func(role int) *QVariant, role int) *QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItem_data{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItem_override_virtual_owned_data(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItem_data(self *C.QStandardItem, cb C.intptr_t, role C.int) *C.QVariant {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItem_data)
	if !ok {
...
func (this *QStandardItem) OnMultiData(slot func(super func(roleDataSpan QModelRoleDataSpan), roleDataSpan QModelRoleDataSpan)) {
	...
	ok := C.QStandardItem_override_virtual_multiData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnSetData(slot func(super func(value *QVariant, role int), value *QVariant, role int)) {
	...
	ok := C.QStandardItem_override_virtual_setData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnClone(slot func(super func() *QStandardItem) *QStandardItem) {
	...
	ok := C.QStandardItem_override_virtual_clone(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnType(slot func(super func() int) int) {
	...
	ok := C.QStandardItem_override_virtual_type(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnRead(slot func(super func(in *QDataStream), in *QDataStream)) {
	...
	ok := C.QStandardItem_override_virtual_read(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnWrite(slot func(super func(out *QDataStream), out *QDataStream)) {
	...
	ok := C.QStandardItem_override_virtual_write(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItem) OnOperatorLesser(slot func(super func(other *QStandardItem) bool, other *QStandardItem) bool) {
	...
	ok := C.QStandardItem_override_virtual_operatorLesser(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
//export miqt_exec_callback_handle_release_QStandardItemModel
func miqt_exec_callback_handle_release_QStandardItemModel(cb C.intptr_t) {
	cgo.Handle(cb).Delete()
}
...
func (this *QStandardItemModel) OnItemChanged(slot func(item *QStandardItem)) *SignalConnection {
	_goptr := UnsafeNewQMetaObject__Connection(C.QStandardItemModel_connect_itemChanged(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}
...
// CreateIndex can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) CreateIndex(row int, column int) QModelIndex {

	var _dynamic_cast_ok C.bool = false
	_goptr := newQModelIndex(C.QStandardItemModel_protectedbase_createIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h), (C.int)(row), (C.int)(column)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	_method_ret := *_goptr
...
// EncodeData can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EncodeData(indexes []QModelIndex, stream *QDataStream) {
	indexes_CArray := (*[0xffff]*C.QModelIndex)(C.malloc(C.size_t(8 * len(indexes))))
	defer C.free(unsafe.Pointer(indexes_CArray))
	for i := range indexes {
		indexes_CArray[i] = indexes[i].cPointer()
	...
	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_encodeData(&_dynamic_cast_ok, unsafe.Pointer(this.h), indexes_ma, stream.cPointer())
...
// DecodeData can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) DecodeData(row int, column int, parent *QModelIndex, stream *QDataStream) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QStandardItemModel_protectedbase_decodeData(&_dynamic_cast_ok, unsafe.Pointer(this.h), (C.int)(row), (C.int)(column), parent.cPointer(), stream.cPointer()))
...
// BeginInsertRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginInsertRows(parent *QModelIndex, first int, last int) {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_beginInsertRows(&_dynamic_cast_ok, unsafe.Pointer(this.h), parent.cPointer(), (C.int)(first), (C.int)(last))
...
// EndInsertRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndInsertRows() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endInsertRows(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginRemoveRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginRemoveRows(parent *QModelIndex, first int, last int) {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_beginRemoveRows(&_dynamic_cast_ok, unsafe.Pointer(this.h), parent.cPointer(), (C.int)(first), (C.int)(last))
...
// EndRemoveRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndRemoveRows() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endRemoveRows(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginMoveRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginMoveRows(sourceParent *QModelIndex, sourceFirst int, sourceLast int, destinationParent *QModelIndex, destinationRow int) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QStandardItemModel_protectedbase_beginMoveRows(&_dynamic_cast_ok, unsafe.Pointer(this.h), sourceParent.cPointer(), (C.int)(sourceFirst), (C.int)(sourceLast), destinationParent.cPointer(), (C.int)(destinationRow)))
...
// EndMoveRows can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndMoveRows() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endMoveRows(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginInsertColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginInsertColumns(parent *QModelIndex, first int, last int) {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_beginInsertColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h), parent.cPointer(), (C.int)(first), (C.int)(last))
...
// EndInsertColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndInsertColumns() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endInsertColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginRemoveColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginRemoveColumns(parent *QModelIndex, first int, last int) {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_beginRemoveColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h), parent.cPointer(), (C.int)(first), (C.int)(last))
...
// EndRemoveColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndRemoveColumns() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endRemoveColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginMoveColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginMoveColumns(sourceParent *QModelIndex, sourceFirst int, sourceLast int, destinationParent *QModelIndex, destinationColumn int) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QStandardItemModel_protectedbase_beginMoveColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h), sourceParent.cPointer(), (C.int)(sourceFirst), (C.int)(sourceLast), destinationParent.cPointer(), (C.int)(destinationColumn)))
...
// EndMoveColumns can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndMoveColumns() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endMoveColumns(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// BeginResetModel can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) BeginResetModel() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_beginResetModel(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// EndResetModel can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) EndResetModel() {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_endResetModel(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// ChangePersistentIndex can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) ChangePersistentIndex(from *QModelIndex, to *QModelIndex) {

	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_changePersistentIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h), from.cPointer(), to.cPointer())
...
// ChangePersistentIndexList can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) ChangePersistentIndexList(from []QModelIndex, to []QModelIndex) {
	...
	var _dynamic_cast_ok C.bool = false
	C.QStandardItemModel_protectedbase_changePersistentIndexList(&_dynamic_cast_ok, unsafe.Pointer(this.h), from_ma, to_ma)
...
// PersistentIndexList can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) PersistentIndexList() []QModelIndex {

	var _dynamic_cast_ok C.bool = false
	var _ma C.struct_miqt_array = C.QStandardItemModel_protectedbase_persistentIndexList(&_dynamic_cast_ok, unsafe.Pointer(this.h))
...
// Sender can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) Sender() *QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := newQObject(C.QStandardItemModel_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// SenderSignalIndex can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QStandardItemModel_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QStandardItemModel_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QStandardItemModel that was directly constructed.
func (this *QStandardItemModel) IsSignalConnected(signal *QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QStandardItemModel_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal.cPointer()))
...
func (this *QStandardItemModel) OnRoleNames(slot func(super func() map[int][]byte) map[int][]byte) {
	...
	ok := C.QStandardItemModel_override_virtual_roleNames(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_index struct {
...
func (this *QStandardItemModel) OnIndex(slot func(super func(row int, column int, parent *QModelIndex) *QModelIndex, row int, column int, parent *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_index{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_index(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnIndexOwned(slot func(super func(row int, column int, parent *QModelIndex) *QModelIndex, row int, column int, parent *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_index{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_index(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_index(self *C.QStandardItemModel, cb C.intptr_t, row C.int, column C.int, parent *C.QModelIndex) *C.QModelIndex {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_index)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
type miqtVirtualCallback_QStandardItemModel_parent struct {
	callback   func(super func(child *QModelIndex) *QModelIndex, child *QModelIndex) *QModelIndex
	ownsReturn bool
}
...
func (this *QStandardItemModel) OnParent(slot func(super func(child *QModelIndex) *QModelIndex, child *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_parent{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_parent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnParentOwned(slot func(super func(child *QModelIndex) *QModelIndex, child *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_parent{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_parent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_parent(self *C.QStandardItemModel, cb C.intptr_t, child *C.QModelIndex) *C.QModelIndex {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_parent)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnRowCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	ok := C.QStandardItemModel_override_virtual_rowCount(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnColumnCount(slot func(super func(parent *QModelIndex) int, parent *QModelIndex) int) {
	...
	ok := C.QStandardItemModel_override_virtual_columnCount(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnHasChildren(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_hasChildren(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_data struct {
	callback   func(super func(index *QModelIndex, role int) *QVariant, index *QModelIndex, role int) *QVariant
	ownsReturn bool
}
...
func (this *QStandardItemModel) OnData(slot func(super func(index *QModelIndex, role int) *QVariant, index *QModelIndex, role int) *QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_data{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_data(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// OnDataOwned installs a virtual override that transfers
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnDataOwned(slot func(super func(index *QModelIndex, role int) *QVariant, index *QModelIndex, role int) *QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_data{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_data(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_data(self *C.QStandardItemModel, cb C.intptr_t, index *C.QModelIndex, role C.int) *C.QVariant {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_data)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnMultiData(slot func(super func(index *QModelIndex, roleDataSpan QModelRoleDataSpan), index *QModelIndex, roleDataSpan QModelRoleDataSpan)) {
	...
	ok := C.QStandardItemModel_override_virtual_multiData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnSetData(slot func(super func(index *QModelIndex, value *QVariant, role int) bool, index *QModelIndex, value *QVariant, role int) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_setData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnClearItemData(slot func(super func(index *QModelIndex) bool, index *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_clearItemData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_headerData struct {
...
func (this *QStandardItemModel) OnHeaderData(slot func(super func(section int, orientation Orientation, role int) *QVariant, section int, orientation Orientation, role int) *QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_headerData{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_headerData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnHeaderDataOwned(slot func(super func(section int, orientation Orientation, role int) *QVariant, section int, orientation Orientation, role int) *QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_headerData{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_headerData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_headerData(self *C.QStandardItemModel, cb C.intptr_t, section C.int, orientation C.int, role C.int) *C.QVariant {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_headerData)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnSetHeaderData(slot func(super func(section int, orientation Orientation, value *QVariant, role int) bool, section int, orientation Orientation, value *QVariant, role int) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_setHeaderData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnInsertRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_insertRows(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnInsertColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_insertColumns(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnRemoveRows(slot func(super func(row int, count int, parent *QModelIndex) bool, row int, count int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_removeRows(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnRemoveColumns(slot func(super func(column int, count int, parent *QModelIndex) bool, column int, count int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_removeColumns(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnFlags(slot func(super func(index *QModelIndex) ItemFlag, index *QModelIndex) ItemFlag) {
	...
	ok := C.QStandardItemModel_override_virtual_flags(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnSupportedDropActions(slot func(super func() DropAction) DropAction) {
	...
	ok := C.QStandardItemModel_override_virtual_supportedDropActions(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnItemData(slot func(super func(index *QModelIndex) map[int]QVariant, index *QModelIndex) map[int]QVariant) {
	...
	ok := C.QStandardItemModel_override_virtual_itemData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnSetItemData(slot func(super func(index *QModelIndex, roles map[int]QVariant) bool, index *QModelIndex, roles map[int]QVariant) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_setItemData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnSort(slot func(super func(column int, order SortOrder), column int, order SortOrder)) {
	...
	ok := C.QStandardItemModel_override_virtual_sort(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnMimeTypes(slot func(super func() []string) []string) {
	...
	ok := C.QStandardItemModel_override_virtual_mimeTypes(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnMimeData(slot func(super func(indexes []QModelIndex) *QMimeData, indexes []QModelIndex) *QMimeData) {
	...
	ok := C.QStandardItemModel_override_virtual_mimeData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_dropMimeData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_sibling struct {
...
func (this *QStandardItemModel) OnSibling(slot func(super func(row int, column int, idx *QModelIndex) *QModelIndex, row int, column int, idx *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_sibling{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_sibling(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnSiblingOwned(slot func(super func(row int, column int, idx *QModelIndex) *QModelIndex, row int, column int, idx *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_sibling{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_sibling(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_sibling(self *C.QStandardItemModel, cb C.intptr_t, row C.int, column C.int, idx *C.QModelIndex) *C.QModelIndex {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_sibling)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnCanDropMimeData(slot func(super func(data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool, data *QMimeData, action DropAction, row int, column int, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_canDropMimeData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnSupportedDragActions(slot func(super func() DropAction) DropAction) {
	...
	ok := C.QStandardItemModel_override_virtual_supportedDragActions(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnMoveRows(slot func(super func(sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool, sourceParent *QModelIndex, sourceRow int, count int, destinationParent *QModelIndex, destinationChild int) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_moveRows(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnMoveColumns(slot func(super func(sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool, sourceParent *QModelIndex, sourceColumn int, count int, destinationParent *QModelIndex, destinationChild int) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_moveColumns(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnFetchMore(slot func(super func(parent *QModelIndex), parent *QModelIndex)) {
	...
	ok := C.QStandardItemModel_override_virtual_fetchMore(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnCanFetchMore(slot func(super func(parent *QModelIndex) bool, parent *QModelIndex) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_canFetchMore(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_buddy struct {
...
func (this *QStandardItemModel) OnBuddy(slot func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_buddy{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_buddy(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnBuddyOwned(slot func(super func(index *QModelIndex) *QModelIndex, index *QModelIndex) *QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_buddy{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_buddy(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_buddy(self *C.QStandardItemModel, cb C.intptr_t, index *C.QModelIndex) *C.QModelIndex {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_buddy)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnMatch(slot func(super func(start *QModelIndex, role int, value *QVariant, hits int, flags MatchFlag) []QModelIndex, start *QModelIndex, role int, value *QVariant, hits int, flags MatchFlag) []QModelIndex) {
	...
	ok := C.QStandardItemModel_override_virtual_match(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
type miqtVirtualCallback_QStandardItemModel_span struct {
...
func (this *QStandardItemModel) OnSpan(slot func(super func(index *QModelIndex) *QSize, index *QModelIndex) *QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_span{callback: slot}))
	}
	ok := C.QStandardItemModel_override_virtual_span(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QStandardItemModel) OnSpanOwned(slot func(super func(index *QModelIndex) *QSize, index *QModelIndex) *QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QStandardItemModel_span{callback: slot, ownsReturn: true}))
	}
	ok := C.QStandardItemModel_override_virtual_owned_span(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QStandardItemModel_span(self *C.QStandardItemModel, cb C.intptr_t, index *C.QModelIndex) *C.QSize {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QStandardItemModel_span)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	gofunc := callbackData.callback
...
func (this *QStandardItemModel) OnSubmit(slot func(super func() bool) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_submit(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnRevert(slot func(super func())) {
	...
	ok := C.QStandardItemModel_override_virtual_revert(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnResetInternalData(slot func(super func())) {
	...
	ok := C.QStandardItemModel_override_virtual_resetInternalData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnEvent(slot func(super func(event *QEvent) bool, event *QEvent) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_event(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnEventFilter(slot func(super func(watched *QObject, event *QEvent) bool, watched *QObject, event *QEvent) bool) {
	...
	ok := C.QStandardItemModel_override_virtual_eventFilter(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnTimerEvent(slot func(super func(event *QTimerEvent), event *QTimerEvent)) {
	...
	ok := C.QStandardItemModel_override_virtual_timerEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnChildEvent(slot func(super func(event *QChildEvent), event *QChildEvent)) {
	...
	ok := C.QStandardItemModel_override_virtual_childEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnCustomEvent(slot func(super func(event *QEvent), event *QEvent)) {
	...
	ok := C.QStandardItemModel_override_virtual_customEvent(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnConnectNotify(slot func(super func(signal *QMetaMethod), signal *QMetaMethod)) {
	...
	ok := C.QStandardItemModel_override_virtual_connectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QStandardItemModel) OnDisconnectNotify(slot func(super func(signal *QMetaMethod), signal *QMetaMethod)) {
	...
	ok := C.QStandardItemModel_override_virtual_disconnectNotify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
