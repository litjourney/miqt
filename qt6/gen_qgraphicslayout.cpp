...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QGraphicsLayout> handle__isEmpty;
	...
	virtual bool isEmpty() const override {
		...
		bool callback_return_value = miqt_exec_callback_QGraphicsLayout_isEmpty(this, handle__isEmpty.value());
		return callback_return_value;
	}
...
bool QGraphicsLayout_virtualbase_isEmpty(const void* self) {
	return static_cast<const MiqtVirtualQGraphicsLayout*>(self)->QGraphicsLayout::isEmpty();
}
