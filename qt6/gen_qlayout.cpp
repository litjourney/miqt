...
void miqt_exec_callback_handle_release_QLayout(intptr_t);
...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__spacing;
	...
	virtual int spacing() const override {
		...
		int callback_return_value = miqt_exec_callback_QLayout_spacing(this, handle__spacing.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__setSpacing;
	...
	virtual void setSpacing(int spacing) override {
		...
		int sigval1 = spacing;
		miqt_exec_callback_QLayout_setSpacing(this, handle__setSpacing.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__invalidate;
	...
	virtual void invalidate() override {
		...
		miqt_exec_callback_QLayout_invalidate(this, handle__invalidate.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__geometry;
	...
	virtual QRect geometry() const override {
		...
		QRect* callback_return_value = miqt_exec_callback_QLayout_geometry(this, handle__geometry.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__addItem;
	...
	virtual void addItem(QLayoutItem* param1) override {
		...
		miqt_exec_callback_QLayout_addItem(this, handle__addItem.value(), sigval1);

	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__expandingDirections;
	...
	virtual Qt::Orientations expandingDirections() const override {
		...
		int callback_return_value = miqt_exec_callback_QLayout_expandingDirections(this, handle__expandingDirections.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__minimumSize;
	...
	virtual QSize minimumSize() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QLayout_minimumSize(this, handle__minimumSize.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__maximumSize;
	...
	virtual QSize maximumSize() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QLayout_maximumSize(this, handle__maximumSize.value());
		std::unique_ptr<QSize> callback_return_value_owner;
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__setGeometry;
	...
	virtual void setGeometry(const QRect& geometry) override {
		...
		miqt_exec_callback_QLayout_setGeometry(this, handle__setGeometry.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__itemAt;
	...
	virtual QLayoutItem* itemAt(int index) const override {
		...
		int sigval1 = index;
		QLayoutItem* callback_return_value = miqt_exec_callback_QLayout_itemAt(this, handle__itemAt.value(), sigval1);
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__takeAt;
	...
	virtual QLayoutItem* takeAt(int index) override {
		...
		int sigval1 = index;
		QLayoutItem* callback_return_value = miqt_exec_callback_QLayout_takeAt(this, handle__takeAt.value(), sigval1);
		return callback_return_value;
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__indexOf;
	...
	virtual int indexOf(const QWidget* param1) const override {
		...
		int callback_return_value = miqt_exec_callback_QLayout_indexOf(this, handle__indexOf.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__indexOfWithQLayoutItem;

	// Subclass to allow providing a Go implementation
	virtual int indexOf(const QLayoutItem* param1) const override {
		if (!handle__indexOfWithQLayoutItem) {
			return QLayout::indexOf(param1);
		}

		QLayoutItem* sigval1 = (QLayoutItem*) param1;
		int callback_return_value = miqt_exec_callback_QLayout_indexOfWithQLayoutItem(this, handle__indexOfWithQLayoutItem.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__count;
	...
	virtual int count() const override {
		...
		int callback_return_value = miqt_exec_callback_QLayout_count(this, handle__count.value());
		return static_cast<int>(callback_return_value);
	}

	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__isEmpty;
	...
	virtual bool isEmpty() const override {
		...
		bool callback_return_value = miqt_exec_callback_QLayout_isEmpty(this, handle__isEmpty.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__controlTypes;
	...
	virtual QSizePolicy::ControlTypes controlTypes() const override {
		...
		int callback_return_value = miqt_exec_callback_QLayout_controlTypes(this, handle__controlTypes.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__replaceWidget;
	...
	virtual QLayoutItem* replaceWidget(QWidget* from, QWidget* to, Qt::FindChildOptions options) override {
		...
		QLayoutItem* callback_return_value = miqt_exec_callback_QLayout_replaceWidget(this, handle__replaceWidget.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__layout;
	...
	virtual QLayout* layout() override {
		...
		QLayout* callback_return_value = miqt_exec_callback_QLayout_layout(this, handle__layout.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__childEvent;
	...
	virtual void childEvent(QChildEvent* e) override {
		...
		miqt_exec_callback_QLayout_childEvent(this, handle__childEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__event;
	...
	virtual bool event(QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QLayout_event(this, handle__event.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__eventFilter;
	...
	virtual bool eventFilter(QObject* watched, QEvent* event) override {
		...
		bool callback_return_value = miqt_exec_callback_QLayout_eventFilter(this, handle__eventFilter.value(), sigval1, sigval2);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__timerEvent;
	...
	virtual void timerEvent(QTimerEvent* event) override {
		...
		miqt_exec_callback_QLayout_timerEvent(this, handle__timerEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__customEvent;
	...
	virtual void customEvent(QEvent* event) override {
		...
		QEvent* sigval1 = event;
		miqt_exec_callback_QLayout_customEvent(this, handle__customEvent.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__connectNotify;
	...
	virtual void connectNotify(const QMetaMethod& signal) override {
		...
		miqt_exec_callback_QLayout_connectNotify(this, handle__connectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__disconnectNotify;
	...
	virtual void disconnectNotify(const QMetaMethod& signal) override {
		...
		// Cast returned reference into pointer
		QMetaMethod* sigval1 = const_cast<QMetaMethod*>(&signal_ret);
		miqt_exec_callback_QLayout_disconnectNotify(this, handle__disconnectNotify.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__sizeHint;
	...
	virtual QSize sizeHint() const override {
		...
		QSize* callback_return_value = miqt_exec_callback_QLayout_sizeHint(this, handle__sizeHint.value());
		std::unique_ptr<QSize> callback_return_value_owner;
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__hasHeightForWidth;
	...
	virtual bool hasHeightForWidth() const override {
		...
		bool callback_return_value = miqt_exec_callback_QLayout_hasHeightForWidth(this, handle__hasHeightForWidth.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__heightForWidth;
	...
	virtual int heightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QLayout_heightForWidth(this, handle__heightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__minimumHeightForWidth;
	...
	virtual int minimumHeightForWidth(int param1) const override {
		...
		int sigval1 = param1;
		int callback_return_value = miqt_exec_callback_QLayout_minimumHeightForWidth(this, handle__minimumHeightForWidth.value(), sigval1);
		return static_cast<int>(callback_return_value);
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__widget;
	...
	virtual QWidget* widget() const override {
		...
		QWidget* callback_return_value = miqt_exec_callback_QLayout_widget(this, handle__widget.value());
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> handle__spacerItem;
	...
	virtual QSpacerItem* spacerItem() override {
		...
		QSpacerItem* callback_return_value = miqt_exec_callback_QLayout_spacerItem(this, handle__spacerItem.value());
		return callback_return_value;
	}
...
QLayout* QLayout_new(QWidget* parent) {
	return new (std::nothrow) MiqtVirtualQLayout(parent);
}

QLayout* QLayout_new2() {
	return new (std::nothrow) MiqtVirtualQLayout();
}
...
bool QLayout_override_virtual_spacing(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> slot_handle(slot);
...
int QLayout_virtualbase_spacing(const void* self) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::spacing();
}
...
void QLayout_virtualbase_setSpacing(void* self, int spacing) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::setSpacing(static_cast<int>(spacing));
}
...
void QLayout_virtualbase_invalidate(void* self) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::invalidate();
}
...
bool QLayout_override_virtual_owned_geometry(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> slot_handle(slot);
	MiqtVirtualQLayout* self_cast = dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QRect* QLayout_virtualbase_geometry(const void* self) {
	return new QRect(static_cast<const MiqtVirtualQLayout*>(self)->QLayout::geometry());
}
...
int QLayout_virtualbase_expandingDirections(const void* self) {
	Qt::Orientations _ret = static_cast<const MiqtVirtualQLayout*>(self)->QLayout::expandingDirections();
	return static_cast<int>(_ret);
}
...
bool QLayout_override_virtual_owned_minimumSize(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> slot_handle(slot);
	MiqtVirtualQLayout* self_cast = dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QSize* QLayout_virtualbase_minimumSize(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQLayout*>(self)->QLayout::minimumSize());
}
...
bool QLayout_override_virtual_owned_maximumSize(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> slot_handle(slot);
	MiqtVirtualQLayout* self_cast = dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
QSize* QLayout_virtualbase_maximumSize(const void* self) {
	return new QSize(static_cast<const MiqtVirtualQLayout*>(self)->QLayout::maximumSize());
}
...
void QLayout_virtualbase_setGeometry(void* self, QRect* geometry) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::setGeometry(*geometry);
}
...
int QLayout_virtualbase_indexOf(const void* self, QWidget* param1) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::indexOf(param1);
}
...
bool QLayout_override_virtual_indexOfWithQLayoutItem(void* self, intptr_t slot) {
	...
	self_cast->handle__indexOfWithQLayoutItem = std::move(slot_handle);
	return true;
}
...
bool QLayout_virtualbase_isEmpty(const void* self) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::isEmpty();
}
...
int QLayout_virtualbase_controlTypes(const void* self) {
	QSizePolicy::ControlTypes _ret = static_cast<const MiqtVirtualQLayout*>(self)->QLayout::controlTypes();
	return static_cast<int>(_ret);
}
...
QLayoutItem* QLayout_virtualbase_replaceWidget(void* self, QWidget* from, QWidget* to, int options) {
	return static_cast<MiqtVirtualQLayout*>(self)->QLayout::replaceWidget(from, to, static_cast<Qt::FindChildOptions>(options));
}
...
QLayout* QLayout_virtualbase_layout(void* self) {
	return static_cast<MiqtVirtualQLayout*>(self)->QLayout::layout();
}
...
void QLayout_virtualbase_childEvent(void* self, QChildEvent* e) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::childEvent(e);
}
...
bool QLayout_virtualbase_event(void* self, QEvent* event) {
	return static_cast<MiqtVirtualQLayout*>(self)->QLayout::event(event);
}
...
bool QLayout_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return static_cast<MiqtVirtualQLayout*>(self)->QLayout::eventFilter(watched, event);
}
...
void QLayout_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::timerEvent(event);
}
...
void QLayout_virtualbase_customEvent(void* self, QEvent* event) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::customEvent(event);
}
...
void QLayout_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::connectNotify(*signal);
}
...
void QLayout_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	static_cast<MiqtVirtualQLayout*>(self)->QLayout::disconnectNotify(*signal);
}
...
bool QLayout_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QLayout> slot_handle(slot);
	MiqtVirtualQLayout* self_cast = dynamic_cast<MiqtVirtualQLayout*>( (QLayout*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QLayout_virtualbase_hasHeightForWidth(const void* self) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::hasHeightForWidth();
}
...
int QLayout_virtualbase_heightForWidth(const void* self, int param1) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::heightForWidth(static_cast<int>(param1));
}
...
int QLayout_virtualbase_minimumHeightForWidth(const void* self, int param1) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::minimumHeightForWidth(static_cast<int>(param1));
}
...
QWidget* QLayout_virtualbase_widget(const void* self) {
	return static_cast<const MiqtVirtualQLayout*>(self)->QLayout::widget();
}
...
QSpacerItem* QLayout_virtualbase_spacerItem(void* self) {
	return static_cast<MiqtVirtualQLayout*>(self)->QLayout::spacerItem();
}
