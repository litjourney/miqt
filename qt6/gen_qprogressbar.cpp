...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QProgressBar> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionProgressBar* option) const override {
		...
		miqt_exec_callback_QProgressBar_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
bool QProgressBar_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QProgressBar> slot_handle(slot);
	MiqtVirtualQProgressBar* self_cast = dynamic_cast<MiqtVirtualQProgressBar*>( (QProgressBar*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QProgressBar_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QProgressBar> slot_handle(slot);
	MiqtVirtualQProgressBar* self_cast = dynamic_cast<MiqtVirtualQProgressBar*>( (QProgressBar*)(self) );
	if (self_cast == nullptr) {
		return false;
...
void QProgressBar_virtualbase_initStyleOption(const void* self, QStyleOptionProgressBar* option) {
	static_cast<const MiqtVirtualQProgressBar*>(self)->QProgressBar::initStyleOption(option);
}
...
bool QProgressBar_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQProgressBar*>(self)->QProgressBar::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
bool QProgressBar_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QProgressBar> slot_handle(slot);
	MiqtVirtualQProgressBar* self_cast = dynamic_cast<MiqtVirtualQProgressBar*>( (QProgressBar*)(self) );
	if (self_cast == nullptr) {
		return false;
