...
func NewQSqlDriver2(parent *qt6.QObject) *QSqlDriver {

	return newQSqlDriver(C.QSqlDriver_new2((*C.QObject)(parent.UnsafePointer())))
}

func (this *QSqlDriver) MetaObject() *qt6.QMetaObject {
	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QSqlDriver_metaObject(this.h)))
}
...
func (this *QSqlDriver) Handle() *qt6.QVariant {
	_goptr := qt6.UnsafeNewQVariant(unsafe.Pointer(C.QSqlDriver_handle(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QSqlDriver) Notification(name string, source QSqlDriver__NotificationSource, payload *qt6.QVariant) {
	name_ms := C.struct_miqt_string{}
	name_ms.data = C.CString(name)
	name_ms.len = C.size_t(len(name))
	defer C.free(unsafe.Pointer(name_ms.data))
	C.QSqlDriver_notification(this.h, name_ms, (C.int)(source), (*C.QVariant)(payload.UnsafePointer()))
}
func (this *QSqlDriver) OnNotification(slot func(name string, source QSqlDriver__NotificationSource, payload *qt6.QVariant)) *qt6.SignalConnection {
	_goptr := qt6.UnsafeNewQMetaObject__Connection(C.QSqlDriver_connect_notification(this.h, C.intptr_t(cgo.NewHandle(slot))))
	_goptr.GoGC()
	return _goptr
}

//export miqt_exec_callback_QSqlDriver_notification
func miqt_exec_callback_QSqlDriver_notification(cb C.intptr_t, name C.struct_miqt_string, source C.int, payload *C.QVariant) {
	gofunc, ok := cgo.Handle(cb).Value().(func(name string, source QSqlDriver__NotificationSource, payload *qt6.QVariant))
	if !ok {
	...
	slotval3 := qt6.UnsafeNewQVariant(unsafe.Pointer(payload))
...
func (this *QSqlDriver) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QSqlDriver_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QSqlDriver) IsSignalConnected(signal *qt6.QMetaMethod) bool {
...
func (this *QSqlDriver) callVirtualBase_Handle() *qt6.QVariant {

	_goptr := qt6.UnsafeNewQVariant(unsafe.Pointer(C.QSqlDriver_virtualbase_handle(unsafe.Pointer(this.h))))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func (this *QSqlDriver) OnMaximumIdentifierLength(slot func(super func(typeVal QSqlDriver__IdentifierType) int, typeVal QSqlDriver__IdentifierType) int) {
	...
	ok := C.QSqlDriver_override_virtual_maximumIdentifierLength(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QSqlDriver) callVirtualBase_Event(event *qt6.QEvent) bool {

	return (bool)(C.QSqlDriver_virtualbase_event(unsafe.Pointer(this.h), (*C.QEvent)(event.UnsafePointer())))

}
func (this *QSqlDriver) OnEvent(slot func(super func(event *qt6.QEvent) bool, event *qt6.QEvent) bool) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_EventFilter(watched *qt6.QObject, event *qt6.QEvent) bool {
...
func (this *QSqlDriver) OnEventFilter(slot func(super func(watched *qt6.QObject, event *qt6.QEvent) bool, watched *qt6.QObject, event *qt6.QEvent) bool) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_TimerEvent(event *qt6.QTimerEvent) {

	C.QSqlDriver_virtualbase_timerEvent(unsafe.Pointer(this.h), (*C.QTimerEvent)(event.UnsafePointer()))

}
func (this *QSqlDriver) OnTimerEvent(slot func(super func(event *qt6.QTimerEvent), event *qt6.QTimerEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_ChildEvent(event *qt6.QChildEvent) {

	C.QSqlDriver_virtualbase_childEvent(unsafe.Pointer(this.h), (*C.QChildEvent)(event.UnsafePointer()))

}
func (this *QSqlDriver) OnChildEvent(slot func(super func(event *qt6.QChildEvent), event *qt6.QChildEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_CustomEvent(event *qt6.QEvent) {

	C.QSqlDriver_virtualbase_customEvent(unsafe.Pointer(this.h), (*C.QEvent)(event.UnsafePointer()))

}
func (this *QSqlDriver) OnCustomEvent(slot func(super func(event *qt6.QEvent), event *qt6.QEvent)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_ConnectNotify(signal *qt6.QMetaMethod) {

	C.QSqlDriver_virtualbase_connectNotify(unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer()))

}
func (this *QSqlDriver) OnConnectNotify(slot func(super func(signal *qt6.QMetaMethod), signal *qt6.QMetaMethod)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
...
func (this *QSqlDriver) callVirtualBase_DisconnectNotify(signal *qt6.QMetaMethod) {

	C.QSqlDriver_virtualbase_disconnectNotify(unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer()))

}
func (this *QSqlDriver) OnDisconnectNotify(slot func(super func(signal *qt6.QMetaMethod), signal *qt6.QMetaMethod)) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(slot))
	}
