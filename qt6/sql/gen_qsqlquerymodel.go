...
func (this *QSqlQueryModel) OnDataOwned(slot func(super func(item *qt6.QModelIndex, role int) *qt6.QVariant, item *qt6.QModelIndex, role int) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnHeaderDataOwned(slot func(super func(section int, orientation qt6.Orientation, role int) *qt6.QVariant, section int, orientation qt6.Orientation, role int) *qt6.QVariant) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnIndexInQueryOwned(slot func(super func(item *qt6.QModelIndex) *qt6.QModelIndex, item *qt6.QModelIndex) *qt6.QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnIndexOwned(slot func(super func(row int, column int, parent *qt6.QModelIndex) *qt6.QModelIndex, row int, column int, parent *qt6.QModelIndex) *qt6.QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnSiblingOwned(slot func(super func(row int, column int, idx *qt6.QModelIndex) *qt6.QModelIndex, row int, column int, idx *qt6.QModelIndex) *qt6.QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
...
func (this *QSqlQueryModel) OnClearItemData(slot func(super func(index *qt6.QModelIndex) bool, index *qt6.QModelIndex) bool) {
	...
	ok := C.QSqlQueryModel_override_virtual_clearItemData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnBuddyOwned(slot func(super func(index *qt6.QModelIndex) *qt6.QModelIndex, index *qt6.QModelIndex) *qt6.QModelIndex) {
	var slotHandle C.intptr_t
	if slot != nil {
...
// ownership of each non-nil returned Qt value object to C++.
func (this *QSqlQueryModel) OnSpanOwned(slot func(super func(index *qt6.QModelIndex) *qt6.QSize, index *qt6.QModelIndex) *qt6.QSize) {
	var slotHandle C.intptr_t
	if slot != nil {
...
func (this *QSqlQueryModel) OnMultiData(slot func(super func(index *qt6.QModelIndex, roleDataSpan qt6.QModelRoleDataSpan), index *qt6.QModelIndex, roleDataSpan qt6.QModelRoleDataSpan)) {
	...
	ok := C.QSqlQueryModel_override_virtual_multiData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QSqlQueryModel) OnResetInternalData(slot func(super func())) {
	...
	ok := C.QSqlQueryModel_override_virtual_resetInternalData(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
