...
//export miqt_exec_callback_handle_release_QDesignerLayoutDecorationExtension
func miqt_exec_callback_handle_release_QDesignerLayoutDecorationExtension(cb C.intptr_t) {
...
func (this *QDesignerLayoutDecorationExtension) OnWidgets(slot func(layout *qt6.QLayout) []*qt6.QWidget) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_widgets(unsafe.Pointer(this.h), slotHandle)
	if !ok {
...
type miqtVirtualCallback_QDesignerLayoutDecorationExtension_itemInfo struct {
	callback   func(index int) *qt6.QRect
	ownsReturn bool
}
...
func (this *QDesignerLayoutDecorationExtension) OnItemInfo(slot func(index int) *qt6.QRect) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QDesignerLayoutDecorationExtension_itemInfo{callback: slot}))
	}
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_itemInfo(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

// OnItemInfoOwned installs a virtual override that transfers
// ownership of each non-nil returned Qt value object to C++.
func (this *QDesignerLayoutDecorationExtension) OnItemInfoOwned(slot func(index int) *qt6.QRect) {
	var slotHandle C.intptr_t
	if slot != nil {
		slotHandle = C.intptr_t(cgo.NewHandle(miqtVirtualCallback_QDesignerLayoutDecorationExtension_itemInfo{callback: slot, ownsReturn: true}))
	}
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_owned_itemInfo(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QDesignerLayoutDecorationExtension_itemInfo(self *C.QDesignerLayoutDecorationExtension, cb C.intptr_t, index C.int) *C.QRect {
	callbackData, ok := cgo.Handle(cb).Value().(miqtVirtualCallback_QDesignerLayoutDecorationExtension_itemInfo)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QDesignerLayoutDecorationExtension) OnIndexOf(slot func(widget *qt6.QWidget) int) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_indexOf(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnIndexOfWithItem(slot func(item *qt6.QLayoutItem) int) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_indexOfWithItem(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnCurrentInsertMode(slot func() QDesignerLayoutDecorationExtension__InsertMode) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_currentInsertMode(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnCurrentIndex(slot func() int) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_currentIndex(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnCurrentCell(slot func() struct {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_currentCell(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnInsertWidget(slot func(widget *qt6.QWidget, cell struct {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_insertWidget(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnRemoveWidget(slot func(widget *qt6.QWidget)) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_removeWidget(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnInsertRow(slot func(row int)) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_insertRow(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnInsertColumn(slot func(column int)) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_insertColumn(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnSimplify(slot func()) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_simplify(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnFindItemAt(slot func(pos *qt6.QPoint) int) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_findItemAt(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnFindItemAt2(slot func(row int, column int) int) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_findItemAt2(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QDesignerLayoutDecorationExtension) OnAdjustIndicator(slot func(pos *qt6.QPoint, index int)) {
	...
	ok := C.QDesignerLayoutDecorationExtension_override_virtual_adjustIndicator(unsafe.Pointer(this.h), slotHandle)
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
