...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QPdfBookmarkModel> handle__clearItemData;
	...
	virtual bool clearItemData(const QModelIndex& index) override {
		...
		// Cast returned reference into pointer
		QModelIndex* sigval1 = const_cast<QModelIndex*>(&index_ret);
		bool callback_return_value = miqt_exec_callback_QPdfBookmarkModel_clearItemData(this, handle__clearItemData.value(), sigval1);
		return callback_return_value;
	}
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QPdfBookmarkModel> handle__multiData;
	...
	virtual void multiData(const QModelIndex& index, QModelRoleDataSpan roleDataSpan) const override {
		...
		miqt_exec_callback_QPdfBookmarkModel_multiData(this, handle__multiData.value(), sigval1, sigval2);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QPdfBookmarkModel> handle__resetInternalData;
	...
	virtual void resetInternalData() override {
		...
		miqt_exec_callback_QPdfBookmarkModel_resetInternalData(this, handle__resetInternalData.value());
...
bool QPdfBookmarkModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	return static_cast<MiqtVirtualQPdfBookmarkModel*>(self)->QPdfBookmarkModel::clearItemData(*index);
}
...
void QPdfBookmarkModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	static_cast<const MiqtVirtualQPdfBookmarkModel*>(self)->QPdfBookmarkModel::multiData(*index, *roleDataSpan);
}
...
void QPdfBookmarkModel_virtualbase_resetInternalData(void* self) {
	static_cast<MiqtVirtualQPdfBookmarkModel*>(self)->QPdfBookmarkModel::resetInternalData();
}
