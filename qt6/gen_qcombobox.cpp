...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__setModel;
	...
	virtual void setModel(QAbstractItemModel* model) override {
		...
		miqt_exec_callback_QComboBox_setModel(this, handle__setModel.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QComboBox> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionComboBox* option) const override {
		...
		miqt_exec_callback_QComboBox_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
void QComboBox_virtualbase_setModel(void* self, QAbstractItemModel* model) {
	static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::setModel(model);
}
...
void QComboBox_virtualbase_initStyleOption(const void* self, QStyleOptionComboBox* option) {
	static_cast<const MiqtVirtualQComboBox*>(self)->QComboBox::initStyleOption(option);
}
...
bool QComboBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQComboBox*>(self)->QComboBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
