...
public:
	...
	miqt_callback_handle<miqt_exec_callback_handle_release_QFormLayout> handle__spacing;
	...
	virtual int spacing() const override {
		...
		int callback_return_value = miqt_exec_callback_QFormLayout_spacing(this, handle__spacing.value());
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFormLayout> handle__setSpacing;
	...
	virtual void setSpacing(int spacing) override {
		...
		int sigval1 = spacing;
		miqt_exec_callback_QFormLayout_setSpacing(this, handle__setSpacing.value(), sigval1);
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QFormLayout> handle__replaceWidget;
	...
	virtual QLayoutItem* replaceWidget(QWidget* from, QWidget* to, Qt::FindChildOptions options) override {
		...
		QLayoutItem* callback_return_value = miqt_exec_callback_QFormLayout_replaceWidget(this, handle__replaceWidget.value(), sigval1, sigval2, sigval3);
		return callback_return_value;
	}
...
int QFormLayout_virtualbase_spacing(const void* self) {
	return static_cast<const MiqtVirtualQFormLayout*>(self)->QFormLayout::spacing();
}
...
void QFormLayout_virtualbase_setSpacing(void* self, int spacing) {
	static_cast<MiqtVirtualQFormLayout*>(self)->QFormLayout::setSpacing(static_cast<int>(spacing));
}
...
QLayoutItem* QFormLayout_virtualbase_replaceWidget(void* self, QWidget* from, QWidget* to, int options) {
	return static_cast<MiqtVirtualQFormLayout*>(self)->QFormLayout::replaceWidget(from, to, static_cast<Qt::FindChildOptions>(options));
}
...
QWidget* QFormLayout_virtualbase_widget(const void* self) {
	return static_cast<const MiqtVirtualQFormLayout*>(self)->QFormLayout::widget();
}
