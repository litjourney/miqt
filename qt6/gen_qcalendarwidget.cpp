...
void* QCalendarWidget_connect_clicked(QCalendarWidget* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QCalendarWidget>>(slot);
	return new QMetaObject::Connection(QCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(QDate)>(&QCalendarWidget::clicked), self, [slot_handle](QDate date) {
		intptr_t slot = slot_handle->value();
...
void* QCalendarWidget_connect_activated(QCalendarWidget* self, intptr_t slot) {
	auto slot_handle = std::make_shared<miqt_callback_handle<miqt_exec_callback_handle_release_QCalendarWidget>>(slot);
	return new QMetaObject::Connection(QCalendarWidget::connect(self, static_cast<void (QCalendarWidget::*)(QDate)>(&QCalendarWidget::activated), self, [slot_handle](QDate date) {
		intptr_t slot = slot_handle->value();
		QDate* sigval1 = new QDate(date);
