...
public:
	...
	// cgo.Handle value for overwritten implementation
	miqt_callback_handle<miqt_exec_callback_handle_release_QDockWidget> handle__initStyleOption;
	...
	virtual void initStyleOption(QStyleOptionDockWidget* option) const override {
		...
		miqt_exec_callback_QDockWidget_initStyleOption(this, handle__initStyleOption.value(), sigval1);
...
void QDockWidget_virtualbase_initStyleOption(const void* self, QStyleOptionDockWidget* option) {
	static_cast<const MiqtVirtualQDockWidget*>(self)->QDockWidget::initStyleOption(option);
}
...
bool QDockWidget_override_virtual_owned_sizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDockWidget> slot_handle(slot);
	MiqtVirtualQDockWidget* self_cast = dynamic_cast<MiqtVirtualQDockWidget*>( (QDockWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QDockWidget_override_virtual_owned_minimumSizeHint(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDockWidget> slot_handle(slot);
	MiqtVirtualQDockWidget* self_cast = dynamic_cast<MiqtVirtualQDockWidget*>( (QDockWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
...
bool QDockWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return static_cast<MiqtVirtualQDockWidget*>(self)->QDockWidget::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
}
...
bool QDockWidget_override_virtual_owned_inputMethodQuery(void* self, intptr_t slot) {
	miqt_callback_handle<miqt_exec_callback_handle_release_QDockWidget> slot_handle(slot);
	MiqtVirtualQDockWidget* self_cast = dynamic_cast<MiqtVirtualQDockWidget*>( (QDockWidget*)(self) );
	if (self_cast == nullptr) {
		return false;
